...
public class AutoUtils {
    ...
    public static float getPercentHeight1px() {
        return (((float) AutoLayoutConifg.getInstance().getScreenHeight()) * 1.0f) / ((float) AutoLayoutConifg.getInstance().getDesignHeight());
    }

    public static int getPercentHeightSize(int i10) {
        return (int) (((((float) i10) * 1.0f) / ((float) AutoLayoutConifg.getInstance().getDesignHeight())) * ((float) AutoLayoutConifg.getInstance().getScreenHeight()));
    }
    ...
    public static float getPercentWidth1px() {
        return (((float) AutoLayoutConifg.getInstance().getScreenWidth()) * 1.0f) / ((float) AutoLayoutConifg.getInstance().getDesignWidth());
    }

    public static int getPercentWidthSize(int i10) {
        return (int) (((((float) i10) * 1.0f) / ((float) AutoLayoutConifg.getInstance().getDesignWidth())) * ((float) AutoLayoutConifg.getInstance().getScreenWidth()));
    }

...
public final class c implements d {
    ...
    public final void a(LogDto logDto) {
        if (logDto.getData() != null) {
            ...
            File file = new File(a.h(ControllerCenter.getGlobalEnvStruct().mAppContext, ControllerCenter.getGlobalEnvStruct().getAppid()), fileName);
    ...
    public final void a(File file) {
        FileUtil.move(file, a.h(ControllerCenter.getGlobalEnvStruct().mAppContext, ControllerCenter.getGlobalEnvStruct().getAppid()));
    }

...
public final class c {
    ...
    private static final SimpleDateFormat f5237a = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss", Locale.CHINA);
    ...
    public static boolean a(String str, RemoteConfig remoteConfig) {
        try {
                ...
                if (optJSONObject.length() > 0) {
                    ...
                    if (optJSONObject2 != null && optJSONObject2.length() > 0) {
                        ...
                        while (keys.hasNext()) {
                            ...
                            hashMap.put(next, optJSONObject2.optString(next, str2));
                        }
                    }
                        ...
                        for (int i11 = 0; i11 < optJSONArray.length(); i11++) {
                            ...
                            if (jSONObject2 != null && jSONObject2.length() == 2) {
                                ...
                                if (!(optJSONArray2 == null || optJSONArray3 == null || optJSONArray3.length() <= 0)) {
                                    a((Map<String, String>) hashMap, optJSONArray3);
                                }
                            }
                        }
                    }
            ...
            remoteConfig.a((Map<String, String>) hashMap);
            ...
            try {
                ...
                if (jSONObject != null && jSONObject.length() >= 2) {
                    ...
                    if (!(optString == null || opt == null)) {
                        String optString2 = jSONObject.optString("lt", (String) null);
                        String optString3 = jSONObject.optString("net", (String) null);
                        if (optString2 != null) {

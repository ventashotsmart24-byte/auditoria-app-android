...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.g {
    ...
    private void addAnimation(RecyclerView.d0 d0Var) {
        ...
        if (!this.mFirstOnlyEnable || d0Var.getLayoutPosition() > this.mLastPosition) {
            ...
            for (Animator startAnim : baseAnimation.getAnimators(d0Var.itemView)) {
                startAnim(startAnim, d0Var.getLayoutPosition());
            }
    ...
    private K createGenericKInstance(Class cls, View view) {
        try {
            ...
            return (BaseViewHolder) declaredConstructor2.newInstance(new Object[]{view});
    ...
    public K createBaseViewHolder(View view) {
        ...
        if (cls2 == null) {
            k10 = new BaseViewHolder(view);
        } else {
            k10 = createGenericKInstance(cls2, view);
        }
        return k10 != null ? k10 : new BaseViewHolder(view);
    }

...
class EngineKey implements Key {
    ...
    public EngineKey(Object obj, Key key, int i10, int i11, Map<Class<?>, Transformation<?>> map, Class<?> cls, Class<?> cls2, Options options2) {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            ...
            int hashCode4 = (hashCode3 * 31) + this.transformations.hashCode();

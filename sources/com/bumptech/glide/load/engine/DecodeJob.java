...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback, Runnable, Comparable<DecodeJob<?>>, FactoryPools.Poolable {
    ...
    public DecodeJob(DiskCacheProvider diskCacheProvider2, e eVar) {
    ...
    private Stage getNextStage(Stage stage2) {
        int i10 = AnonymousClass1.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[stage2.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3 || i10 == 4) {
    ...
    private Options getOptionsWithHardwareConfig(DataSource dataSource) {
        ...
        options3.set(option, Boolean.valueOf(z10));
        return options3;
    }
    ...
    private void logWithTimeAndKey(String str, long j10) {
        logWithTimeAndKey(str, j10, (String) null);
    }
    ...
    private void notifyEncodeAndRelease(Resource<R> resource, DataSource dataSource, boolean z10) {
        ...
        try {
            ...
            notifyComplete(lockedResource, dataSource, z10);
    ...
    public DecodeJob<R> init(GlideContext glideContext2, Object obj, EngineKey engineKey, Key key, int i10, int i11, Class<?> cls, Class<R> cls2, Priority priority2, DiskCacheStrategy diskCacheStrategy2, Map<Class<?>, Transformation<?>> map, boolean z10, boolean z11, boolean z12, Options options2, Callback<R> callback2, int i12) {
        this.decodeHelper.init(glideContext2, obj, key, i10, i11, diskCacheStrategy2, cls, cls2, priority2, options2, map, z10, z11, this.diskCacheProvider);

...
public final class QMediaStoreUriLoader<DataT> implements ModelLoader<Uri, DataT> {
    ...
    public static final class QMediaStoreUriFetcher<DataT> implements DataFetcher<DataT> {
        ...
        public QMediaStoreUriFetcher(Context context2, ModelLoader<File, DataT> modelLoader, ModelLoader<Uri, DataT> modelLoader2, Uri uri2, int i10, int i11, Options options2, Class<DataT> cls) {

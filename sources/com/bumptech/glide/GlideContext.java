...
public class GlideContext extends ContextWrapper {
    ...
    public GlideContext(Context context, ArrayPool arrayPool2, GlideSuppliers.GlideSupplier<Registry> glideSupplier, ImageViewTargetFactory imageViewTargetFactory2, Glide.RequestOptionsFactory requestOptionsFactory, Map<Class<?>, TransitionOptions<?, ?>> map, List<RequestListener<Object>> list, Engine engine2, GlideExperiments glideExperiments, int i10) {

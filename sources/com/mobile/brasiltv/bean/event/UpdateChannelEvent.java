...
public final class UpdateChannelEvent {
    ...
    public static /* synthetic */ UpdateChannelEvent copy$default(UpdateChannelEvent updateChannelEvent, ArrayList<Channel> arrayList, int i10, boolean z10, String str, int i11, String str2, int i12, int i13, Object obj) {
        if ((i13 & 1) != 0) {
    ...
    public int hashCode() {
        ...
        return ((((((((hashCode + (z10 ? 1 : 0)) * 31) + this.liveType.hashCode()) * 31) + this.categoryCode) * 31) + this.tdcFrom.hashCode()) * 31) + this.previousColumnIndex;
    }

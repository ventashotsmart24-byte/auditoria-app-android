...
public final class RedemptionAty extends d implements j0 {
    ...
    public ExchangeFailedDialog f12093l;

    /* renamed from: m  reason: collision with root package name */
    public q2 f12094m;

    /* renamed from: n  reason: collision with root package name */
    public Map f12095n = new LinkedHashMap();

    public static final class a implements TextWatcher {

        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ RedemptionAty f12096a;

        public a(RedemptionAty redemptionAty) {
            this.f12096a = redemptionAty;
        }

        public void afterTextChanged(Editable editable) {
            boolean z10;
            q2 c32 = this.f12096a.S2();
            RedemptionAty redemptionAty = this.f12096a;
            int i10 = R$id.mEtExchangeCode;
            EditText editText = (EditText) redemptionAty.X2(i10);
            i.f(editText, "mEtExchangeCode");
            c32.n(editText, this);
            ((EditText) this.f12096a.X2(i10)).setSelection(((EditText) this.f12096a.X2(i10)).getText().length());
            Editable text = ((EditText) this.f12096a.X2(i10)).getText();
            ...
            if (z10) {
                ((ImageButton) this.f12096a.X2(R$id.mIbClear)).setVisibility(0);
            } else {
                ((ImageButton) this.f12096a.X2(R$id.mIbClear)).setVisibility(8);
            }
        }
    ...
    public static final class b extends j implements l {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ RedemptionAty f12097a;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public b(RedemptionAty redemptionAty) {
            super(1);
            this.f12097a = redemptionAty;
        }
        ...
        public final void b(View view) {
            ...
            i.g(view, "it");
            this.f12097a.d3();
            q2 c32 = this.f12097a.S2();
            Editable text = ((EditText) this.f12097a.X2(R$id.mEtExchangeCode)).getText();
    ...
    public static final boolean a3(RedemptionAty redemptionAty, View view, int i10, KeyEvent keyEvent) {
        ...
        if (i10 == 67) {
            ...
            i.f(text, "mEtExchangeCode.text");
            if (t.q(text, Operator.Operation.MINUS, false, 2, (Object) null) && ((EditText) redemptionAty.X2(i11)).length() > 1) {
    ...
    public void R2() {
        ...
        int i10 = R$id.mEtExchangeCode;
        ((EditText) X2(i10)).setOnFocusChangeListener(new e3(this));
        ((EditText) X2(i10)).addTextChangedListener(new a(this));
        ((EditText) X2(i10)).setOnKeyListener(new f3(this));
        KoocanButton koocanButton = (KoocanButton) X2(R$id.mKbConfirm);
        i.f(koocanButton, "mKbConfirm");
        b0.f(koocanButton, new b(this), 500);
        ((ImageButton) X2(R$id.mIbClear)).setOnClickListener(new g3(this));
    }
    ...
    public void W(String str, ExchangeData exchangeData, String str2) {
        ...
        if (exchangeData != null) {
            this.f12093l = new ExchangeFailedDialog(this);
        }
            ...
            switch (hashCode) {
                case 268950164:
                    if (str.equals("aaa40001")) {
                        ExchangeFailedDialog exchangeFailedDialog = this.f12093l;
                        if (exchangeFailedDialog != null) {
                            exchangeFailedDialog.setRedeemCode(str2);
                        }
                        ExchangeFailedDialog exchangeFailedDialog2 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog3 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog4 = this.f12093l;
                ...
                case 268950165:
                    if (str.equals("aaa40002")) {
                        ExchangeFailedDialog exchangeFailedDialog5 = this.f12093l;
                        if (exchangeFailedDialog5 != null) {
                            exchangeFailedDialog5.setRedeemCode(str2);
                        }
                        ExchangeFailedDialog exchangeFailedDialog6 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog7 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog8 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog9 = this.f12093l;
                ...
                case 268950166:
                    if (str.equals("aaa40003")) {
                        ExchangeFailedDialog exchangeFailedDialog10 = this.f12093l;
                        if (exchangeFailedDialog10 != null) {
                            exchangeFailedDialog10.setRedeemCode(str2);
                        }
                        ExchangeFailedDialog exchangeFailedDialog11 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog12 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog13 = this.f12093l;
                ...
                case 268950167:
                    if (str.equals("aaa40004")) {
                        ExchangeFailedDialog exchangeFailedDialog14 = this.f12093l;
                        if (exchangeFailedDialog14 != null) {
                            exchangeFailedDialog14.setRedeemCode(str2);
                        }
                        ExchangeFailedDialog exchangeFailedDialog15 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog16 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog17 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog18 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog19 = this.f12093l;
                ...
                case 268950168:
                    if (str.equals("aaa40005")) {
                        ExchangeFailedDialog exchangeFailedDialog20 = this.f12093l;
                        if (exchangeFailedDialog20 != null) {
                            exchangeFailedDialog20.setRedeemCode(str2);
                        }
                        ExchangeFailedDialog exchangeFailedDialog21 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog22 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog23 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog24 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog25 = this.f12093l;
                ...
                case 268950169:
                    if (str.equals("aaa40006")) {
                        ExchangeFailedDialog exchangeFailedDialog26 = this.f12093l;
                        if (exchangeFailedDialog26 != null) {
                            exchangeFailedDialog26.setRedeemCode(str2);
                        }
                        ExchangeFailedDialog exchangeFailedDialog27 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog28 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog29 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog30 = this.f12093l;
                        ...
                        ExchangeFailedDialog exchangeFailedDialog31 = this.f12093l;

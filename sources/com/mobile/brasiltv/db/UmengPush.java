...
public class UmengPush implements Parcelable {
    public static final Parcelable.Creator<UmengPush> CREATOR = new UmengPush$Companion$CREATOR$1();
    public static final Companion Companion = new Companion((g) null);
    private String alias;
    private String channelNumber;
    @f
    private int clientSave = 1;
    ...
    public UmengPush(Parcel parcel) {
        ...
        this.isRead = parcel.readByte() == 0 ? false : z10;
    }
}

...
public final class VodDao implements a.b {
    ...
    public final String DATABASE_NAME = "KoocanPortCodeMobile.db";
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public Context ctx;
    private final g db$delegate = h.b(new VodDao$db$2(this));
    ...
    private final String getPoster(List<? extends PosterList> list) {
        ...
        for (T next : list) {
            if (i.b(d.f10697a.g(), ((PosterList) next).getFileType())) {
                arrayList.add(next);
            }
        }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:10:0x003f A[Catch:{ RuntimeException -> 0x004f }] */
    /* JADX WARNING: Removed duplicated region for block: B:11:0x0047 A[Catch:{ RuntimeException -> 0x004f }] */
    ...
    public final void addLinks(com.mobile.brasiltv.db.Links r6) {
        /*
            ...
            java.lang.String r2 = r6.getContentId()     // Catch:{ RuntimeException -> 0x004f }
            r1.append(r2)     // Catch:{ RuntimeException -> 0x004f }
            java.lang.String r2 = "' and position="
            r1.append(r2)     // Catch:{ RuntimeException -> 0x004f }
            int r2 = r6.getPosition()     // Catch:{ RuntimeException -> 0x004f }
            r1.append(r2)     // Catch:{ RuntimeException -> 0x004f }
            java.lang.String r1 = r1.toString()     // Catch:{ RuntimeException -> 0x004f }
            ra.a r2 = r5.getDb()     // Catch:{ RuntimeException -> 0x004f }
            java.lang.Class<com.mobile.brasiltv.db.Links> r3 = com.mobile.brasiltv.db.Links.class
            java.util.List r2 = r2.m(r3, r1)     // Catch:{ RuntimeException -> 0x004f }
            if (r2 == 0) goto L_0x003c
            boolean r2 = r2.isEmpty()     // Catch:{ RuntimeException -> 0x004f }
        ...
        L_0x003d:
            ...
            ra.a r1 = r5.getDb()     // Catch:{ RuntimeException -> 0x004f }
            r1.r(r6)     // Catch:{ RuntimeException -> 0x004f }
            goto L_0x004e
        L_0x0047:
            ra.a r2 = r5.getDb()     // Catch:{ RuntimeException -> 0x004f }
            r2.u(r6, r1)     // Catch:{ RuntimeException -> 0x004f }
        L_0x004e:
            return
        L_0x004f:
            r6 = move-exception

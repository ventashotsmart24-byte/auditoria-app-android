...
public final class MenuSwitchItem extends AutoRelativeLayout {
    ...
    public MenuSwitchItem(Context context, AttributeSet attributeSet, int i10) {
        ...
        LayoutInflater.from(context).inflate(R.layout.layout_menu_switch_item, this, true);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.f11945p, i10, 0);

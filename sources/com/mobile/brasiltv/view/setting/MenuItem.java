...
public final class MenuItem extends AutoRelativeLayout {
    ...
    public MenuItem(Context context, AttributeSet attributeSet, int i10) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.f11944o, i10, 0);
        ...
        String str = "";
        ((TextView) _$_findCachedViewById(R$id.mTvMenuName)).setText(string == null ? str : string);
        ...
        ((TextView) _$_findCachedViewById(R$id.mTvMenuInfo)).setText(string2 != null ? string2 : str);

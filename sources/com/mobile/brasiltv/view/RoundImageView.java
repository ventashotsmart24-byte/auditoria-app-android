...
public class RoundImageView extends ImageView {
    ...
    private void setBitmapShader() {
        ...
        if (drawable != null) {
            ...
            float f10 = 1.0f;
            if (i10 == 0) {
                f10 = (((float) this.mWidth) * 1.0f) / ((float) Math.min(drawableToBitmap.getWidth(), drawableToBitmap.getHeight()));
            } else if (i10 == 1 || i10 == 2) {
                f10 = Math.max((((float) getWidth()) * 1.0f) / ((float) drawableToBitmap.getWidth()), (((float) getHeight()) * 1.0f) / ((float) drawableToBitmap.getHeight()));
            }
    ...
    public void onDraw(Canvas canvas) {
        if (getDrawable() != null) {
            ...
            if (i10 == 0) {
                ...
                canvas.drawCircle((float) i11, (float) i11, (float) i11, this.mPaint);
            } else if (i10 == 1) {
                this.mPaint.setColor(-65536);
                if (this.isCardViewParent) {
                    canvas.drawRoundRect(this.mRect, (float) this.mRoundRadius, 0.0f, this.mPaint);
                    return;
                }
                RectF rectF = this.mRect;
                int i12 = this.mRoundRadius;
                canvas.drawRoundRect(rectF, (float) i12, (float) i12, this.mPaint);
            } else if (i10 == 2) {

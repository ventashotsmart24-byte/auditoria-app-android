...
public final class ExchangeFailedDialog extends Dialog {
    ...
    public ExchangeFailedDialog(Context context) {
        ...
        ((TextView) findViewById(R$id.mButtonOK)).setOnClickListener(new u(this));
        ((ImageView) findViewById(R$id.mIvClose)).setOnClickListener(new v(this));
        setCancelable(false);
    }

    /* access modifiers changed from: private */
    public static final void _init_$lambda$0(ExchangeFailedDialog exchangeFailedDialog, View view) {
        i.g(exchangeFailedDialog, "this$0");
    ...
    public final void setRedeemCode(String str) {
        ...
        i.f(string, "context.resources.getStr…ing.exchange_redeem_code)");
    ...
    public final void setServiceDays(String str) {
        ...
        i.f(string, "context.resources.getStr…ng.exchange_service_days)");
        String format = String.format(string, Arrays.copyOf(new Object[]{str}, 1));
        i.f(format, "format(format, *args)");
    ...
    public final void setStatus(String str) {
        ...
        i.f(string, "context.resources.getStr…hange_redeem_code_status)");
        String format = String.format(string, Arrays.copyOf(new Object[]{str}, 1));
        i.f(format, "format(format, *args)");
    ...
    public final void setTimeOfUsed(String str) {
        ...
        i.f(string, "context.resources.getStr…ing.exchange_time_of_use)");
        String format = String.format(string, Arrays.copyOf(new Object[]{str}, 1));
        i.f(format, "format(format, *args)");
        ((TextView) findViewById(i10)).setText(Html.fromHtml(format));
    }
    ...
    public final void setValidUntil(String str) {
        ...
        i.f(string, "context.resources.getStr…ing.exchange_valid_until)");
        String format = String.format(string, Arrays.copyOf(new Object[]{str}, 1));
        i.f(format, "format(format, *args)");
        ((TextView) findViewById(i10)).setText(Html.fromHtml(format));
    }

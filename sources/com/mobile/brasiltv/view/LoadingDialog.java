...
public final class LoadingDialog extends DialogFragment {
    ...
    public static final class Companion {
        ...
        public final void hidden() {
            try {
                LoadingDialog access$getLoadingDialog$cp = LoadingDialog.loadingDialog;
                if (access$getLoadingDialog$cp != null) {
                    access$getLoadingDialog$cp.dismiss();
                }
        ...
        public final void show(FragmentManager fragmentManager) {
            ...
            LoadingDialog access$getLoadingDialog$cp = LoadingDialog.loadingDialog;
            if (access$getLoadingDialog$cp != null) {
                access$getLoadingDialog$cp.show(fragmentManager, "loading");
            }
        }
    }

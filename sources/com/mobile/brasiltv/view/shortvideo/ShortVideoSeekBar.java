...
public final class ShortVideoSeekBar extends AutoLinearLayout {
    ...
    /* access modifiers changed from: private */
    public final Runnable resetSeekBarRunnable;
    ...
    public ShortVideoSeekBar(Context context) {
        super(context);
        i.g(context, f.X);
        this.resetSeekBarRunnable = new a(this);
        initView();
    }
    ...
    private final void initListener() {
        ...
        ((AppCompatSeekBar) _$_findCachedViewById(i10)).setThumb((Drawable) null);
    ...
    private final void initView() {
        setOrientation(1);
        LayoutInflater.from(getContext()).inflate(R.layout.layout_shortvideo_seekbar, this, true);
        initListener();
    }
    ...
    public static final void resetSeekBarRunnable$lambda$0(ShortVideoSeekBar shortVideoSeekBar) {
        ...
        int i10 = R$id.mSeekBar;
        ((AppCompatSeekBar) shortVideoSeekBar._$_findCachedViewById(i10)).setThumb((Drawable) null);

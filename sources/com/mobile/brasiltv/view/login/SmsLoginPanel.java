...
public final class SmsLoginPanel extends AutoLinearLayout implements ILoginPanel, IPickAreaCallback {
    ...
    public boolean mFindVerifyCode;
    /* access modifiers changed from: private */
    public ISmsLoginCallback mSmsLoginCallback;
    ...
    private final void initListeners() {
        ...
        ((TitleBarView) _$_findCachedViewById(R$id.mTbvTitle)).setOnBackClickListener(new x(this));
        ((PickAreaView) _$_findCachedViewById(R$id.mPavArea)).setPickAreaCallback(this);
        ((VerifyCodeView) _$_findCachedViewById(R$id.mVcvVerifyCode)).setVerifyCodeCallback(new SmsLoginPanel$initListeners$3(this));
        ((TextView) _$_findCachedViewById(R$id.mTvLogin)).setOnClickListener(new y(this));
        ((TextView) _$_findCachedViewById(R$id.mTvUseMobileLogin)).setOnClickListener(new z(this));
    }
    ...
    public final void setSmsLoginCallback(ISmsLoginCallback iSmsLoginCallback) {
        i.g(iSmsLoginCallback, "callback");
    ...
    public SmsLoginPanel(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.mErrorHintRunnable = new v(this);
        setOrientation(1);
        LayoutInflater.from(context).inflate(R.layout.layout_sms_login_panel, this, true);
        initViews();
        initListeners();
    }
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ SmsLoginPanel(Context context, AttributeSet attributeSet, int i10, int i11, g gVar) {

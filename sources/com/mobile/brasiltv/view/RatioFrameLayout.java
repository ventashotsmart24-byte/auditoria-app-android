...
public class RatioFrameLayout extends AutoFrameLayout {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.f11950u);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (this.mRatioEnable) {
            ...
            if (f10 != 0.0f) {
                i11 = View.MeasureSpec.makeMeasureSpec((int) (((float) size) / f10), Ints.MAX_POWER_OF_TWO);
            }
        }

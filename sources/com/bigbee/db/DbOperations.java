...
public class DbOperations {
    ...
    public void deleteEvent(long j10, String str) {
        synchronized (this) {
            fixDatabaseCode14();
            SQLite.delete(EventDbModel.class).where(EventDbModel_Table.eventId.eq(str), EventDbModel_Table.startTime.eq(Long.valueOf(j10))).execute();
        }
    }
    ...
    public void deleteLimitNum() {
        synchronized (this) {
            ...
            FlowManager.getDatabase((Class<?>) BBDatabase.class).beginTransactionAsync(new ITransaction() {
                public void execute(DatabaseWrapper databaseWrapper) {
                    Class<EventDbModel> cls = EventDbModel.class;
                    From<TModel> from = SQLite.delete().from(cls);
                    Property<Integer> property = EventDbModel_Table.id;
                    from.where(property.in((BaseModelQueriable) SQLite.select(property).from(cls).orderBy(EventDbModel_Table.startTime.asc()).limit(1000), new BaseModelQueriable[0])).execute(databaseWrapper);
                }
    ...
    public void deleteListEvent(List<EventDbModel> list) {
        if (list != null && list.size() > 0) {
            ...
            synchronized (this) {
                try {
                    fixDatabaseCode14();
                    FlowManager.getDatabase((Class<?>) BBDatabase.class).executeTransaction(new ProcessModelTransaction.Builder(new ProcessModelTransaction.ProcessModel<EventDbModel>() {
    ...
    public List<EventDbModel> queryAllList(boolean z10) {
        ...
        synchronized (this) {
            try {
                fixDatabaseCode14();
                From<TModel> from = SQLite.select(new IProperty[0]).from(EventDbModel.class);
                Where<TModel> where = from;
                if (!z10) {
                    where = from.where(EventDbModel_Table.reporting.eq(Boolean.FALSE));
                }
                queryList = where.orderBy(NameAlias.of(AnalyticsConfig.RTD_START_TIME), true).limit(1000).queryList();
            } catch (Exception e10) {
                e10.printStackTrace();
    ...
    public long queryAllSizeIntactEvent() {
        ...
        synchronized (this) {
            try {
                ...
                count = from.where(property.eq(bool), EventDbModel_Table.reporting.eq(bool)).count();
            } catch (Exception e10) {
                e10.printStackTrace();
                return 0;
            } catch (Throwable th) {
    ...
    public List<EventDbModel> queryByEventId(String str) {
        ...
        synchronized (this) {
            try {
                fixDatabaseCode14();
                queryList = SQLite.select(new IProperty[0]).from(EventDbModel.class).where(EventDbModel_Table.eventId.eq(str)).orderBy(NameAlias.of(AnalyticsConfig.RTD_START_TIME), true).queryList();
            } catch (Exception e10) {
                e10.printStackTrace();
                return new ArrayList();
            } catch (Throwable th) {
    ...
    public EventDbModel queryByEventIdAndTime(String str, long j10) {
        ...
        synchronized (this) {
            try {
                fixDatabaseCode14();
                eventDbModel = (EventDbModel) SQLite.select(new IProperty[0]).from(EventDbModel.class).where(EventDbModel_Table.eventId.eq(str), EventDbModel_Table.startTime.eq(Long.valueOf(j10))).querySingle();
            } catch (Exception e10) {
                e10.printStackTrace();
                return null;
            } catch (Throwable th) {
    ...
    public List<EventDbModel> queryLimitNum(boolean z10) {
        ...
        synchronized (this) {
            try {
                ...
                From<TModel> from = SQLite.select(new IProperty[0]).from(EventDbModel.class);
                if (z10) {
                    where = from.where(EventDbModel_Table.notIntactEvent.notEq(Boolean.TRUE));
                } else {
                    where = from.where(EventDbModel_Table.notIntactEvent.notEq(Boolean.TRUE), EventDbModel_Table.reporting.eq(Boolean.FALSE));
                }
    ...
    public long queryListSize() {
        synchronized (this) {
            ...
            try {
                ...
                Property<Boolean> property = EventDbModel_Table.notIntactEvent;
                Boolean bool = Boolean.FALSE;
                from.where(property.eq(bool), EventDbModel_Table.reporting.eq(bool)).queryList();
            } catch (Exception e10) {
                e10.printStackTrace();
            }
        }
    ...
    public void updateAllReportingStatus(boolean z10) {
        synchronized (this) {
            fixDatabaseCode14();
            try {
                SQLite.update(EventDbModel.class).set(EventDbModel_Table.reporting.is(Boolean.valueOf(z10))).execute();
            } catch (Exception e10) {
                e10.printStackTrace();
            }
        }
    ...
    public void updateEvent(String str, long j10, long j11) {
        synchronized (this) {
            fixDatabaseCode14();
            SQLite.update(EventDbModel.class).set(EventDbModel_Table.endTime.is(Long.valueOf(j10))).where(EventDbModel_Table.eventId.is(str), EventDbModel_Table.startTime.is(Long.valueOf(j11))).execute();
        }
    }
}

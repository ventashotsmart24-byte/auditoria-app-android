...
public class NetPerformanceMonitor extends BaseMonitor {
    ...
    public boolean beforeCommit() {
        if (this.real_to_bz_date == 0) {
            this.real_to_bz_date = this.f13165d;
        }
        this.accs_sdk_version = Constants.SDK_VERSION_CODE;
        this.total_time = a(this.f13162a, this.real_to_bz_date);
        this.start_to_enter_queue_time = a(this.f13162a, this.f13163b);
        this.in_queue_time = a(this.f13163b, this.take_date);
        this.talk_to_send_time = a(this.take_date, this.to_tnet_date);
        this.send_to_receive_time = a(this.to_tnet_date, this.f13164c);
        this.receive_to_distribute_time = a(this.f13164c, this.f13165d);
        this.distribute_to_service_time = a(this.f13165d, this.start_service);
        ...
        this.receive_accs_to_call_time = a(this.f13166e, this.f13167f);
        this.receive_agoo_to_call_time = a(this.f13166e, this.f13168g);
    ...
    public void onRecAck() {
        this.f13164c = System.currentTimeMillis();
    }
    ...
    public void onSend() {
        this.f13162a = System.currentTimeMillis();
    }
    ...
    public void onToAccsTime() {
        this.f13167f = System.currentTimeMillis();
    }
    ...
    public void onToBizDate() {
        this.f13165d = System.currentTimeMillis();
    }

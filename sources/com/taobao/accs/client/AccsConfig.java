...
public class AccsConfig {
    ...
    public static void build() {
        try {
            AccsClientConfig configByTag = AccsClientConfig.getConfigByTag(ACCSManager.getDefaultConfig((Context) null));
    ...
    private static AccsClientConfig.Builder getBuilder() {
        if (!TextUtils.isEmpty(ACCSManager.mDefaultAppkey)) {
            if (mBuilder == null) {
                mBuilder = new AccsClientConfig.Builder().setAppKey(ACCSManager.mDefaultAppkey).setTag(ACCSManager.getDefaultConfig((Context) null)).setAutoUnit(true);
            }
            return mBuilder;
        }
    ...
    public static void setAccsCenterHosts(String str, String str2, String str3) {
        ...
        ALog.i(TAG, "setAccsCenterHost", bd.f13841a, Integer.valueOf(ACCSManager.mEnv), "releaseHost", str, "prepareHost", str2, "dailyHost", str3);
    ...
    public static void setChannelHosts(String str, String str2, String str3) {
        ALog.i(TAG, bd.f13841a, Integer.valueOf(ACCSManager.mEnv), "setChannelHosts", "releaseHost", str, "prepareHost", str2, "dailyHost", str3);
        int i10 = ACCSManager.mEnv;
        if (i10 == 1) {

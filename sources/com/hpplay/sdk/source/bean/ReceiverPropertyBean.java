...
public class ReceiverPropertyBean implements Parcelable, Cloneable {
    public static final Parcelable.Creator<ReceiverPropertyBean> CREATOR = new Parcelable.Creator<ReceiverPropertyBean>() {
    ...
    public String toJson() {
        ...
        try {
            ...
            jSONObject.put("value", new JSONArray(Arrays.asList(this.value)));
    ...
    public ReceiverPropertyBean clone() {
        try {
            ReceiverPropertyBean receiverPropertyBean = new ReceiverPropertyBean();

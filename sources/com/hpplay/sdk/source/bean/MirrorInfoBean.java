...
public class MirrorInfoBean implements Parcelable {
    public static final Parcelable.Creator<MirrorInfoBean> CREATOR = new Parcelable.Creator<MirrorInfoBean>() {
    ...
    public void writeToParcel(Parcel parcel, int i10) {
        ...
        parcel.writeByte(this.audioEnable ? (byte) 1 : 0);
        parcel.writeByte(this.isFullScreen ? (byte) 1 : 0);
        parcel.writeByte(this.isShowExternalScreen ? (byte) 1 : 0);
        parcel.writeByte(this.isCloudMirror ? (byte) 1 : 0);
        parcel.writeByte(this.isAutoBitRate ? (byte) 1 : 0);
        parcel.writeInt(this.captureType);
        parcel.writeString(this.roomId);
        parcel.writeString(this.mSessionId);
        parcel.writeByte(this.isUseRealResolution ? (byte) 1 : 0);
        parcel.writeByte(this.isCustomAudio ? (byte) 1 : 0);
    }
    ...
    public MirrorInfoBean(Parcel parcel) {
        ...
        this.isCustomAudio = parcel.readByte() != 0 ? true : z10;
    }
}

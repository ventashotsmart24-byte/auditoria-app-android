...
public class PushConnectCallback implements LelinkSdkManager.ConnectCallback {
    ...
    public PushConnectCallback(Context context, OutParameter outParameter, LelinkPlayerInfo lelinkPlayerInfo, LelinkServiceInfo lelinkServiceInfo2) {
        this.mContext = context;
        this.playInfo = outParameter;
        this.playerInfo = lelinkPlayerInfo;
        this.lelinkServiceInfo = lelinkServiceInfo2;
    }

...
public class RelationReportTask {
    ...
    private Handler mHandler = new Handler(Looper.getMainLooper(), new Handler.Callback() {
        public boolean handleMessage(Message message) {
            ...
            try {
                ...
                SourceLog.w(RelationReportTask.TAG, (Throwable) e10);
                return false;
            }
        }
    });
    ...
    public static synchronized RelationReportTask getInstance() {
        RelationReportTask relationReportTask;
        synchronized (RelationReportTask.class) {
            ...
            relationReportTask = sInstance;
        }
        return relationReportTask;
    }
    ...
    private String getScanBody(List<LelinkServiceInfo> list) {
        ...
        for (LelinkServiceInfo next : list) {
            if (!(next == null || (browserTypeBean = BrowserHistory.getInstance().getBrowserTypeBean(next.getName())) == null)) {
                try {
                    if (browserTypeBean.isMDns) {
                        JSONObject jSONObject = new JSONObject();
                        jSONObject.put(ParamsMap.DeviceParams.KEY_UID, next.getUid());
                        jSONObject.put("pt", 1);
                    ...
                    if (browserTypeBean.isUPnP) {
                        ...
                        BrowserInfo browserInfo = CastUtil.getBrowserInfo(next, 3);
                        if (browserInfo != null) {
                    ...
                    if (browserTypeBean.isQRCode) {
                        ...
                        jSONObject3.put(ParamsMap.DeviceParams.KEY_UID, next.getUid());
                    ...
                    if (browserTypeBean.isPinCode) {
                        ...
                        jSONObject4.put(ParamsMap.DeviceParams.KEY_UID, next.getUid());
                    ...
                    if (browserTypeBean.isSonic) {
                        ...
                        jSONObject5.put(ParamsMap.DeviceParams.KEY_UID, next.getUid());
                    ...
                    if (browserTypeBean.isBle) {
                        ...
                        jSONObject6.put(ParamsMap.DeviceParams.KEY_UID, next.getUid());
    ...
    private String getScanTypes() {
        ...
        BrowserHistory instance = BrowserHistory.getInstance();
        if (instance.isUseMdns()) {
            sb.append("1,");
        }
        if (instance.isUseUPnP()) {
            sb.append("2,");
        }
        if (instance.isUseQR()) {
            sb.append("3,");
        }
        if (instance.isUsePinCode()) {
            sb.append("4,");
        }
        if (instance.isUseSonic()) {
            sb.append("5,");
        }
        if (instance.isUseBLE()) {
            sb.append("6,");
        }
        return sb.toString();
    }
    ...
    public void reportRelation(Context context) {
        ...
        if (browserList == null || browserList.isEmpty()) {
            ...
            long j10 = this.mStartTimeStamp;
            instance.relation(j10, this.mStopTimeStamp, "", "", "", getScanTypes(), BrowserBridge.getInstance().getBrowseErrorMsg());
            return;
        }
        StringBuilder sb = new StringBuilder();
        for (LelinkServiceInfo next : browserList) {
            BrowserInfo browserInfo = CastUtil.getBrowserInfo(next, 1);
            if (browserInfo != null) {
                browserInfo.getUid();
            }
            BrowserInfo browserInfo2 = CastUtil.getBrowserInfo(next, 3);
        ...
        SourceDataReport.getInstance().relation(this.mStartTimeStamp, this.mStopTimeStamp, sb2, scanBody, "", getScanTypes(), (String) null);
    }
    ...
    public void reportSinkDevice(long j10, String str, String str2) {
        SourceDataReport.getInstance().relation(this.mStartTimeStamp, j10, str2, (String) null, (String) null, (String) null, str, (String) null);
    }

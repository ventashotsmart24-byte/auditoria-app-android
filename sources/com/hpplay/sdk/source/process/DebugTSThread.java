                        ...
                        if (audioTSFrames != null && audioTSFrames.size() > 0) {
                            ...
                            for (int intValue2 = this.mDebugBean.audioReadSerial.intValue(); intValue2 < intValue; intValue2++) {
                                if (audioTSFrames.containsKey(Integer.valueOf(intValue2))) {
                                    ...
                                    SourceLog.i("MirrorAudio", String.format("serial: %d, capture: %d, encode time: %d, send time: %d", new Object[]{Integer.valueOf(debugTimestampInfoBean.getSerial()), Long.valueOf(debugTimestampInfoBean.getCaptureTS()), Integer.valueOf((int) debugTimestampInfoBean.getEncodeTime()), Long.valueOf(debugTimestampInfoBean.getSendTime())}));
                                }
                            }
                        }
                        if (videoTSFrames != null && videoTSFrames.size() > 0) {
                            ...
                            for (int intValue4 = this.mDebugBean.videoReadSerial.intValue(); intValue4 < intValue3; intValue4++) {
                                if (videoTSFrames.containsKey(Integer.valueOf(intValue4))) {
                                    ...
                                    SourceLog.i("MirrorVideo", String.format("serial: %d, init mediacodec time: %d, send time: %d", new Object[]{Integer.valueOf(debugTimestampInfoBean2.getSerial()), Long.valueOf(debugTimestampInfoBean2.getCaptureTS()), Long.valueOf(debugTimestampInfoBean2.getSendTime())}));
                                }
                            }
                        }
                        i11 = 0;

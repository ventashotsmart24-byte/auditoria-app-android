...
public class OnlineManager {
    ...
    private boolean isInBrowseList(LelinkServiceInfo lelinkServiceInfo) {
        ...
        if (!(lelinkServiceInfo == null || browserList == null)) {
            try {
                for (LelinkServiceInfo equals : browserList) {
                    if (equals.equals(lelinkServiceInfo)) {
                        return true;
                    }
                }
            } catch (Exception e10) {
                SourceLog.w("OnlineManager", (Throwable) e10);
            }
                ...
                public void run() {
                    ...
                    if (browserInfo != null) {
                        ...
                        if (tcpCheckTvState) {
                            ...
                            OnlineListener onlineListener = onlineListener;
                    ...
                    if (onlineListener4 != null) {
                        onlineListener4.OnLineCheckResult(lelinkServiceInfo, false);
                    }
                }

...
public class b implements VideoMgr.VideoFrameCallback {
    ...
    public SurfaceViewRenderer f11880a;

    /* renamed from: b  reason: collision with root package name */
    private int f11881b = 90;

    public b(SurfaceViewRenderer surfaceViewRenderer) {
        this.f11880a = surfaceViewRenderer;
    }
    ...
    public void a(String str, byte[] bArr, int i10, int i11, int i12, int i13, long j10) {
        ...
        int i17 = i11;
        int i18 = i12;
        this.f11880a.renderFrame(new VideoBaseRenderer.I420Frame(i17, i18, this.f11881b, iArr, new ByteBuffer[]{ByteBuffer.wrap(bArr2), ByteBuffer.wrap(bArr3), ByteBuffer.wrap(bArr4)}));
    }
    ...
    public void a(String str, int i10, int i11, float[] fArr, int i12, int i13, long j10) {
        if (this.f11880a != null) {
            ...
            i420Frame.rotationDegree = this.f11881b;
            this.f11880a.renderFrame(i420Frame);
        }
    }

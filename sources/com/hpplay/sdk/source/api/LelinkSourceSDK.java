...
public class LelinkSourceSDK {
    ...
    /* access modifiers changed from: private */
    public BrowserConfigBean mBrowseConfigBean = null;
    /* access modifiers changed from: private */
    public int mCallBrowseType = -1;
    ...
    public void setCacheList(List<ShortMediaBean> list) {
        if (list != null && !list.isEmpty()) {
            ...
            for (ShortMediaBean json : list) {
                JSONObject json2 = ShortMediaBean.toJSON(json);
                if (json2 != null) {
                    jSONArray.put(json2);
                }
            }
    ...
    public void addPinCodeToLelinkServiceInfo(String str, IParceResultListener iParceResultListener) {
        addPinCodeToLelinkServiceInfo(str, (IServiceInfoParseListener) new DeprecatedParceResultListenerWrapper(iParceResultListener));
    }

    @Deprecated
    public void addQRCodeToLelinkServiceInfo(String str, IParceResultListener iParceResultListener) {
        addQRCodeToLelinkServiceInfo(str, (IServiceInfoParseListener) new DeprecatedParceResultListenerWrapper(iParceResultListener));
    }
    ...
    public void setSinkTouchEventListener(ISinkTouchEventListener iSinkTouchEventListener) {
        setSinkTouchEventListener((SinkTouchEventArea) null, 0.0f, iSinkTouchEventListener);
    }
    ...
    public void setSinkTouchEventListener(float f10, ISinkTouchEventListener iSinkTouchEventListener) {
        setSinkTouchEventListener((SinkTouchEventArea) null, f10, iSinkTouchEventListener);
    }

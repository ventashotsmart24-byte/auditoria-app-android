...
public class LelinkServerInstance {
    ...
    public LelinkFileServer mFileServer;
    /* access modifiers changed from: private */
    public int mHttpPort = 8091;
    /* access modifiers changed from: private */
    ...
    public class PortCheckTask extends AsyncTask<Void, Void, Integer> {
        ...
        public Integer doInBackground(Void... voidArr) {
            if (HapplayUtils.checkLoaclPort(LelinkServerInstance.this.mHttpPort)) {
                ...
                int unused = lelinkServerInstance.mHttpPort = lelinkServerInstance.mHttpPort + new Random().nextInt(10);
        ...
        public void onPostExecute(Integer num) {
            int unused = LelinkServerInstance.this.mHttpPort = num.intValue();
            if (LelinkServerInstance.this.mFileServer == null) {
                LelinkServerInstance lelinkServerInstance = LelinkServerInstance.this;
                String unused2 = lelinkServerInstance.mLocalIp = lelinkServerInstance.getRealIp();
                LelinkFileServer unused3 = LelinkServerInstance.this.mFileServer = new LelinkFileServer(LelinkServerInstance.this.mLocalIp, LelinkServerInstance.this.mHttpPort);
                try {
                    LelinkServerInstance.this.mFileServer.start();
                } catch (IOException e10) {
                    SourceLog.w(LelinkServerInstance.TAG, (Throwable) e10);
                }
                ...
                try {
                    ...
                    LelinkFileServer unused4 = LelinkServerInstance.this.mFileServer = new LelinkFileServer(HapplayUtils.getLoaclIp(), LelinkServerInstance.this.mHttpPort);
                    LelinkServerInstance.this.mFileServer.start();
                } catch (Exception e11) {
                    SourceLog.w(LelinkServerInstance.TAG, (Throwable) e11);
                }
            }
    ...
    public String getRealIp() {
        ...
        try {
            if (HapplayUtils.isNetworkConnected(this.mContext)) {
                ...
                String relIp = getRelIp();
                if (TextUtils.isEmpty(relIp)) {
                    relIp = HapplayUtils.getLoaclIp();
                }

...
public class BrowserInfo implements Parcelable, Cloneable {
    ...
    public static final String KEY_M = (Device.ELEM_NAME + FieldUtil.getString(FieldUtil.f10533m));
        ...
        try {
            ...
            if (map != null && !map.isEmpty()) {
                for (String next : this.extras.keySet()) {
                    jSONObject2.put(next, this.extras.get(next));
                }
    ...
    public BrowserInfo(Parcel parcel) {
        ...
        this.isLocalWifi = parcel.readByte() == 0 ? false : z10;

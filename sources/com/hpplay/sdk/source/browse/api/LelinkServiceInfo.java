...
public class LelinkServiceInfo implements Parcelable, Cloneable, Comparable<LelinkServiceInfo> {
    public static final Parcelable.Creator<LelinkServiceInfo> CREATOR = new Parcelable.Creator<LelinkServiceInfo>() {
    ...
    public LelinkServiceInfo clone() {
        try {
            ...
            lelinkServiceInfo.mInstance = this.mInstance.clone();

...
public class ConferenceCodeParser implements CodeParser {
    ...
    public int agentPOrt = 30000;
    /* access modifiers changed from: private */
    public String guestModePincode;
    /* access modifiers changed from: private */
    public IConferenceMirrorListener mConferenceMirrorListener;
    /* access modifiers changed from: private */
    public IConferenceFuzzyMatchingPinCodeListener mFuzzyMatchingPinCodeListener;
            ...
            public void onRequestResult(AsyncHttpParameter asyncHttpParameter) {
                ...
                if (out.resultType != 0) {
                    ...
                    if (ConferenceCodeParser.this.mListener != null) {
                        ConferenceCodeParser.this.mListener.onParseResult(5, (LelinkServiceInfo) null);
                        return;
                    }
                    return;
                }
            ...
            public void onRequestResult(AsyncHttpParameter asyncHttpParameter) {
                ...
                if (out.resultType != 0) {
                    ...
                    if (ConferenceCodeParser.this.mFuzzyMatchingPinCodeListener != null) {
                        ConferenceCodeParser.this.mFuzzyMatchingPinCodeListener.onParseResult(5, (List<LelinkServiceInfo>) null);
                        return;
                    }
                    return;
                }
                ...
                try {
                    ...
                    if (optJSONObject != null) {
                        if (optJSONObject.length() > 0) {
                            ...
                            int optInt4 = optJSONObject.optInt(f.f14205t);
    ...
    public void parseGuestPinCode(String str) {
        try {
            ...
            if (iServiceInfoParseListener2 != null) {
                iServiceInfoParseListener2.onParseResult(0, (LelinkServiceInfo) null);
            }
        }
    }
    ...
    public void parsePinCode(PinCodeInfo pinCodeInfo) {
        if (TextUtils.isEmpty(pinCodeInfo.pinCode)) {
            ...
            IServiceInfoParseListener iServiceInfoParseListener = this.mListener;
            if (iServiceInfoParseListener != null) {
                iServiceInfoParseListener.onParseResult(0, (LelinkServiceInfo) null);
                return;
            }
            return;
        }
    ...
    public void resetGuestMode(String str, IConferenceMirrorListener iConferenceMirrorListener) {
        try {
            ...
            AsyncHttpParameter asyncHttpParameter = new AsyncHttpParameter("http://" + geustModeIp + SOAP.DELIM + this.agentPOrt + PUSH_SETTINGS + "type=visitorAuth&data=" + jSONObject.toString(), (String) null);
                ...
                public void onRequestResult(AsyncHttpParameter asyncHttpParameter) {
                    if (asyncHttpParameter.out.resultType == 2) {
                        ...
                        try {
                            ...
                            if (new JSONObject(asyncHttpParameter.out.result).getInt(Constant.KEY_STATUS) == 200) {
                                int unused = ConferenceCodeParser.this.agentPOrt = 30000;
                            ...
                            SourceLog.w(ConferenceCodeParser.TAG, (Throwable) e10);
                        }
                    }
                    ...
                    int unused2 = ConferenceCodeParser.this.agentPOrt = 30000;
                    if (ConferenceCodeParser.this.mConferenceMirrorListener != null) {
    ...
    public void setGuestMode(LelinkServiceInfo lelinkServiceInfo, String str, String str2, IConferenceMirrorListener iConferenceMirrorListener) {
        ...
        AsyncHttpParameter asyncHttpParameter = new AsyncHttpParameter(CloudAPI.sConferenceVisitorAuth + "username=" + str + "&password=" + str2, (String) null);
    ...
    public void startSetGuestMode(String str) {
        AsyncHttpParameter asyncHttpParameter = new AsyncHttpParameter(CloudAPI.sConferenceSetGuestMode + ("ip=" + this.mLelinkServiceInfo.getIp() + "&agentPort=" + this.mLelinkServiceInfo.getAgentPort() + "&token=" + str), (String) null);
        asyncHttpParameter.in.requestMethod = 0;
        AsyncManager.getInstance().exeHttpTask(asyncHttpParameter, new AsyncHttpRequestListener() {
            public void onRequestResult(AsyncHttpParameter asyncHttpParameter) {
                if (asyncHttpParameter.out.resultType == 2) {
                    ...
                    try {
                        SourceLog.debug(ConferenceCodeParser.TAG, "startSetGuestMode  request" + asyncHttpParameter.out.result);
                        if (new JSONObject(asyncHttpParameter.out.result).getInt(Constant.KEY_STATUS) == 200 && ConferenceCodeParser.this.mConferenceMirrorListener != null) {

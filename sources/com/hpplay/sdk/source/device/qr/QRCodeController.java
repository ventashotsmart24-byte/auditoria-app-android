...
public class QRCodeController {
        ...
        if (iServiceInfoParseListener == null) {
            ...
            if (str.contains("ip=") || str.contains("remotePort=")) {
                ...
                try {
                    ...
                    SourceLog.w("QRCodeController", (Throwable) e10);
                    str2 = str6;
                }
    ...
    private String getQrAsyncHttpParameter(String str) {
        ...
        hashMap.put("t", String.valueOf(TimeUnit.HOURS.toSeconds((long) instance.mExpireTime)));
    ...
    private String getShortUrlParameter() {
        ...
        sb.append("a=" + instance.appKey);
        sb.append("&cname=" + instance.getUID());
        sb.append("&tc=" + instance.serverPort);
        sb.append("&remotePort=" + instance.serverPort);
        sb.append("&ip=" + HapplayUtils.getLoaclIp());
        sb.append("&ver=2.0");
        sb.append(DispatchConstants.SIGN_SPLIT_SYMBOL);
        sb.append(FieldUtil.getString(FieldUtil.f10533m));
        sb.append(Operator.Operation.EQUALS);
        sb.append(Session.DEFAULT_M);
        sb.append("&hid=" + instance.getHID());
        return sb.toString();
    }
    ...
    public void parseQRCodeforServer(String str, IServiceInfoParseListener iServiceInfoParseListener) {
        ...
        AsyncManager.getInstance().exeHttpTask(asyncHttpParameter, new AsyncHttpRequestListener() {
            public void onRequestResult(AsyncHttpParameter asyncHttpParameter) {
                ...
                if (!TextUtils.isEmpty(asyncHttpParameter.out.result) && asyncHttpParameter.out.result.contains("411")) {
                    QRCodeController.this.callbackToApp(4, (LelinkServiceInfo) null);
                } else if (TextUtils.isEmpty(asyncHttpParameter.out.result)) {
                    QRCodeController.this.callbackToApp(5, (LelinkServiceInfo) null);
                } else {
                    QRCodeController.this.callbackToApp(5, (LelinkServiceInfo) null);
                }
            }
    ...
    private void requestLelinkTxtInfo(String str, String str2, String str3, String str4, String str5) {
        ...
        AsyncManager.getInstance().exeHttpTask(asyncHttpParameter, new AsyncHttpRequestListener() {
            public void onRequestResult(AsyncHttpParameter asyncHttpParameter) {
                ...
                if (i10 == 2) {
                    ...
                    SourceLog.debug("QRCodeController", "requestLelinkTxtInfo response:" + str);
                    LelinkServiceInfo lelinkTxtInfo = LelinkServiceInfoCreator.getLelinkTxtInfo(str6, str7, str8, str9, QRCodeController.this.plateForm, str, 2);
                    if (lelinkTxtInfo != null) {
                        ...
                        QRCodeController.this.callbackToApp(1, LelinkServiceInfoCreator.getQRCodeInfo(str10));
                    }
                } else {
        ...
        AsyncManager.getInstance().exeHttpTask(asyncHttpParameter, new AsyncHttpRequestListener() {
            ...
            public void onRequestResult(com.hpplay.common.asyncmanager.AsyncHttpParameter r5) {
                /*
                    ...
                    com.hpplay.sdk.source.log.SourceLog.w((java.lang.String) r1, (java.lang.String) r5)
                    return
                L_0x0025:
                    java.lang.String r0 = r5.result
                    r2 = 0
                    if (r0 == 0) goto L_0x003f
                    com.hpplay.common.utils.HttpEncrypt r0 = r1     // Catch:{ Exception -> 0x003b }
                    java.lang.String r5 = r0.decode(r5)     // Catch:{ Exception -> 0x003b }
                    com.hpplay.sdk.source.bean.ShortUrlBean r0 = new com.hpplay.sdk.source.bean.ShortUrlBean     // Catch:{ Exception -> 0x003b }
                    org.json.JSONObject r3 = new org.json.JSONObject     // Catch:{ Exception -> 0x003b }
                    r3.<init>(r5)     // Catch:{ Exception -> 0x003b }
                    r0.<init>(r3)     // Catch:{ Exception -> 0x003b }
                    goto L_0x0040
                L_0x003b:
                    r5 = move-exception
                    com.hpplay.sdk.source.log.SourceLog.w((java.lang.String) r1, (java.lang.Throwable) r5)
                L_0x003f:
                    r0 = r2
                L_0x0040:
                    ...
                    com.hpplay.sdk.source.browse.api.ICreateShortUrlListener r5 = r5

...
public class PublicCastClient {
            ...
            switch ((int) j10) {
                case PublicCastClient.ACTION_MIRROR /*33555199*/:
                    try {
                        ...
                        SourceLog.w(PublicCastClient.TAG, (Throwable) e10);
                        return;
                    }
    ...
    private OnConnectServerListener mServerListener = new OnConnectServerListener() {
        ...
        public void onConnectFailed() {
            ...
            for (OnConnectIMListener onConnectFailed : PublicCastClient.this.mIMListenerList) {
                boolean unused = PublicCastClient.this.isCallbackSeverFailed = true;
        ...
        public void onConnectSuccess() {
            ...
            boolean unused = PublicCastClient.this.isCallbackSeverFailed = false;
            for (OnConnectIMListener onConnectSuccess : PublicCastClient.this.mIMListenerList) {
        ...
        try {
            ...
            IMQueue.getInstance().addTask(asyncHttpParameter, new AsyncHttpRequestListener() {
                public void onRequestResult(AsyncHttpParameter asyncHttpParameter) {
                    ...
                    SourceLog.debug(PublicCastClient.TAG, "playControl " + i10 + " " + asyncHttpParameter.out.result);
                }
            });
        } catch (Exception e10) {
            SourceLog.w(TAG, (Throwable) e10);
        ...
        try {
            ...
            if (jSONArray.length() > 0) {
                for (int i10 = 0; i10 < jSONArray.length(); i10++) {
                    instance.parseByNetCast(jSONArray.optString(i10));
                }
            }
        } catch (Exception e11) {
    ...
    public void resolvePlayStateMsg(String str) {
        ...
        try {
            ...
            if (parseInt != 0) {
                ...
                this.mPlayStateListener.onPlaying(optString, jSONObject.optInt("duration"), optInt);
            }
        } catch (Exception e10) {
            SourceLog.w(TAG, (Throwable) e10);
        }
    ...
    public void reveiveSinkServiceMsg(int i10, String str) {
        ...
        for (AbsIMMsgReceiveListener onMsgReceive : this.mIMMsgReceiveListenerList) {
            onMsgReceive.onMsgReceive(i10, str);
        }
    }
    ...
    public void addVolume(OutParameter outParameter) {
        playControl(outParameter, 6, -1, -1, (String) null, -1);
    }
            ...
            IMQueue.getInstance().addTask(asyncHttpParameter, new AsyncHttpRequestListener() {
                public void onRequestResult(AsyncHttpParameter asyncHttpParameter) {
                    ...
                    if (out == null || TextUtils.isEmpty(out.result)) {
                        OnConnectSinkListener onConnectSinkListener = onConnectSinkListener;
                    ...
                    try {
                        int optInt = new JSONObject(decode).optInt(Constant.KEY_STATUS);
                        if (optInt == 200) {
    ...
    public void pause(OutParameter outParameter) {
        playControl(outParameter, 2, -1, -1, (String) null, -1);
    }
    ...
    public void play(OutParameter outParameter, String str, AsyncHttpRequestListener asyncHttpRequestListener) {
        ...
        try {
            ...
            if (dramaInfoBeanArr != null) {
                if (dramaInfoBeanArr.length > 0) {
                    JSONArray jSONArray = new JSONArray();
                    for (DramaInfoBean json : outParameter.urls) {
            ...
            JSONObject genPostContent2 = genPostContent(stringBuffer.toString(), str2, uid);
            SourceLog.i(TAG, "play push: " + genPostContent2.toString());
            AsyncHttpParameter asyncHttpParameter2 = new AsyncHttpParameter(CloudAPI.sGLSBRoot + PUSH_ACTION, genPostContent2.toString());
            asyncHttpParameter2.in.requestMethod = 1;
            IMQueue.getInstance().addTask(asyncHttpParameter2, asyncHttpRequestListener);
        } catch (Exception e13) {
    ...
    public void playNextDrama(OutParameter outParameter) {
        playControl(outParameter, 9, -1, -1, (String) null, -1);
    }

    public void playPreDrama(OutParameter outParameter) {
        playControl(outParameter, 10, -1, -1, (String) null, -1);
    }
    ...
    public void reconnect() {
        ...
        connectServer(this.mUrl, this.mToken, (OnConnectIMListener) null);
    }
    ...
    public void resume(OutParameter outParameter) {
        playControl(outParameter, 1, -1, -1, (String) null, -1);
    }

    public void seekTo(OutParameter outParameter, int i10) {
        playControl(outParameter, 4, i10, -1, (String) null, -1);
    }

    public void selectTrack(OutParameter outParameter, int i10) {
        playControl(outParameter, 11, -1, -1, (String) null, i10);
    }
    ...
    public void setPlayList(OutParameter outParameter, String str, DramaInfoBean[] dramaInfoBeanArr, int i10, int i11, int i12) {
        ...
        try {
            ...
            if (!DramaInfoBean.CLEAR_PLAY_LIST.equals(str)) {
                JSONArray jSONArray = new JSONArray();
                for (DramaInfoBean json : dramaInfoBeanArr) {
                    jSONArray.put(json.toJson());
                }
            ...
            IMQueue.getInstance().addTask(asyncHttpParameter, new AsyncHttpRequestListener() {
                public void onRequestResult(AsyncHttpParameter asyncHttpParameter) {
                    ...
                    SourceLog.debug(PublicCastClient.TAG, "setPlayList onRequestResult " + str);
                }
            });
        } catch (Exception e11) {
            SourceLog.w(TAG, (Throwable) e11);
    ...
    public void setVolume(OutParameter outParameter, int i10) {
        playControl(outParameter, 5, -1, i10, (String) null, -1);
    }

    public void stop(OutParameter outParameter) {
        playControl(outParameter, 3, -1, -1, (String) null, -1);
    }

    public void subVolume(OutParameter outParameter) {
        playControl(outParameter, 7, -1, -1, (String) null, -1);
    }

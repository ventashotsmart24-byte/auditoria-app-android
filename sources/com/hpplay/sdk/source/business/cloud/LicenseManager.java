...
public class LicenseManager {
    ...
    public ILicenseCheckListener mListener;
    /* access modifiers changed from: private */
    ...
    public void callbackError(int i10) {
        ...
        if (listenerDispatcher != null) {
            ...
            listenerDispatcher.onError((OutParameter) null, PlayerListenerConstant.WHAT_ERROR_LICENSE_INVALID, i11);
        }
    }
    ...
    public void requestLicense(Context context) {
        ...
        this.mTask = AsyncManager.getInstance().exeHttpTask(asyncHttpParameter, new AsyncHttpRequestListener() {
            public void onRequestResult(AsyncHttpParameter asyncHttpParameter) {
                int i10;
                AsyncTask unused = LicenseManager.this.mTask = null;
                ...
                if (out == null || out.resultType != 2) {
                    if (out == null || out.resultType != 0) {
                        ...
                        i10 = LicenseManager.this.parseLicense(context2, decode, str);
                    }
                    if (!LicenseManager.this.mRequestDone && LicenseManager.this.mListener != null) {
                        ...
                        ILicenseCheckListener unused2 = LicenseManager.this.mListener = null;
                    }
                    boolean unused3 = LicenseManager.this.mRequestDone = true;
                    if (i10 != 0) {

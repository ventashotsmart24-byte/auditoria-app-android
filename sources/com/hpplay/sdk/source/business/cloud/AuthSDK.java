...
public class AuthSDK {
    ...
    public List<AuthListener> mAuthListeners;
    /* access modifiers changed from: private */
    ...
    private void analysisServerList() {
        try {
            ...
            for (ServListEntity.UrlListEntity next : servListEntity.url_list) {
    ...
    public void cacheServerList(JSONObject jSONObject) {
        try {
            ...
            if (optJSONObject != null) {
                ...
                long j10 = Preference.getInstance().get(Preference.KEY_SDK_LOGIN_TIME, 0);
            ...
            public void onRequestResult(AsyncHttpParameter asyncHttpParameter) {
                ...
                if (asyncHttpParameter == null || (out = asyncHttpParameter.out) == null || out.resultType != 0) {
                    ...
                    if (LelinkSdkManager.getInstance().mSearchBannerDataCallback != null) {
                        LelinkSdkManager.getInstance().mSearchBannerDataCallback.onBannerData((String) null);
                        return;
                    }
                    return;
                }
    ...
    public void startAuth(String str) {
        ...
        long currentTimeMillis = System.currentTimeMillis() - Preference.getInstance().get(Preference.KEY_AUTH_FAIL_TIME, 0);
        ...
        final String str4 = Session.getInstance().appVersion;
        String str5 = Session.getInstance().appKey;
        String str6 = Session.getInstance().appSecret;
        HashMap hashMap = new HashMap();
        hashMap.put(ParamsMap.DeviceParams.KEY_UID, Session.getInstance().getUID());
        hashMap.put(ParamsMap.DeviceParams.KEY_APPID, str5);
        ...
        hashMap.put(FieldUtil.getString(FieldUtil.f10532a), LeboUtil.getAID(this.mContext));
        ...
        hashMap.put("sign", EncryptUtil.md5EncryData((((String) hashMap.get(ParamsMap.DeviceParams.KEY_UID)) + ((String) hashMap.get(ParamsMap.DeviceParams.KEY_APPID)) + ((String) hashMap.get(Constants.KEY_PACKAGE)) + ((String) hashMap.get(UMCrash.SP_KEY_TIMESTAMP))) + str6));
        ...
        this.mAuthTask = AsyncManager.getInstance().exeHttpTask(asyncHttpParameter, new AsyncHttpRequestListener() {
            public void onRequestResult(AsyncHttpParameter asyncHttpParameter) {
                int i10;
                String decode;
                AuthSDKBean authSDKBean = null;
                AsyncTask unused = AuthSDK.this.mAuthTask = null;
                    ...
                    try {
                        ...
                        if (out2.resultType == 0) {
                            ...
                            try {
                                ...
                                SourceLog.w(AuthSDK.TAG, "AuthSDK parse error:", e10);
                                AuthSDK.this.reportAuthFailedInfo(AuthSDK.AUTH_PARSE_ERROR);
                            }
                            if (authSDKBean != null) {
                                if (authSDKBean.data != null && AuthSDK.this.mAuthStatusCode = authSDKBean.status == 200) {
                            ...
                            authSDK3.reportAuthFailedInfo(AuthSDK.AUTH_NETWORK_ERROR + String.valueOf(asyncHttpParameter.out.responseCode));
                        }
                        ...
                        if (AuthSDK.this.mAuthStatusCode != 402) {
                            AuthSDK.this.reportLogin(str4);
                        }
                        SDKConfig.getInstance().requestConfig();
                    } catch (Exception e11) {
                        SourceLog.w(AuthSDK.TAG, (Throwable) e11);
                    }
                }
            }
        });

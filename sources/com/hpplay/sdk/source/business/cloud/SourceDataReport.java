...
public class SourceDataReport {
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.hpplay.sdk.source.business.cloud.SourceDataReport.AnonymousClass2.<clinit>():void");
        }
    }
    ...
    private void onConnect(int i10, int i11, String str, int i12, LelinkServiceInfo lelinkServiceInfo, long j10, int i13, String str2) {
        onConnect(i10, i11, str, i12, lelinkServiceInfo, j10, i13, str2, (String) null);
    }

    private void onConnectSuccess(int i10, int i11, String str, int i12, LelinkServiceInfo lelinkServiceInfo) {
        onConnect(i10, i11, str, i12, lelinkServiceInfo, 0, 1, "");
    }
    ...
    private void onMirrorSuccess(OutParameter outParameter) {
        ...
        onMirrorSend(outParameter, true, "", "", (String) null);
    }
    ...
    public void crashDataUpload(Map<String, String> map) {
        ...
        if (!TextUtils.isEmpty(preParameter)) {
            String[] split = preParameter.split(DispatchConstants.SIGN_SPLIT_SYMBOL);
    ...
    public void onAuthFailed(String str) {
        onConnect(5, 500, "", 0, (LelinkServiceInfo) null, 0, 0, str);
    }
    ...
    public void onCloudConnectFailed(String str, int i10, LelinkServiceInfo lelinkServiceInfo, String str2) {
        StringBuilder sb = new StringBuilder();
        sb.append("onCloudConnectFailed ");
        String str3 = str;
        sb.append(str);
        sb.append(" / ");
        sb.append(i10);
        ...
        onConnect(4, 408, str, i10, lelinkServiceInfo, 0, 0, str4);
    }
    ...
    public void onCloudDisconnect(String str, int i10, LelinkServiceInfo lelinkServiceInfo, int i11) {
        StringBuilder sb = new StringBuilder();
        sb.append("onCloudDisconnect ");
        sb.append(str);
        sb.append(" / ");
        int i12 = i10;
        sb.append(i12);
        SourceLog.i(TAG, sb.toString());
        onConnect(4, Constant.TOKEN_EXPIRED, str, i12, lelinkServiceInfo, 0, 1, "", i11, 0, (String) null);
    }
    ...
    public void onGetRoomFailed(OutParameter outParameter, String str) {
        onGetRoom(outParameter, false, (String) null, (String) null, str);
    }

    public void onGetRoomSuccess(OutParameter outParameter, String str) {
        onGetRoom(outParameter, true, str, (String) null, (String) null);
    }
    ...
    public void onLocalConnectFailed(String str, int i10, LelinkServiceInfo lelinkServiceInfo, String str2, String str3) {
        StringBuilder sb = new StringBuilder();
        sb.append("onLocalConnectFailed ");
        String str4 = str;
        sb.append(str);
        sb.append(" / ");
        sb.append(i10);
        ...
        sb.append(str5);
        SourceLog.i(TAG, sb.toString());
        onConnect(3, 6, str, i10, lelinkServiceInfo, 0, 0, str5, str3);
    }
    ...
    public void onLocalDisconnect(String str, int i10, LelinkServiceInfo lelinkServiceInfo, int i11) {
        StringBuilder sb = new StringBuilder();
        sb.append("onLocalDisconnect ");
        sb.append(str);
        sb.append(" / ");
        int i12 = i10;
        sb.append(i12);
        SourceLog.i(TAG, sb.toString());
        onConnect(3, 10, str, i12, lelinkServiceInfo, 0, 1, "", i11, 0, (String) null);
    }
    ...
    public void onPinCodeEnd(LelinkServiceInfo lelinkServiceInfo, String str, int i10, long j10) {
        onConnect(11, 1002, str, 0, lelinkServiceInfo, j10, i10, (String) null);
    }

    public void onPinCodeStart(String str) {
        onConnect(11, 1001, str, 0, (LelinkServiceInfo) null, 0, 0, (String) null);
    }
    ...
    public void onQRScanEnd(LelinkServiceInfo lelinkServiceInfo, String str, int i10, long j10) {
        onConnect(10, 1002, str, 0, lelinkServiceInfo, j10, i10, (String) null);
    }

    public void onQRScanStart(String str) {
        onConnect(10, 1001, str, 0, (LelinkServiceInfo) null, 0, 0, (String) null);
    }
    ...
    public void relation(long j10, long j11, String str, String str2, String str3, String str4, String str5) {
        relation(j10, j11, str, str2, str3, str4, (String) null, str5);
    }
    ...
    private void onQuality(JSONArray jSONArray, String str, boolean z10) {
        try {
            ...
            jSONObject.put("sn", 1);
            jSONObject.put("suc", instance.getUID());
            jSONObject.put("sc", instance.appKey);
            jSONObject.put(ParamsMap.DeviceParams.KEY_HID, instance.getHID());
    ...
    public void relation(long j10, long j11, String str, String str2, String str3, String str4, String str5, String str6) {
        if (!Feature.isNubiaChannel()) {
            ...
            sb.append(j10);
            sb.append("");
            hashMap.put("ltp", sb.toString());
            StringBuilder sb2 = new StringBuilder();
            long j13 = j11;
            sb2.append(j11);
            sb2.append("");
            hashMap.put("lte", sb2.toString());
            String oaid = DeviceUtil.getOAID(this.mContext);
    ...
    private void onConnect(int i10, int i11, String str, int i12, LelinkServiceInfo lelinkServiceInfo, long j10, int i13, String str2, int i14, int i15, String str3) {
        ...
        SourceLog.debug(TAG, "onConnect params :" + str5);

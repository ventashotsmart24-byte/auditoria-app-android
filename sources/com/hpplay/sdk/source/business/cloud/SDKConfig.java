...
public class SDKConfig {
    ...
    public SDKConfigBean mConfigBean;
    ...
    public void requestConfig() {
        ...
        AsyncManager.getInstance().exeHttpTask(new AsyncHttpParameter(CloudAPI.sConfig, HapplayUtils.getMapParams(hashMap)), new AsyncHttpRequestListener() {
            public void onRequestResult(AsyncHttpParameter asyncHttpParameter) {
                ...
                if (asyncHttpParameter != null && (out = asyncHttpParameter.out) != null && !TextUtils.isEmpty(out.result)) {
                    ...
                    if (formJSON != null) {
                        SDKConfigBean unused = SDKConfig.this.mConfigBean = formJSON;
                    }

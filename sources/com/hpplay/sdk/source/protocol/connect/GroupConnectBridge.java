...
public class GroupConnectBridge extends ConnectBridge {
    ...
    /* access modifiers changed from: private */
    public final AtomicInteger mCloudConnectState = new AtomicInteger();
    /* access modifiers changed from: private */
    public final SparseArray<ConnectBridge> mConnectionBridges = new SparseArray<>();
    private int mCurrentType = 0;
    /* access modifiers changed from: private */
    public LelinkServiceInfo mInfo;
    ...
    /* access modifiers changed from: private */
    public final AtomicInteger mLocalConnectState = new AtomicInteger();
    /* access modifiers changed from: private */
    public IConnectListener mOuterListener;
    /* access modifiers changed from: private */
    public int mReconnect;
    /* access modifiers changed from: private */
    public IConnectListener mReconnectListener;
            ...
            if (!GroupConnectBridge.this.isDisconnected) {
                if (GroupConnectBridge.this.isConnectConnected()) {
                    try {
                        ...
                        SourceLog.w(GroupConnectBridge.TAG, (Throwable) e10);
                    }
                } else {
                    if (GroupConnectBridge.this.mReconnect < 1) {
                        try {
                            ...
                            SourceLog.w(GroupConnectBridge.TAG, (Throwable) e11);
                            GroupConnectBridge groupConnectBridge2 = GroupConnectBridge.this;
    ...
    public void disconnect() {
        try {
            ...
            for (int i10 = 0; i10 < this.mConnectionBridges.size(); i10++) {
                this.mConnectionBridges.valueAt(i10).setConnectListener((IConnectListener) null);
    ...
    public void groupReconnect(int i10, LelinkServiceInfo lelinkServiceInfo, IConnectListener iConnectListener) {
        ...
        try {
            ...
            for (int i11 = 0; i11 < this.mConnectionBridges.size(); i11++) {
                this.mConnectionBridges.valueAt(i11).setConnectListener((IConnectListener) null);
            }
    ...
    public void release() {
        ...
        int i10 = 0;
        while (i10 < this.mConnectionBridges.size()) {
            try {

...
public class P2PProxy {
    ...
    /* access modifiers changed from: private */
    public ArrayList<WifiP2pDevice> wifiP2pDevices;
    ...
    private void discoverWifiP2pDevices() {
        ...
        if (iWDirectController != null) {
            iWDirectController.setBrowseResultListener(new IBrowseResultListener() {
                public void onBrowseResultCallback(int i10, Object obj) {
                    if (4 == i10) {
                        ArrayList arrayList = new ArrayList();
                        ArrayList unused = P2PProxy.this.wifiP2pDevices = (ArrayList) obj;
                        if (P2PProxy.this.wifiP2pDevices.size() > 0) {
                            for (int i11 = 0; i11 < P2PProxy.this.wifiP2pDevices.size(); i11++) {
                                String access$000 = P2PProxy.TAG;
                                SourceLog.e(access$000, "start onBrowseResultCallback ---- " + ((WifiP2pDevice) P2PProxy.this.wifiP2pDevices.get(i11)).deviceName);
                        ...
                        BrowserResolver.updateServiceList((List<LelinkServiceInfo>) arrayList);
                    }
                }
            });

...
public class g {
    ...
    private static final String f11806a = "DaReport";

    /* renamed from: b  reason: collision with root package name */
    private static final String f11807b = "__IP__";

    /* renamed from: c  reason: collision with root package name */
    private static final String f11808c = "__DURATION__";

    /* renamed from: d  reason: collision with root package name */
    private static g f11809d;
    ...
    public void a(Context context, String str, boolean z10, int i10, int i11) {
        if (TextUtils.isEmpty(str)) {
            SourceLog.w(f11806a, "thirdReport ignore,reason: url is empty");
            return;
        }
        String a10 = a(f11807b, DeviceUtil.getIPAddress(context), str);
        if (z10) {
            SourceLog.i(f11806a, "thirdReport duration: " + i10);
            a10 = a(f11808c, i10 + "", a10);
        }
        SourceLog.debug(f11806a, "thirdReport url: " + a10);
        AsyncHttpParameter asyncHttpParameter = new AsyncHttpParameter(a10, (String) null);
        ...
        AsyncManager.getInstance().exeHttpTask(asyncHttpParameter, new AsyncHttpRequestListener() {
            public void onRequestResult(AsyncHttpParameter asyncHttpParameter) {
                if (asyncHttpParameter.out.resultType == 0) {
                    SourceLog.debug(g.f11806a, "thirdReport success");
                } else {
                    SourceLog.debug(g.f11806a, "thirdReport fail");
                }
            }
        });
    }
    ...
    private Map<String, String> a(String str, OutParameter outParameter, String str2, String str3, int i10, boolean z10, String str4) {
        ...
        hashMap.put("apv", "1.1");
        hashMap.put(bd.f13864x, z10 ? "1" : "0");
        if (!z10) {
            hashMap.put("ec", str4);
        }

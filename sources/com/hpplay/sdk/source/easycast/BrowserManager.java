...
public class BrowserManager {
    ...
    public boolean isCastError = false;
    private boolean isPush = true;
    /* access modifiers changed from: private */
    public IEasyCastListener mCastListener;
    ...
    /* access modifiers changed from: private */
    public int mErrorExtra = -1;
    /* access modifiers changed from: private */
    public int mErrorWhat = -1;
    /* access modifiers changed from: private */
    public Handler mHandler = new Handler(Looper.getMainLooper());
    /* access modifiers changed from: private */
    public EasyCastBean mLastCastBean;
    /* access modifiers changed from: private */
    public LelinkServiceInfo mLastSelectInfo;
    /* access modifiers changed from: private */
    public String mPassword;
    /* access modifiers changed from: private */
    public INewPlayerListener mPlayerListener = new INewPlayerListener() {
            ...
            if (browserManager.checkSameCast(castBean, browserManager.mLastCastBean)) {
                ...
                BrowserManager.this.mHandler.post(new Runnable() {
                    public void run() {
                        ...
                        BrowserManager browserManager = BrowserManager.this;
                        browserManager.startPush(browserManager.mLastSelectInfo);
                    }
                });
            }
        }
        ...
        public void onError(CastBean castBean, int i10, int i11) {
            ...
            boolean unused = BrowserManager.this.isCastError = true;
            int unused2 = BrowserManager.this.mErrorWhat = i10;
            int unused3 = BrowserManager.this.mErrorExtra = i11;
        ...
        public void onLoading(CastBean castBean) {
            BrowserManager browserManager = BrowserManager.this;
            if (browserManager.checkSameCast(castBean, browserManager.mLastCastBean)) {
                boolean unused = BrowserManager.this.isCastError = false;
        ...
        public void onPositionUpdate(CastBean castBean, long j10, long j11) {
            ...
            if (browserManager.checkSameCast(castBean, browserManager.mLastCastBean)) {
                ...
                BrowserManager.this.mHandler.post(new Runnable() {
                    public void run() {
                        if (BrowserManager.this.mCastListener != null) {
                            BrowserManager.this.mCastListener.onCastPositionUpdate(BrowserManager.this.mLastSelectInfo, BrowserManager.this.mLastCastBean, j12, j13);
                        }
                    }
                });
            }
    ...
    private IServiceSelectListener mSelectListener = new IServiceSelectListener() {
        public void onSelect(LelinkServiceInfo lelinkServiceInfo) {
            ...
            LelinkServiceInfo unused = BrowserManager.this.mLastSelectInfo = lelinkServiceInfo;
    ...
    public boolean checkSameCast(CastBean castBean, EasyCastBean easyCastBean) {
        if (castBean == null || easyCastBean == null) {
            ...
            return true;
        } else if (!TextUtils.isEmpty(castBean.url) && !TextUtils.equals(castBean.url, easyCastBean.url)) {
            return false;
        } else {
            return true;
        }
        ...
        if (this.mController != null) {
            switch (i11) {
                ...
                case 210011:
                    ...
                    str = "请检查\n大屏和手机端网络后重试";
                    break;
                case PlayerListenerConstant.EXTRA_ERROR_MIRROR_SINK_UNSUPPORTED:
                    str2 = "不支持该功能";
                    str = "大屏设备不支持该功能";
                    break;
                case PlayerListenerConstant.EXTRA_ERROR_MIRROR_SINK_CLOUD_UNSUPPORTED:
                    str2 = "大屏设备版本过低";
                    str = "请升级大屏设备软件版本后重试";
                    break;
                default:
            ...
            SourceLog.i(TAG, "notifyError:" + str2 + Operator.Operation.DIVISION + str);
            this.mController.notifyError(str2, str);
        }
    }
    ...
    public void showPWDDialog() {
        ...
        new AlertDialog.Builder(this.mContext).setTitle("请输入密码").setView(editText).setPositiveButton("确定", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i10) {
                if (TextUtils.isEmpty(editText.getText().toString())) {
                    Toast.makeText(BrowserManager.this.mContext.getApplicationContext(), "请输入密码", 1).show();
                    return;
                }
                String unused = BrowserManager.this.mPassword = editText.getText().toString();
                BrowserManager browserManager = BrowserManager.this;
        ...
        if (this.mCastListener == null) {
            ...
            AsyncManager.getInstance().exeRunnable(new Runnable() {
                public void run() {
                    ...
                    EasyCastBean unused = BrowserManager.this.mLastCastBean = onCast;
    ...
    public void startBrowse(boolean z10, boolean z11, ViewGroup viewGroup, boolean z12) {
        ...
        } else if (TextUtils.isEmpty(LelinkSourceSDK.getInstance().getAppID()) || TextUtils.isEmpty(LelinkSourceSDK.getInstance().getAppSecret())) {

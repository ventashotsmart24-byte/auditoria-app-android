...
public class DNSInput {
    ...
    public int readU16() {
        ...
        this.pos = i11 + 1;
        return (b10 << 8) + (bArr[i11] & UnsignedBytes.MAX_VALUE);
    }
    ...
    public long readU32() {
        ...
        byte b10 = bArr[i10] & UnsignedBytes.MAX_VALUE;
        int i12 = i11 + 1;
        byte b11 = bArr[i11] & UnsignedBytes.MAX_VALUE;
        int i13 = i12 + 1;
        byte b12 = bArr[i12] & UnsignedBytes.MAX_VALUE;
        this.pos = i13 + 1;
        return (((long) b10) << 24) + ((long) (b11 << 16)) + ((long) (b12 << 8)) + ((long) (bArr[i13] & UnsignedBytes.MAX_VALUE));
    }

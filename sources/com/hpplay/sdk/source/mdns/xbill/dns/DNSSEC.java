...
public class DNSSEC {
    ...
    public static class ECKeyInfo {
        ...
        public BigInteger f11830a;

        /* renamed from: b  reason: collision with root package name */
        public BigInteger f11831b;
        EllipticCurve curve = new EllipticCurve(new ECFieldFp(this.f11833p), this.f11830a, this.f11831b);
        public BigInteger gx;
        public BigInteger gy;
        int length;

        /* renamed from: n  reason: collision with root package name */
        public BigInteger f11832n;

        /* renamed from: p  reason: collision with root package name */
        public BigInteger f11833p;
        ECParameterSpec spec = new ECParameterSpec(this.curve, new ECPoint(this.gx, this.gy), this.f11832n, 1);

        public ECKeyInfo(int i10, String str, String str2, String str3, String str4, String str5, String str6) {
            this.length = i10;
            this.f11833p = new BigInteger(str, 16);
            this.f11830a = new BigInteger(str2, 16);
            this.f11831b = new BigInteger(str3, 16);
            this.gx = new BigInteger(str4, 16);
            this.gy = new BigInteger(str5, 16);
            this.f11832n = new BigInteger(str6, 16);
        }
    }
    ...
    private static void verify(PublicKey publicKey, int i10, byte[] bArr, byte[] bArr2) {
        ...
        try {
            Signature instance = Signature.getInstance(algString(i10));
    ...
    public static RRSIGRecord sign(RRset rRset, DNSKEYRecord dNSKEYRecord, PrivateKey privateKey, Date date, Date date2, String str) {
        ...
        RRSIGRecord rRSIGRecord = r1;
        RRSIGRecord rRSIGRecord2 = new RRSIGRecord(rRset.getName(), rRset.getDClass(), rRset.getTTL(), rRset.getType(), algorithm, rRset.getTTL(), date2, date, dNSKEYRecord.getFootprint(), dNSKEYRecord.getName(), (byte[]) null);
        RRSIGRecord rRSIGRecord3 = rRSIGRecord;
        rRSIGRecord3.setSignature(sign(privateKey, dNSKEYRecord.getPublicKey(), algorithm, digestRRset(rRSIGRecord, rRset), str));
        return rRSIGRecord3;
    }
}

...
public class ZoneTransferIn {
    ...
    public static ZoneTransferIn newAXFR(Name name, SocketAddress socketAddress, TSIG tsig2) {
        return new ZoneTransferIn(name, Type.AXFR, 0, false, socketAddress, tsig2);
    }

    public static ZoneTransferIn newIXFR(Name name, long j10, boolean z10, SocketAddress socketAddress, TSIG tsig2) {
        return new ZoneTransferIn(name, Type.IXFR, j10, z10, socketAddress, tsig2);
    }
    ...
    private void sendQuery() {
        ...
        if (this.qtype == 251) {
            ...
            message.addRecord(new SOARecord(name, i10, 0, name2, name2, this.ixfr_serial, 0, 0, 0, 0), 2);
        }
        ...
        this.client.send(message.toWire((int) Message.MAXLENGTH));
    }
    ...
    public void setTimeout(int i10) {
        if (i10 >= 0) {
            this.timeout = ((long) i10) * 1000;
            return;
        }
        throw new IllegalArgumentException("timeout cannot be negative");
    }

    public static ZoneTransferIn newAXFR(Name name, String str, int i10, TSIG tsig2) {
        if (i10 == 0) {
            i10 = 53;
        }
        return newAXFR(name, new InetSocketAddress(str, i10), tsig2);
    }

    public static ZoneTransferIn newIXFR(Name name, long j10, boolean z10, String str, int i10, TSIG tsig2) {
        if (i10 == 0) {
            i10 = 53;
        }
        return newIXFR(name, j10, z10, (SocketAddress) new InetSocketAddress(str, i10), tsig2);
    }

    private ZoneTransferIn(Name name, int i10, long j10, boolean z10, SocketAddress socketAddress, TSIG tsig2) {
    ...
    public static ZoneTransferIn newIXFR(Name name, long j10, boolean z10, String str, TSIG tsig2) {
        return newIXFR(name, j10, z10, str, 0, tsig2);
    }

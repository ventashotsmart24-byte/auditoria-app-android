...
public class ElementHelper {
    ...
    public ElementHelper(Cache cache2, Object obj) {
        this.cache = new WeakReference<>(cache2);
    ...
    public int compareCredibility(int i10) {
        return ((Integer) this.compareCredibility.invoke(this.element, new Object[]{Integer.valueOf(i10)})).intValue();
    }
    ...
    public void resetExpire() {
        if (this.cache.get() != null) {
            this.expireField.setInt(this.element, limitExpire(getTTL(), (long) this.cache.get().getMaxCache()));
        }
    }
}

...
public interface j extends IInterface {
    ...
    public static abstract class a extends Binder implements j {
        ...
        public static class C0168a implements j {

            /* renamed from: a  reason: collision with root package name */
            private IBinder f11826a;

            public C0168a(IBinder iBinder) {
                this.f11826a = iBinder;
            }
            ...
            public void onAddDevice(int i10, int i11) {
                ...
                try {
                    ...
                    obtain.writeInt(i10);
                    obtain.writeInt(i11);
                    this.f11826a.transact(1, obtain, obtain2, 0);
            ...
            public void onGetDeviceList(int i10, int i11, List<LelinkServiceInfo> list) {
                ...
                try {
                    ...
                    this.f11826a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onRemoveDevice(int i10, int i11) {
                ...
                try {
                    ...
                    obtain.writeInt(i10);
                    obtain.writeInt(i11);
                    this.f11826a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onSetDeviceAlias(int i10, int i11) {
                ...
                try {
                    ...
                    obtain.writeInt(i10);
                    obtain.writeInt(i11);
                    this.f11826a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();

...
public final class TransformationUtils {
    ...
    public static Bitmap centerCrop(Bitmap bitmap, Bitmap bitmap2, int i10, int i11) {
        ...
        if (bitmap2.getWidth() * i11 > bitmap2.getHeight() * i10) {
            f11 = ((float) i11) / ((float) bitmap2.getHeight());
            f12 = (((float) i10) - (((float) bitmap2.getWidth()) * f11)) * 0.5f;
            f10 = 0.0f;
        } else {
            f11 = ((float) i10) / ((float) bitmap2.getWidth());
            f10 = (((float) i11) - (((float) bitmap2.getHeight()) * f11)) * 0.5f;
        }

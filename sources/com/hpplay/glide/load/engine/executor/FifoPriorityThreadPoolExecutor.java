...
public class FifoPriorityThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    public static class DefaultThreadFactory implements ThreadFactory {
        ...
        public Thread newThread(Runnable runnable) {
            AnonymousClass1 r02 = new Thread(runnable, "fifo-pool-thread-" + this.threadNum) {
                public void run() {
    ...
    public FifoPriorityThreadPoolExecutor(int i10, UncaughtThrowableStrategy uncaughtThrowableStrategy2) {
        this(i10, i10, 0, TimeUnit.MILLISECONDS, new DefaultThreadFactory(), uncaughtThrowableStrategy2);
    }

    public FifoPriorityThreadPoolExecutor(int i10, int i11, long j10, TimeUnit timeUnit, ThreadFactory threadFactory, UncaughtThrowableStrategy uncaughtThrowableStrategy2) {

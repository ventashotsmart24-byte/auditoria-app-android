...
public class RequestFutureTarget<T, R> implements FutureTarget<R>, Runnable {
    ...
    public synchronized boolean cancel(boolean r3) {
        ...
        L_0x0016:
            com.hpplay.glide.request.RequestFutureTarget$Waiter r3 = r2.waiter     // Catch:{ all -> 0x001d }
        ...
        L_0x001d:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hpplay.glide.request.RequestFutureTarget.cancel(boolean):boolean");
    }
    ...
    public RequestFutureTarget(Handler handler, int i10, int i11, boolean z10, Waiter waiter2) {

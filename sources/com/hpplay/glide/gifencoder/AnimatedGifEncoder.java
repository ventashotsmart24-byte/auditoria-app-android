...
public class AnimatedGifEncoder {
    ...
    private void getImagePixels() {
        ...
        int i10 = this.width;
        if (!(width2 == i10 && height2 == this.height)) {
    ...
    public void setDelay(int i10) {
        this.delay = Math.round(((float) i10) / 10.0f);
    }
    ...
    public boolean start(String str) {
        ...
        try {
            ...
            z10 = start((OutputStream) bufferedOutputStream);

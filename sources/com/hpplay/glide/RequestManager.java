...
public class RequestManager implements LifecycleListener {
    ...
    public final class ImageModelRequest<T> {
        ...
        public DrawableTypeRequest<T> load(T t10) {
            return (DrawableTypeRequest) from(RequestManager.getSafeClass(t10)).load(t10);
        }
    }
    ...
    public final class VideoModelRequest<T> {
        ...
        public DrawableTypeRequest<T> load(T t10) {
            return (DrawableTypeRequest) ((DrawableTypeRequest) RequestManager.this.optionsApplier.apply(new DrawableTypeRequest(RequestManager.getSafeClass(t10), (ModelLoader) null, this.loader, RequestManager.this.context, RequestManager.this.glide, RequestManager.this.requestTracker, RequestManager.this.lifecycle, RequestManager.this.optionsApplier))).load(t10);
        }
    }
    ...
    public <T> DrawableTypeRequest<T> load(T t10) {
        return (DrawableTypeRequest) loadGeneric(getSafeClass(t10)).load(t10);
    }
}

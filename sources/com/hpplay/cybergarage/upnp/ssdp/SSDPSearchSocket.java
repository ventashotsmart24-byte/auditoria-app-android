...
public class SSDPSearchSocket extends HTTPMUSocket implements Runnable {
    ...
    public boolean open(Inet4Address inet4Address) {
        ...
        return open(SSDP.ADDRESS, (int) SSDP.PORT, (InetAddress) inet4Address);
    }
    ...
    public boolean open(Inet6Address inet6Address) {
        ...
        return open(SSDP.getIPv6Address(), (int) SSDP.PORT, (InetAddress) inet6Address);
    }
    ...
    public boolean open(String str, String str2) {
        ...
        return open(str2, (int) SSDP.PORT, str);
    }

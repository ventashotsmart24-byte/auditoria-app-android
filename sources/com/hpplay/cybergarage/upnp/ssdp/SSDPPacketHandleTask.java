...
public class SSDPPacketHandleTask extends Thread {
    ...
    public SSDPPacketHandleTask(ControlPoint controlPoint) {
        ...
        this.mThreadPoolExecutor = new ThreadPoolExecutor(5, 5, 0, TimeUnit.SECONDS, new LinkedBlockingQueue(10), Executors.defaultThreadFactory(), new ThreadPoolExecutor.DiscardOldestPolicy());
    }

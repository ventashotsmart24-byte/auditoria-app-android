...
public class LocationCacheHandleTask extends Thread {
    ...
    public LocationCacheHandleTask(ControlPoint controlPoint) {
        ...
        try {
            ...
            String string = sharedPreferences.getString(KEY_DLNA_LOCATION, (String) null);
    ...
    private void deleteToLocal(String str) {
        try {
            ...
            String string = this.mPreferences.getString(KEY_DLNA_LOCATION, (String) null);
            if (!TextUtils.isEmpty(string)) {
    ...
    public void run() {
        ...
        try {
            ...
            int i10 = 0;
            while (true) {
                if (i10 >= this.mLocationList.size()) {
                    break;
                }

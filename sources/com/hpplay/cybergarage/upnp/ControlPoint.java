...
public class ControlPoint implements HTTPRequestListener {
    ...
    public void callbackResultCode(int i10) {
        int i11 = 0;
        while (i11 < this.deviceChangeListenerList.size()) {
            try {
                ((DeviceChangeListener) this.deviceChangeListenerList.get(i11)).deviceAdded(i10, (Device) null);
                i11++;
            } catch (Exception e10) {

...
public class Node {
    ...
    public void output(PrintWriter printWriter, int i10, boolean z10) {
        ...
        if (!hasNodes() || !z10) {
            printWriter.print(indentLevelString + Operator.Operation.LESS_THAN + name2);
            outputAttributes(printWriter);
            if (value2 == null || value2.length() == 0) {
                printWriter.println("></" + name2 + Operator.Operation.GREATER_THAN);
                return;
            }
            printWriter.println(Operator.Operation.GREATER_THAN + XML.escapeXMLChars(value2) + "</" + name2 + Operator.Operation.GREATER_THAN);
            return;
        }
        printWriter.print(indentLevelString + Operator.Operation.LESS_THAN + name2);
        outputAttributes(printWriter);
        ...
        printWriter.println(indentLevelString + "</" + name2 + Operator.Operation.GREATER_THAN);
    }

...
public class CertUtils {
    ...
    public static SSLSocketFactory getCertCAS() {
        ...
        try {
            ...
            try {
                byte[] bArr = DWP;
                instance.load(byteArrayInputStream, new String(bArr).toCharArray());
                byteArrayInputStream.close();
                KeyManagerFactory instance2 = KeyManagerFactory.getInstance(KeyManagerFactory.getDefaultAlgorithm());
                instance2.init(instance, new String(bArr).toCharArray());
                instance2.init(instance, new String(bArr).toCharArray());
                ...
                instance3.init(instance2.getKeyManagers(), new TrustManager[]{new X509TrustManager() {
                ...
                sSLSocketFactory = instance3.getSocketFactory();
                try {
                    byteArrayInputStream.close();
    ...
    public static SSLSocketFactory getCertCNS() {
        ...
        try {
            ...
            try {
                ...
                instance3.init(instance, new String(bArr).toCharArray());
                TrustManagerFactory instance4 = TrustManagerFactory.getInstance(TrustManagerFactory.getDefaultAlgorithm());
                instance4.init((KeyStore) null);
                instance2.init(instance3.getKeyManagers(), instance4.getTrustManagers(), new SecureRandom());
    ...
    public static TrustManager getDefaultTrustManager() {
        try {
            ...
            return instance.getTrustManagers()[0];
        } catch (Exception e10) {
            LeLog.w(TAG, (Throwable) e10);
            return null;
        }

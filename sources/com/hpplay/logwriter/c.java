...
public class c {
    ...
    private static final String f10591a = "DeviceInfoUtils";

    /* renamed from: b  reason: collision with root package name */
    private static final String f10592b = "status.txt";

    public static void a(String str, Context context) {
        File file = new File(str, f10592b);
        if (file.exists()) {
            file.delete();
            file = new File(str, f10592b);
        }
        try {
    ...
    public static String e() {
        ...
        if (totalRxBytes2 >= 1048576.0f) {
            return decimalFormat.format((double) (totalRxBytes2 / 1048576.0f)) + "MB/s";
        }
        return decimalFormat.format((double) (totalRxBytes2 / 1024.0f)) + "KB/s";
    }

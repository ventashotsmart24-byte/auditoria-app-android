...
public class PushControllerImpl extends IPushController {
            ...
            try {
                if (PushControllerImpl.this.mType == 3) {
                    ...
                    if (PushControllerImpl.this.mReverseChannel != null) {
                        ...
                        LelinkReverseChannel access$300 = PushControllerImpl.this.mReverseChannel;
                        PushControllerImpl pushControllerImpl = PushControllerImpl.this;
                        access$300.setRecevelistenerAndProtocol(pushControllerImpl.mReverseProtocolListener, pushControllerImpl.mPushBuilder.getReverseData().getBytes());
                ...
                CLog.w(PushControllerImpl.TAG, (Throwable) e10);
            }
        }
    };
    ...
    public void genPushConnection(String str, ParamsMap paramsMap) {
        ...
        if (paramsMap.get(ParamsMap.DeviceParams.KEY_LELINK_PORT) == null || paramsMap.get(ParamsMap.DeviceParams.KEY_LELINK_PORT).toString().length() <= 0) {
            i10 = 0;
        } else {
        ...
        if (i11 == 1) {
            ...
            this.mProtocolSender.startConnect((String) null, (String) null, this.mType, this.mConnectProtocolListener);
        } else if (i11 == 3) {
    ...
    public void setPlayList(ParamsMap paramsMap) {
        ...
        setConnectionState(true);
        this.mPlayType = 2;
        genPushConnection((String) null, paramsMap);
    }

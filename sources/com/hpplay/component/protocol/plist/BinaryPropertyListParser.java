...
public final class BinaryPropertyListParser {
    ...
    private NSObject parseObject(int i10) {
        ...
        switch (i12) {
            ...
            case 1:
                int i14 = i11 + 1;
                return new NSNumber(this.bytes, i14, ((int) Math.pow(2.0d, (double) b11)) + i14, 0);
            case 2:
                int i15 = i11 + 1;
                return new NSNumber(this.bytes, i15, ((int) Math.pow(2.0d, (double) b11)) + i15, 1);
            case 3:
                if (b11 == 3) {
                    return new NSDate(this.bytes, i11 + 1, i11 + 9);
                }
                throw new PropertyListFormatException("The given binary property list contains a date object of an unknown type (" + b11 + ")");
            case 4:
                int[] readLengthAndOffset = readLengthAndOffset(b11, i11);
                int i16 = readLengthAndOffset[0];
                int i17 = i11 + readLengthAndOffset[1];
                return new NSData(copyOfRange(this.bytes, i17, i16 + i17));
            case 5:
                int[] readLengthAndOffset2 = readLengthAndOffset(b11, i11);
                int i18 = readLengthAndOffset2[0];
                int i19 = i11 + readLengthAndOffset2[1];
                return new NSString(this.bytes, i19, i18 + i19, "ASCII");
            case 6:
                int[] readLengthAndOffset3 = readLengthAndOffset(b11, i11);
                int i20 = readLengthAndOffset3[0];
                int i21 = i11 + readLengthAndOffset3[1];
                return new NSString(this.bytes, i21, (i20 * 2) + i21, "UTF-16BE");
            case 7:
                int[] readLengthAndOffset4 = readLengthAndOffset(b11, i11);
                int i22 = readLengthAndOffset4[1];
                int i23 = i11 + i22;
                return new NSString(this.bytes, i23, calculateUtf8StringLength(this.bytes, i23, readLengthAndOffset4[0]) + i23, "UTF-8");
            case 8:
                int i24 = i11 + 1;
                return new UID(String.valueOf(i10), copyOfRange(this.bytes, i24, b11 + 1 + i24));
            case 10:
                int[] readLengthAndOffset5 = readLengthAndOffset(b11, i11);
                ...
                while (i13 < i25) {
                    ...
                    int i29 = i13 + 1;
                    nSArray.setValue(i13, parseObject((int) parseUnsignedInt(bArr, (i13 * i28) + i27, i27 + (i28 * i29))));
                    i13 = i29;
                }
                return nSArray;
            case 11:
                int[] readLengthAndOffset6 = readLengthAndOffset(b11, i11);
                ...
                while (i13 < i30) {
                    ...
                    i13++;
                    nSSet.addObject(parseObject((int) parseUnsignedInt(bArr2, (i13 * i33) + i32, i32 + (i33 * i13))));
                }
                return nSSet;
            case 12:
                int[] readLengthAndOffset7 = readLengthAndOffset(b11, i11);
                ...
                while (i13 < i34) {
                    ...
                    i13++;
                    nSSet2.addObject(parseObject((int) parseUnsignedInt(bArr3, (i13 * i37) + i36, i36 + (i37 * i13))));
                }
                return nSSet2;
            case 13:
                int[] readLengthAndOffset8 = readLengthAndOffset(b11, i11);
                ...
                while (i13 < i38) {
                    ...
                    int i42 = i13 + 1;
                    int parseUnsignedInt = (int) parseUnsignedInt(bArr4, (i13 * i41) + i40, (i41 * i42) + i40);
                    byte[] bArr5 = this.bytes;
                    int i43 = this.objectRefSize;
                    NSObject parseObject = parseObject(parseUnsignedInt);
                    nSDictionary.put(parseObject.toString(), parseObject((int) parseUnsignedInt(bArr5, (i38 * i43) + i40 + (i13 * i43), i40 + (i38 * i43) + (i43 * i42))));
                    i13 = i42;
                }
                return nSDictionary;
            default:
    ...
    private int[] readLengthAndOffset(int i10, int i11) {
        ...
        if (i10 == 15) {
            ...
            int pow = (int) Math.pow(2.0d, (double) (b10 & 15));
            i12 = pow + 2;
            if (pow < 3) {
                int i14 = i11 + 2;
    ...
    public static double parseDouble(byte[] bArr, int i10, int i11) {
        ...
        if (i12 == 4) {
            return (double) Float.intBitsToFloat((int) parseLong(bArr, i10, i11));
        }
    ...
    public static long parseLong(byte[] bArr, int i10, int i11) {
        long j10 = 0;
        while (i10 < i11) {
            j10 = (j10 << 8) | ((long) (bArr[i10] & UnsignedBytes.MAX_VALUE));
            i10++;
        }
        return j10;
    }

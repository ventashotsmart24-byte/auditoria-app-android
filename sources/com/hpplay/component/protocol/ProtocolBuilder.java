...
public class ProtocolBuilder {
    ...
    public ProtocolBuilder getAudioSetUpCmd(String str) {
        this.mBuildProtocol = String.format(AUDIO_SETUP_CMD, new Object[]{str}) + "\r\n";
        return this;
    }

    public ProtocolBuilder getAunounce(String str) {
        this.mBuildProtocol = String.format(ANNOUNCE_CMD, new Object[]{str}) + "\r\n";
        return this;
    }
    ...
    public ProtocolBuilder getParameterCmd(String str) {
        this.mBuildProtocol = String.format(GET_PARAMETER_CMD, new Object[]{str}) + "\r\n";
        return this;
    }
    ...
    public ProtocolBuilder getRecordCmd(String str) {
        this.mBuildProtocol = String.format(RECORD_CMD, new Object[]{str}) + "\r\n";
        return this;
    }
    ...
    public ProtocolBuilder getSetParameterCmd(String str) {
        this.mBuildProtocol = String.format(SET_PARAMETER_CMD, new Object[]{str}) + "\r\n";
        return this;
    }
    ...
    public ProtocolBuilder getTearDown(String str) {
        this.mBuildProtocol = String.format(TEARDOWN_CMD, new Object[]{str}) + "\r\n";
        return this;
    }
    ...
    public ProtocolBuilder getVideoMetaData() {
        String str;
        String str2;
        boolean isEmpty = TextUtils.isEmpty(this.mResolution);
        String str3 = "unknown";
        String str4 = DIDL_LITE_END_NODE;
        String str5 = ITEMID_END_NODE;
        if (isEmpty) {
            StringBuilder sb = new StringBuilder();
    ...
    public ProtocolBuilder getVideoSetUpCmd(String str) {
        this.mBuildProtocol = String.format(VIDEO_SETUP_CMD, new Object[]{str}) + "\r\n";
        return this;
    }
    ...
    public ProtocolBuilder setBrowseInfo(String str, String str2, String str3, String str4) {
        ...
        try {
            ...
            CLog.w("setBrowseInfo", (Throwable) e10);
        }
        return this;
    }

...
public class SRP6ServerSession extends SRP6Session {
    ...
    private BigInteger f10567b;
    private boolean noSuchUserIdentity;
    private State state;

    /* renamed from: v  reason: collision with root package name */
    private BigInteger f10568v;
    ...
    public BigInteger step1(String str, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        this.userID = str;
        if (bigInteger != null) {
            this.f10570s = bigInteger;
            if (bigInteger2 != null) {
                this.f10568v = bigInteger2;
                if (this.state == State.INIT) {
                    ...
                    this.f10569k = sRP6Routines.computeK(messageDigestInstance, sRP6CryptoParams.N, sRP6CryptoParams.f10566g);
                    messageDigestInstance.reset();
                    this.f10567b = this.srp6Routines.generatePrivateValue(this.config.N, this.random);
                    messageDigestInstance.reset();
                    SRP6Routines sRP6Routines2 = this.srp6Routines;
                    SRP6CryptoParams sRP6CryptoParams2 = this.config;
                    this.B = sRP6Routines2.computePublicServerValue(sRP6CryptoParams2.N, sRP6CryptoParams2.f10566g, this.f10569k, bigInteger2, this.f10567b);
    ...
    public BigInteger step2(BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        if (bigInteger != null) {
            ...
            if (bigInteger2 != null) {
                ...
                } else if (this.srp6Routines.isValidPublicValue(this.config.N, bigInteger)) {
                    MessageDigest messageDigestInstance = this.config.getMessageDigestInstance();
                    if (this.hashedKeysRoutine != null) {
                        this.f10571u = this.hashedKeysRoutine.computeU(this.config, new URoutineContext(bigInteger, this.B));
                    } else {
                        this.f10571u = this.srp6Routines.computeU(messageDigestInstance, this.config.N, bigInteger, this.B);
                        messageDigestInstance.reset();
                    }
                    BigInteger computeSessionKey = this.srp6Routines.computeSessionKey(this.config.N, this.f10568v, this.f10571u, bigInteger, this.f10567b);
                    this.S = computeSessionKey;
                    if (this.clientEvidenceRoutine != null) {
                        bigInteger3 = this.clientEvidenceRoutine.computeClientEvidence(this.config, new SRP6ClientEvidenceContext(this.userID, this.f10570s, bigInteger, this.B, computeSessionKey));
                    } else {
                        bigInteger3 = this.srp6Routines.computeClientEvidence(messageDigestInstance, bigInteger, this.B, computeSessionKey);
                        messageDigestInstance.reset();
                    }
                    if (this.noSuchUserIdentity || !bigInteger3.equals(bigInteger2)) {

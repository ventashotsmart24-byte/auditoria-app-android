...
public class SRP6Server extends SRP6Tool {
    ...
    public void run() {
        ...
        AnonymousClass1 r12 = new SRP6ServerSession(getConfig(HTTP.TAB)) {
            {
        ...
        BigInteger step1 = r12.step1(readInput, readBigInteger, readBigInteger());
        println();
        ...
        try {
            BigInteger step2 = r12.step2(readBigInteger2, readBigInteger());
            println();
            logM2(BigIntegerUtils.toHex(step2));
            println();
            println("Mutual authentication successfully completed");
            println();
            logS(BigIntegerUtils.toHex(r12.getSessionKey()));
            logShash(r12.getSessionKeyHash());

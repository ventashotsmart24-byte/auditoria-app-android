...
public class NLProtocolBuiler extends ProtocolBuilder {
    ...
    public NLProtocolBuiler getAudioSetUpCmd(String str, String str2) {
        this.mBuildProtocol = String.format(NEW_LELINK_AUDIO_SETUP_CMD, new Object[]{str, str2}) + "\r\n";
        return this;
    }
    ...
    public NLProtocolBuiler getRecordCmd(String str, String str2) {
        this.mBuildProtocol = String.format(NEW_LELINK_RECORD_CMD, new Object[]{str, str2}) + "\r\n";
        return this;
    }
    ...
    public NLProtocolBuiler getTearDownCmd(String str, String str2) {
        this.mBuildProtocol = String.format(NEW_LELINK_TEARDOWN_CMD, new Object[]{str, str2}) + "\r\n";
        return this;
    }
    ...
    public NLProtocolBuiler getVideoSetUpCmd(String str, String str2) {
        this.mBuildProtocol = String.format(NEW_LELINK_VIDEO_SETUP_CMD, new Object[]{str, str2}) + "\r\n";
        return this;
    }

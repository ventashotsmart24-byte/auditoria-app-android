...
public class ConnectTask extends IConnector implements Runnable {
    ...
    private final ProtocolListener mDisconnectedListener = new ProtocolListener() {
        public void onResult(int i10, String... strArr) {
            ...
            try {
                ...
                CLog.w(ConnectTask.TAG, (Throwable) e10);
            }
        ...
        public void onResult(int i10, String... strArr) {
            if (20 != i10 || strArr == null) {
                ...
                try {
                    ...
                    ParamsMap unused = ConnectTask.this.mMap = ParamsMap.create(strArr[0]);
    ...
    private boolean startConnect() {
        ...
        if (this.isConnected) {
            ...
            if (protocolListener2 != null) {
                protocolListener2.onResult(11, "successful", String.valueOf(this.mConnectType), this.mFeature);
            }
    ...
    public void checkConnection(ProtocolListener protocolListener2) {
        CLog.i(TAG, "checkConnection ~~~~" + this.isActiveCheck);
        if (this.isActiveCheck || !this.isConnected) {
            protocolListener2.onResult(20, (String[]) null);
            return;
        }
        this.isActiveCheck = true;
        this.mCheckconnectionListener = protocolListener2;
        unLockThread();
    }

    public void connect(ParamsMap paramsMap, ProtocolListener protocolListener2) {
            ...
            if (this.mFailedCount > 2) {
                ...
                try {
                    ...
                    if (this.isAppPause.get()) {
                        ...
                        j10 = (long) this.mConnectionCheckInterval;
                    }
                    lockThread(j10);
                    this.isLock.set(false);
    ...
    public boolean sendPassthroughData(int i10, String str, String str2, ProtocolListener protocolListener2) {
        LelinkPassthroughChannel lelinkPassthroughChannel = this.mLelinkPassthroughChannel;
        if (lelinkPassthroughChannel == null) {
            return false;
        }
        return lelinkPassthroughChannel.sendPassthData(i10, str, str2, protocolListener2);
    }

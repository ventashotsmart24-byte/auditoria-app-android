...
public class LelinkPassthroughChannel {
    ...
    public static String TAG = "LelinkPassthroughChannel";
    ...
    public static class ProtocolResultPaser extends ProtocolListener {
        ...
        public void onResult(int i10, String... strArr) {
            try {
                ...
                CLog.w("lelinkpassths", (Throwable) e10);
            }
        }
    }
    ...
    public void connect() {
        ...
        this.mProtocolSender.startConnect(this.mSessionId, (String) null, 1, new ProtocolListener() {
            public void onResult(int i10, String... strArr) {
    ...
    public void startPassthroughChannel() {
        ...
        this.mProtocolReceiver.setRecevelistenerAndProtocol(new ProtocolListener() {
            public void onResult(int i10, String... strArr) {
                try {
                    String access$000 = LelinkPassthroughChannel.TAG;
                    CLog.i(access$000, "---------> cmd :" + i10 + " result : " + Base64.encodeBytes(strArr[0].getBytes()));
                } catch (Exception e10) {
                    CLog.w(LelinkPassthroughChannel.TAG, (Throwable) e10);
                }
                    ...
                    try {
                        ...
                        if (nSDictionary.containsKey("data")) {
                            ...
                            if (!TextUtils.isEmpty(obj) && LelinkPassthroughChannel.this.mProtocolListener != null) {
                                ...
                                String access$0002 = LelinkPassthroughChannel.TAG;
                                CLog.i(access$0002, "---------> cmd :" + i10 + " result : " + Base64.encodeBytes(parsePassthroughData[0].getBytes()));
                            }
                        }
                    } catch (Exception e11) {
                        CLog.w(LelinkPassthroughChannel.TAG, (Throwable) e11);
                    }
                }
            }
    ...
    public void startSendData(int i10, String str, ProtocolListener protocolListener) {
        if (this.isIMPush) {
            ...
            ProtocolResultPaser protocolResultPaser = new ProtocolResultPaser(i10, protocolListener);
            this.mProtocolSender.protocolEnqueue(protocolResultPaser, str.getBytes());
        }
    }
}

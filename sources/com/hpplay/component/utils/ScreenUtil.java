...
public class ScreenUtil {
    ...
    private static double getScreenInches(Context context) {
        double sqrt = Math.sqrt(Math.pow((double) getScreenWidth(context), 2.0d) + Math.pow((double) getScreenHeight(context), 2.0d));
        double densityDpi = (double) getDensityDpi(context);

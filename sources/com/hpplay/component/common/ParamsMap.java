...
public class ParamsMap extends ConcurrentHashMap {
    ...
    public int getAirplayPort() {
        if (get(DeviceParams.KEY_AIRPLAY_PORT) == null) {
            return 0;
        }
    ...
    public String getAppKey() {
        if (get(DeviceParams.KEY_APPID) == null) {
            return "";
        }
    ...
    public String getChannelVersion() {
        if (get(DeviceParams.KEY_CHANNEL_VERSION) == null) {
            return "";
        }
    ...
    public String getCuid() {
        if (get(DeviceParams.KEY_UID) == null) {
            return "";
        }
    ...
    public String getHID() {
        if (get(DeviceParams.KEY_HID) == null) {
            return "";
        }
    ...
    public int getLelinkPort() {
        if (get(DeviceParams.KEY_LELINK_PORT) == null) {
            return 0;
        }
    ...
    public String getMac() {
        if (get(DeviceParams.KEY_MAC) == null) {
            return "";
        }
    ...
    public String getMediaType() {
        if (get(PushParams.KEY_MEDIA_TYPE) == null) {
            return "";
        }
    ...
    public int getRaopPort() {
        if (get(DeviceParams.KEY_RAOP_PORT) == null) {
            return 0;
        }
    ...
    public String getRuid() {
        if (get(DeviceParams.KEY_RECEIVER_UID) == null) {
            return "";
        }
    ...
    public String getToken() {
        if (get(DeviceParams.KEY_AUTH_TOKEN) == null) {
            return "";
        }

...
public final class AdReportBean {
    ...
    public static /* synthetic */ AdReportBean copy$default(AdReportBean adReportBean, String str, String str2, int i10, int i11, String str3, String str4, String str5, int i12, String str6, String str7, String str8, long j10, long j11, int i13, Object obj) {
        AdReportBean adReportBean2 = adReportBean;
        int i14 = i13;
        return adReportBean.copy((i14 & 1) != 0 ? adReportBean2.ad_id : str, (i14 & 2) != 0 ? adReportBean2.ad_name : str2, (i14 & 4) != 0 ? adReportBean2.display_times : i10, (i14 & 8) != 0 ? adReportBean2.click_times : i11, (i14 & 16) != 0 ? adReportBean2.sn : str3, (i14 & 32) != 0 ? adReportBean2.user_id : str4, (i14 & 64) != 0 ? adReportBean2.user_name : str5, (i14 & 128) != 0 ? adReportBean2.apk_version : i12, (i14 & 256) != 0 ? adReportBean2.app_id : str6, (i14 & 512) != 0 ? adReportBean2.media_type : str7, (i14 & 1024) != 0 ? adReportBean2.ad_type : str8, (i14 & 2048) != 0 ? adReportBean2.last_update_timestamp : j10, (i14 & 4096) != 0 ? adReportBean2.game_stay_time : j11);
    }
    ...
    public final AdReportBean copy(String str, String str2, int i10, int i11, String str3, String str4, String str5, int i12, String str6, String str7, String str8, long j10, long j11) {
        ...
        i.g(str14, "app_id");
        String str15 = str7;
        i.g(str15, "media_type");
        String str16 = str8;
        i.g(str16, "ad_type");
        return new AdReportBean(str9, str10, i10, i11, str11, str12, str13, i12, str14, str15, str16, j10, j11);
    }

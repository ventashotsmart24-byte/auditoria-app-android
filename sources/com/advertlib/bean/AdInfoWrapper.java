...
public final class AdInfoWrapper {
    ...
    public AdInfoWrapper(AdInfo adInfo2, String str) {
        i.g(str, "cachePath");
        this.adInfo = adInfo2;
        this.cachePath = str;
    }

    public static /* synthetic */ AdInfoWrapper copy$default(AdInfoWrapper adInfoWrapper, AdInfo adInfo2, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            adInfo2 = adInfoWrapper.adInfo;
        }
        if ((i10 & 2) != 0) {
            str = adInfoWrapper.cachePath;
        }
        return adInfoWrapper.copy(adInfo2, str);
    }
    ...
    public final AdInfoWrapper copy(AdInfo adInfo2, String str) {
        i.g(str, "cachePath");
        return new AdInfoWrapper(adInfo2, str);
    }
    ...
    public int hashCode() {
        ...
        return ((adInfo2 == null ? 0 : adInfo2.hashCode()) * 31) + this.cachePath.hashCode();
    }

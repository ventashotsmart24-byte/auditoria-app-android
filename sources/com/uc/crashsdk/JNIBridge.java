...
public class JNIBridge {
    ...
    public static long cmd(int i10) {
        return nativeCmd(i10, 0, (String) null, (Object[]) null);
    }
    ...
    private static void onKillProcess(String str, int i10, int i11) {
        ...
        f10.insert(0, String.format(locale, "SIG: %d, fg: %s, exiting: %s, main process: %s, time: %s\n", new Object[]{Integer.valueOf(i11), Boolean.valueOf(b.B()), Boolean.valueOf(b.u()), Boolean.valueOf(b.F()), e.n()}));
        f10.insert(0, String.format(locale, "Kill PID: %d (%s) by pid: %d (%s) tid: %d (%s)\n", new Object[]{Integer.valueOf(i10), e.a(i10), Integer.valueOf(Process.myPid()), e.a(Process.myPid()), Integer.valueOf(Process.myTid()), Thread.currentThread().getName()}));
    ...
    private static int registerInfoCallback(String str, int i10, long j10, int i11) {
        return a.a(str, i10, (Callable<String>) null, j10, i11);
    }

    public static long set(int i10, boolean z10) {
        return nativeSet(i10, z10 ? 1 : 0, (String) null, (Object[]) null);
    }

    public static long cmd(int i10, String str) {
        return nativeCmd(i10, 0, str, (Object[]) null);
    }

    public static long set(int i10, long j10) {
        return nativeSet(i10, j10, (String) null, (Object[]) null);
    }

    public static long set(int i10, String str) {
        return nativeSet(i10, 0, str, (Object[]) null);
    }
}

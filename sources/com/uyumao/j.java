...
public class j {
    ...
    public static Context f16286a;

    public static class a {

        /* renamed from: a  reason: collision with root package name */
        public static final j f16287a = new j();
    }
    ...
    public synchronized i a() {
        ...
        iVar = null;
        try {
            Intent registerReceiver = f16286a.registerReceiver((BroadcastReceiver) null, new IntentFilter("android.intent.action.BATTERY_CHANGED"));
            int i10 = 0;
            ...
            i iVar2 = new i();
            try {
                iVar2.f16280a = intExtra;
                iVar2.f16281b = intExtra2;
                iVar2.f16283d = i11;
                iVar2.f16282c = intExtra3;
                iVar2.f16284e = i10;
                iVar2.f16285f = System.currentTimeMillis();

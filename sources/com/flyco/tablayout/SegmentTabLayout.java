...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attributeSet) {
        ...
        float dimension = obtainStyledAttributes.getDimension(R.styleable.SegmentTabLayout_tl_tab_width, (float) dp2px(-1.0f));
        this.mTabWidth = dimension;
        int i11 = R.styleable.SegmentTabLayout_tl_tab_padding;
        if (this.mTabSpaceEqual || dimension > 0.0f) {
            i10 = dp2px(0.0f);
        } else {
            i10 = dp2px(10.0f);
        }
        this.mTabPadding = obtainStyledAttributes.getDimension(i11, (float) i10);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i10 = 0; i10 < this.mTabCount; i10++) {
            View inflate = View.inflate(this.mContext, R.layout.layout_tab_segment, (ViewGroup) null);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (!isInEditMode() && this.mTabCount > 0) {
            ...
            gradientDrawable.setBounds(i11, (int) f12, (int) (((float) (paddingLeft + rect.right)) - this.mIndicatorMarginRight), (int) (f12 + this.mIndicatorHeight));

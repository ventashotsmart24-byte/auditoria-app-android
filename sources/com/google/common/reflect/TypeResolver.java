            ...
            new TypeVisitor() {
                ...
                public void visitGenericArrayType(GenericArrayType genericArrayType) {
                    ...
                    if (!(type instanceof WildcardType)) {
                        ...
                        Preconditions.checkArgument(z10, "%s is not an array type.", (Object) type2);
                ...
                public void visitParameterizedType(ParameterizedType parameterizedType) {
                    ...
                    if (!(type instanceof WildcardType)) {
                        ...
                        Preconditions.checkArgument(z10, "%s not compatible with %s", (Object) parameterizedType, (Object) parameterizedType2);
                        for (int i10 = 0; i10 < actualTypeArguments.length; i10++) {
                ...
                public void visitWildcardType(WildcardType wildcardType) {
                    ...
                    if (type instanceof WildcardType) {
                        ...
                        Preconditions.checkArgument(z10, "Incompatible type: %s vs. %s", (Object) wildcardType, (Object) type2);

...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static final class Digit extends RangesMatcher {
        ...
        private static char[] nines() {
            ...
            for (int i10 = 0; i10 < 37; i10++) {
                cArr[i10] = (char) (ZEROES.charAt(i10) + 9);
            }
            return cArr;
        }
    ...
    private static CharMatcher precomputedPositive(int i10, BitSet bitSet, String str) {
        ...
        } else if (isSmall(i10, bitSet.length())) {
    ...
    public CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(this, precomputedPositive(i10, bitSet, str)) {
            public String toString() {
                return charMatcher;
            }
        };
    ...
    public String replaceFrom(CharSequence charSequence, CharSequence charSequence2) {
        ...
        do {
            sb.append(charSequence3, i10, indexIn);
            sb.append(charSequence2);
            i10 = indexIn + 1;
            indexIn = indexIn(charSequence3, i10);
        } while (indexIn != -1);
        sb.append(charSequence3, i10, length2);
        return sb.toString();
    }
}

    ...
    public final class QueueWorker implements Runnable {
        ...
        private void workOnQueue() {
            /*
                ...
                r1 = 0
            L_0x0002:
                com.google.common.util.concurrent.SequentialExecutor r2 = com.google.common.util.concurrent.SequentialExecutor.this     // Catch:{ all -> 0x008c }
                java.util.Deque r2 = r2.queue     // Catch:{ all -> 0x008c }
                monitor-enter(r2)     // Catch:{ all -> 0x008c }
                if (r0 != 0) goto L_0x002b
                com.google.common.util.concurrent.SequentialExecutor r0 = com.google.common.util.concurrent.SequentialExecutor.this     // Catch:{ all -> 0x0089 }
                com.google.common.util.concurrent.SequentialExecutor$WorkerRunningState r0 = r0.workerRunningState     // Catch:{ all -> 0x0089 }
            ...
            L_0x0020:
                com.google.common.util.concurrent.SequentialExecutor r0 = com.google.common.util.concurrent.SequentialExecutor.this     // Catch:{ all -> 0x0089 }
                com.google.common.util.concurrent.SequentialExecutor.access$308(r0)     // Catch:{ all -> 0x0089 }
                com.google.common.util.concurrent.SequentialExecutor r0 = com.google.common.util.concurrent.SequentialExecutor.this     // Catch:{ all -> 0x0089 }
                com.google.common.util.concurrent.SequentialExecutor.WorkerRunningState unused = r0.workerRunningState = r3     // Catch:{ all -> 0x0089 }
                r0 = 1
            L_0x002b:
                com.google.common.util.concurrent.SequentialExecutor r3 = com.google.common.util.concurrent.SequentialExecutor.this     // Catch:{ all -> 0x0089 }
                java.util.Deque r3 = r3.queue     // Catch:{ all -> 0x0089 }
                java.lang.Object r3 = r3.poll()     // Catch:{ all -> 0x0089 }
                java.lang.Runnable r3 = (java.lang.Runnable) r3     // Catch:{ all -> 0x0089 }
                r9.task = r3     // Catch:{ all -> 0x0089 }
            ...
            L_0x004d:
                ...
                r1 = r1 | r2
                r2 = 0
                java.lang.Runnable r3 = r9.task     // Catch:{ RuntimeException -> 0x005e }
                r3.run()     // Catch:{ RuntimeException -> 0x005e }
            L_0x0059:
                r9.task = r2     // Catch:{ all -> 0x008c }
                goto L_0x0002
            L_0x005c:
                r0 = move-exception
                goto L_0x0086
            L_0x005e:
                r3 = move-exception
                java.util.logging.Logger r4 = com.google.common.util.concurrent.SequentialExecutor.log     // Catch:{ all -> 0x005c }
                java.util.logging.Level r5 = java.util.logging.Level.SEVERE     // Catch:{ all -> 0x005c }
                java.lang.Runnable r6 = r9.task     // Catch:{ all -> 0x005c }

...
public abstract class AbstractService implements Service {
    ...
    public static final class StateSnapshot {
        ...
        public Throwable failureCause() {
            ...
            Preconditions.checkState(z10, "failureCause() is only valid if the service has failed, service is %s", (Object) state2);
            Throwable th = this.failure;
            Objects.requireNonNull(th);
            return th;
        }

        public StateSnapshot(Service.State state2, boolean z10, @CheckForNull Throwable th) {
            boolean z11 = false;
            Preconditions.checkArgument(!z10 || state2 == Service.State.STARTING, "shutdownWhenStartupFinishes can only be set if state is STARTING. Got %s instead.", (Object) state2);
            Preconditions.checkArgument((th != null) == (state2 == Service.State.FAILED) ? true : z11, "A failure cause should be set if and only if the state is failed.  Got %s and %s instead.", (Object) state2, (Object) th);
            this.state = state2;

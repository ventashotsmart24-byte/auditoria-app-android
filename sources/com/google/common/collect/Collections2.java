...
public final class Collections2 {
    ...
    public static final class OrderedPermutationCollection<E> extends AbstractCollection<List<E>> {
        ...
        private static <E> int calculateSize(List<E> list, Comparator<? super E> comparator2) {
            ...
            int i12 = 1;
            while (i10 < list.size()) {
                if (comparator2.compare(list.get(i10 - 1), list.get(i10)) < 0) {
    ...
    public static class PermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        public void calculateNextPermutation() {
            ...
            if (size != -1) {
                int i10 = 0;
                while (true) {
                    int[] iArr = this.f10057c;
                    int i11 = this.f10058j;
                    int i12 = iArr[i11];
                    int i13 = this.f10059o[i11] + i12;
                    if (i13 < 0) {
                        switchDirection();
                    } else if (i13 != i11 + 1) {
                        Collections.swap(this.list, (i11 - i12) + i10, (i11 - i13) + i10);
                        this.f10057c[this.f10058j] = i13;
                        return;
                    } else if (i11 != 0) {
                        i10++;
                        switchDirection();
    ...
    public static StringBuilder newStringBuilderForCollection(int i10) {
        ...
        return new StringBuilder((int) Math.min(((long) i10) * 8, IjkMediaMeta.AV_CH_STEREO_RIGHT));
    }

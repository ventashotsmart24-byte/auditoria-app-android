...
class ObjectCountHashMap<K> {
    ...
    public class MapEntry extends Multisets.AbstractEntry<K> {
        ...
        public MapEntry(int i10) {
            this.key = ObjectCountHashMap.this.keys[i10];
    ...
    private void resizeTable(int i10) {
        ...
        int i11 = ((int) (((float) i10) * this.loadFactor)) + 1;
        ...
        for (int i12 = 0; i12 < this.size; i12++) {
            ...
            newTable[i13] = i12;
            jArr[i12] = (((long) hash) << 32) | (NEXT_MASK & ((long) i14));
        }
        this.threshold = i11;
        this.table = newTable;
    }
    ...
    private static long swapNext(long j10, int i10) {
        return (j10 & HASH_MASK) | (NEXT_MASK & ((long) i10));
    }

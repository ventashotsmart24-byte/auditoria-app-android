...
public final class Hashing {
    ...
    public static final class ConcatenatedHashFunction extends AbstractCompositeHashFunction {
        ...
        public HashCode makeHash(Hasher[] hasherArr) {
            ...
            for (Hasher hash : hasherArr) {
                ...
                i10 += hash2.writeBytesTo(bArr, i10, hash2.bits() / 8);
            }
    ...
    public static final class LinearCongruentialGenerator {
        ...
        public double nextDouble() {
            ...
            this.state = j10;
            double d10 = (double) (((int) (j10 >>> 33)) + 1);
            Double.isNaN(d10);
    ...
    public static HashCode combineOrdered(Iterable<HashCode> iterable) {
        ...
        for (HashCode asBytes : iterable) {
            ...
            for (int i10 = 0; i10 < asBytes2.length; i10++) {
                bArr[i10] = (byte) ((bArr[i10] * 37) ^ asBytes2[i10]);
            }
        }
        return HashCode.fromBytesNoCopy(bArr);
    }
    ...
    public static HashCode combineUnordered(Iterable<HashCode> iterable) {
        ...
        for (HashCode asBytes : iterable) {
            ...
            Preconditions.checkArgument(z10, "All hashcodes must have the same bit length.");
            for (int i10 = 0; i10 < asBytes2.length; i10++) {
                bArr[i10] = (byte) (bArr[i10] + asBytes2[i10]);
            }
        }
        return HashCode.fromBytesNoCopy(bArr);
    }

...
final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    public static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        private long f10083h1;

        /* renamed from: h2  reason: collision with root package name */
        private long f10084h2;
        ...
        private void bmix64(long j10, long j11) {
            long mixK1 = mixK1(j10) ^ this.f10083h1;
            this.f10083h1 = mixK1;
            long rotateLeft = Long.rotateLeft(mixK1, 27);
            long j12 = this.f10084h2;
            this.f10083h1 = ((rotateLeft + j12) * 5) + 1390208809;
            long mixK2 = mixK2(j11) ^ j12;
            this.f10084h2 = mixK2;
            this.f10084h2 = ((Long.rotateLeft(mixK2, 31) + this.f10083h1) * 5) + 944331445;
        }
        ...
        public HashCode makeHash() {
            long j10 = this.f10083h1;
            int i10 = this.length;
            long j11 = this.f10084h2 ^ ((long) i10);
            long j12 = (j10 ^ ((long) i10)) + j11;
            this.f10083h1 = j12;
            this.f10084h2 = j11 + j12;
            this.f10083h1 = fmix64(j12);
            long fmix64 = fmix64(this.f10084h2);
            long j13 = this.f10083h1 + fmix64;
            this.f10083h1 = j13;
            this.f10084h2 = fmix64 + j13;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f10083h1).putLong(this.f10084h2).array());
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x00f6, code lost:
            r11.f10083h1 ^= mixK1(r2);
            r11.f10084h2 ^= mixK2(r7);
         */
        ...
        public void processRemaining(java.nio.ByteBuffer r12) {
            ...
            L_0x00eb:
                ...
                long r2 = r2 ^ r0
            L_0x00f6:
                long r0 = r11.f10083h1
                long r2 = mixK1(r2)
                long r0 = r0 ^ r2
                r11.f10083h1 = r0
                long r0 = r11.f10084h2
                long r2 = mixK2(r7)
                long r0 = r0 ^ r2
                r11.f10084h2 = r0
                return

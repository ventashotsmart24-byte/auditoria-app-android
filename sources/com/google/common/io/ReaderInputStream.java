...
final class ReaderInputStream extends InputStream {
    ...
    public ReaderInputStream(Reader reader2, Charset charset, int i10) {
        this(reader2, charset.newEncoder().onMalformedInput(CodingErrorAction.REPLACE).onUnmappableCharacter(CodingErrorAction.REPLACE), i10);
    }
    ...
    public ReaderInputStream(Reader reader2, CharsetEncoder charsetEncoder, int i10) {
        boolean z10 = true;
        ...
        Preconditions.checkArgument(i10 <= 0 ? false : z10, "bufferSize must be positive: %s", i10);

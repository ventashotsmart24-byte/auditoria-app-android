...
public abstract class BaseEncoding {
    ...
    public static final class Base16Encoding extends StandardBaseEncoding {
        ...
        public void encodeTo(Appendable appendable, byte[] bArr, int i10, int i11) {
            ...
            for (int i12 = 0; i12 < i11; i12++) {
                byte b10 = bArr[i10 + i12] & UnsignedBytes.MAX_VALUE;
                appendable.append(this.encoding[b10]);
                appendable.append(this.encoding[b10 | 256]);
            }
        }
    ...
    public static final class Base64Encoding extends StandardBaseEncoding {
        ...
        public void encodeTo(Appendable appendable, byte[] bArr, int i10, int i11) {
            ...
            while (i11 >= 3) {
                int i13 = i10 + 1;
                int i14 = i13 + 1;
                byte b10 = ((bArr[i10] & UnsignedBytes.MAX_VALUE) << 16) | ((bArr[i13] & UnsignedBytes.MAX_VALUE) << 8) | (bArr[i14] & UnsignedBytes.MAX_VALUE);
                appendable.append(this.alphabet.encode(b10 >>> Ascii.DC2));
                appendable.append(this.alphabet.encode((b10 >>> 12) & 63));
                appendable.append(this.alphabet.encode((b10 >>> 6) & 63));
                appendable.append(this.alphabet.encode(b10 & 63));
                i11 -= 3;
                i10 = i14 + 1;
            }
            if (i10 < i12) {
    ...
    public static class StandardBaseEncoding extends BaseEncoding {
            ...
            if (this.alphabet.isValidPaddingStartPosition(trimTrailingPadding.length())) {
                ...
                while (i10 < trimTrailingPadding.length()) {
                    ...
                    while (true) {
                        ...
                        if (i12 >= alphabet2.charsPerChunk) {
                            break;
                        }
                        j10 <<= alphabet2.bitsPerChar;
                        if (i10 + i12 < trimTrailingPadding.length()) {
                            j10 |= (long) this.alphabet.decode(trimTrailingPadding.charAt(i13 + i10));
                            i13++;
                        }
                        i12++;
                    }
                    int i14 = alphabet2.bytesPerChunk;
                    int i15 = (i14 * 8) - (i13 * alphabet2.bitsPerChar);
                    int i16 = (i14 - 1) * 8;
                    while (i16 >= i15) {
                        ...
                        if (read != -1) {
                            ...
                            if (ch == null || ch.charValue() != c10) {
                                if (!this.hitPadding) {
                                    ...
                                    this.bitBuffer = i12;
                                    int decode = alphabet.decode(c10) | i12;
        ...
        public void encodeChunkTo(Appendable appendable, byte[] bArr, int i10, int i11) {
            ...
            for (int i13 = 0; i13 < i11; i13++) {
                j10 = (j10 | ((long) (bArr[i10 + i13] & UnsignedBytes.MAX_VALUE))) << 8;
            }
            int i14 = ((i11 + 1) * 8) - this.alphabet.bitsPerChar;
            while (i12 < i11 * 8) {
                Alphabet alphabet2 = this.alphabet;
                appendable.append(alphabet2.encode(((int) (j10 >>> (i14 - i12))) & alphabet2.mask));
        ...
        public int maxEncodedSize(int i10) {
            Alphabet alphabet2 = this.alphabet;
            return alphabet2.charsPerChunk * IntMath.divide(i10, alphabet2.bytesPerChunk, RoundingMode.CEILING);
        }
        ...
        public BaseEncoding withSeparator(String str, int i10) {
            ...
            for (int i11 = 0; i11 < str.length(); i11++) {
                Preconditions.checkArgument(!this.alphabet.matches(str.charAt(i11)), "Separator (%s) cannot contain alphabet characters", (Object) str);
            }
            Character ch = this.paddingChar;
            if (ch != null) {
                ...
                Preconditions.checkArgument(z10, "Separator (%s) cannot contain padding character", (Object) str);
            }
            return new SeparatedBaseEncoding(this, str, i10);
        }

        public StandardBaseEncoding(Alphabet alphabet2, @CheckForNull Character ch) {
    ...
    public static Appendable separatingAppendable(Appendable appendable, String str, int i10) {
        ...
        Preconditions.checkArgument(z10);
        return new Appendable(i10, appendable, str) {
    ...
    public static Writer separatingWriter(final Writer writer, String str, int i10) {
        ...
        return new Writer() {
            ...
            public void write(int i10) {
                separatingAppendable.append((char) i10);
            }

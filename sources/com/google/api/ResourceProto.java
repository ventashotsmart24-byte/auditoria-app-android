...
public final class ResourceProto {
    ...
    static {
        ...
        resourceReference = GeneratedMessageLite.newSingularGeneratedExtension(defaultInstance, defaultInstance2, defaultInstance3, (Internal.EnumLiteMap<?>) null, RESOURCE_REFERENCE_FIELD_NUMBER, fieldType, ResourceReference.class);
        resourceDefinition = GeneratedMessageLite.newRepeatedGeneratedExtension(DescriptorProtos.FileOptions.getDefaultInstance(), ResourceDescriptor.getDefaultInstance(), (Internal.EnumLiteMap<?>) null, 1053, fieldType, false, ResourceDescriptor.class);
        resource = GeneratedMessageLite.newSingularGeneratedExtension(DescriptorProtos.MessageOptions.getDefaultInstance(), ResourceDescriptor.getDefaultInstance(), ResourceDescriptor.getDefaultInstance(), (Internal.EnumLiteMap<?>) null, 1053, fieldType, ResourceDescriptor.class);
    }

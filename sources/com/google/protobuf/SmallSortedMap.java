...
class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public class DescendingEntryIterator implements Iterator<Map.Entry<K, V>> {
        ...
        public Map.Entry<K, V> next() {
            ...
            int i10 = this.pos - 1;
            this.pos = i10;
            return (Map.Entry) access$600.get(i10);
        }
    }
        ...
        public void remove() {
            if (this.nextCalledBeforeRemove) {
                ...
                if (this.pos < SmallSortedMap.this.entryList.size()) {
                    ...
                    int i10 = this.pos;
                    this.pos = i10 - 1;
                    Object unused = smallSortedMap.removeArrayEntryAt(i10);
                    return;
                }
    ...
    public static <FieldDescriptorType extends FieldSet.FieldDescriptorLite<FieldDescriptorType>> SmallSortedMap<FieldDescriptorType, Object> newFieldMap(int i10) {
        return new SmallSortedMap<FieldDescriptorType, Object>(i10) {
            public void makeImmutable() {
                if (!isImmutable()) {
                    for (int i10 = 0; i10 < getNumArrayEntries(); i10++) {
                        Map.Entry arrayEntryAt = getArrayEntryAt(i10);
    ...
    public V put(K k10, V v10) {
        ...
        if (size == i11) {
            Entry remove = this.entryList.remove(i11 - 1);

...
final class Utf8 {
    ...
    public static class DecodeUtil {
        ...
        public static void handleFourBytes(byte b10, byte b11, byte b12, byte b13, char[] cArr, int i10) {
            ...
            int trailingByteValue = ((b10 & 7) << Ascii.DC2) | (trailingByteValue(b11) << 12) | (trailingByteValue(b12) << 6) | trailingByteValue(b13);
    ...
    public static abstract class Processor {
        ...
        private static int partialIsValidUtf8(ByteBuffer byteBuffer, int i10, int i11) {
            int access$200 = i10 + Utf8.estimateConsecutiveAscii(byteBuffer, i10, i11);
            while (access$200 < i11) {
                int i12 = access$200 + 1;
                byte b10 = byteBuffer.get(access$200);
                if (b10 < 0) {
                    if (b10 < -32) {
                        if (i12 >= i11) {
                            return b10;
    ...
    public static final class UnsafeProcessor extends Processor {
        ...
        private static int unsafeIncompleteStateFor(byte[] bArr, int i10, long j10, int i11) {
            ...
            if (i11 == 2) {
                return Utf8.incompleteStateFor(i10, (int) UnsafeUtil.getByte(bArr, j10), (int) UnsafeUtil.getByte(bArr, j10 + 1));
            }
        ...
        public String decodeUtf8Direct(ByteBuffer byteBuffer, int i10, int i11) {
            ...
            if ((i12 | i13 | ((byteBuffer.limit() - i12) - i13)) >= 0) {
                long addressOffset = UnsafeUtil.addressOffset(byteBuffer) + ((long) i12);
                long j11 = ((long) i13) + addressOffset;
                ...
                while (true) {
                    ...
                    while (j10 < j11) {
                        ...
                        if (DecodeUtil.isOneByte(b11)) {
                            ...
                            if (j12 < j11) {
                                j10 = j12 + 1;
                                DecodeUtil.handleTwoBytes(b11, UnsafeUtil.getByte(j12), cArr, i15);
                                i15++;
                            } else {
                                throw InvalidProtocolBufferException.invalidUtf8();
                            }
                            ...
                            if (j12 < j11 - 1) {
                                long j13 = j12 + 1;
                                DecodeUtil.handleThreeBytes(b11, UnsafeUtil.getByte(j12), UnsafeUtil.getByte(j13), cArr, i15);
                                i15++;
                                j10 = j13 + 1;
                            } else {
                                throw InvalidProtocolBufferException.invalidUtf8();
                            ...
                            long j15 = j14 + 1;
                            byte b14 = UnsafeUtil.getByte(j14);
                            addressOffset = j15 + 1;
                            DecodeUtil.handleFourBytes(b11, b13, b14, UnsafeUtil.getByte(j15), cArr, i15);
                            i14 = i15 + 1 + 1;
                        } else {
                            throw InvalidProtocolBufferException.invalidUtf8();
                        }
        ...
        private static int unsafeIncompleteStateFor(long j10, int i10, int i11) {
            ...
            if (i11 == 2) {
                return Utf8.incompleteStateFor(i10, (int) UnsafeUtil.getByte(j10), (int) UnsafeUtil.getByte(j10 + 1));
            }
            throw new AssertionError();
        }
    ...
    public static int incompleteStateFor(byte[] bArr, int i10, int i11) {
        ...
        if (i12 == 2) {
            return incompleteStateFor((int) b10, (int) bArr[i10], (int) bArr[i10 + 1]);
        }
        throw new AssertionError();
    }
    ...
    public static int incompleteStateFor(ByteBuffer byteBuffer, int i10, int i11, int i12) {
        ...
        if (i12 == 2) {
            return incompleteStateFor(i10, (int) byteBuffer.get(i11), (int) byteBuffer.get(i11 + 1));
        }
        throw new AssertionError();
    }

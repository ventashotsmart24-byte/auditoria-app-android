...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        public final void bufferUInt32NoTag(int i10) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                long j10 = (long) this.position;
                while ((i10 & -128) != 0) {
                    byte[] bArr = this.buffer;
                    int i11 = this.position;
                    this.position = i11 + 1;
                    UnsafeUtil.putByte(bArr, (long) i11, (byte) ((i10 & 127) | 128));
                    i10 >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i12 = this.position;
                this.position = i12 + 1;
                UnsafeUtil.putByte(bArr2, (long) i12, (byte) i10);
        ...
        public final void bufferUInt64NoTag(long j10) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((j10 & -128) != 0) {
                    ...
                    int i10 = this.position;
                    this.position = i10 + 1;
                    UnsafeUtil.putByte(bArr, (long) i10, (byte) ((((int) j10) & 127) | 128));
                    j10 >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i11 = this.position;
                this.position = i11 + 1;
                UnsafeUtil.putByte(bArr2, (long) i11, (byte) ((int) j10));
    ...
    public static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void write(byte b10) {
            try {
                ...
                throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.position), Integer.valueOf(this.limit), 1}), e10);
            }
        }
        ...
        public final void writeUInt64NoTag(long j10) {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                ...
                while ((j10 & -128) != 0) {
                    ...
                    int i12 = this.position;
                    this.position = i12 + 1;
                    UnsafeUtil.putByte(bArr3, (long) i12, (byte) ((((int) j10) & 127) | 128));
                    j10 >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i13 = this.position;
                this.position = i13 + 1;
                UnsafeUtil.putByte(bArr4, (long) i13, (byte) ((int) j10));
            }
        }
        ...
        public final void write(byte[] bArr, int i10, int i11) {
            try {
                ...
                throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.position), Integer.valueOf(this.limit), Integer.valueOf(i11)}), e10);
            }
        }
        ...
        public final void write(ByteBuffer byteBuffer) {
            ...
            try {
                ...
                throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.position), Integer.valueOf(this.limit), Integer.valueOf(remaining)}), e10);
            }
        }
    }
    ...
    public static final class OutputStreamEncoder extends AbstractBufferedEncoder {
        ...
        public void writeStringNoTag(String str) {
            ...
            try {
                ...
                i10 = this.position;
                if (computeUInt32SizeNoTag2 == computeUInt32SizeNoTag) {
                    int i14 = i10 + computeUInt32SizeNoTag2;
                    this.position = i14;
                    int encode2 = Utf8.encode(str, this.buffer, i14, this.limit - i14);
                    this.position = i10;
                    i11 = (encode2 - i10) - computeUInt32SizeNoTag2;
                    bufferUInt32NoTag(i11);
                    this.position = encode2;
                } else {
                    i11 = Utf8.encodedLength(str);
                    bufferUInt32NoTag(i11);
                    this.position = Utf8.encode(str, this.buffer, this.position, i11);
                }
                this.totalBytesWritten += i11;
            } catch (Utf8.UnpairedSurrogateException e10) {
    ...
    public static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        private void encode(String str) {
            try {
                ...
                throw new OutOfSpaceException((Throwable) e10);
            }
        }
    ...
    public static final class UnsafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt64NoTag(long j10) {
            if (this.position <= this.oneVarintLimit) {
                ...
                long j12 = this.position;
                this.position = 1 + j12;
                UnsafeUtil.putByte(j12, (byte) ((int) j10));
                return;
            }
            while (true) {
                ...
                if (j13 >= this.limit) {
                    ...
                    this.position = 1 + j13;
                    UnsafeUtil.putByte(j13, (byte) ((int) j10));
                    return;
                } else {
                    this.position = j13 + 1;
        ...
        public void write(byte[] bArr, int i10, int i11) {
            if (bArr != null && i10 >= 0 && i11 >= 0 && bArr.length - i11 >= i10) {
                ...
                if (this.limit - j10 >= j11) {
                    UnsafeUtil.copyMemory(bArr, (long) i10, j11, j10);
                    this.position += j10;
                    return;
                }
            }
            ...
            throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(this.position), Long.valueOf(this.limit), Integer.valueOf(i11)}));
        }
    ...
    public static int computeStringSizeNoTag(String str) {
        int i10;
        try {
            i10 = Utf8.encodedLength(str);
        } catch (Utf8.UnpairedSurrogateException unused) {
            i10 = str.getBytes(Internal.UTF_8).length;
        }
        return computeLengthDelimitedFieldSize(i10);
    }

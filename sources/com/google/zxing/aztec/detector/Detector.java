...
public final class Detector {
    ...
    public static final class Point {
        ...
        public String toString() {
            return Operator.Operation.LESS_THAN + this.f10404x + ' ' + this.f10405y + ASCIIPropertyListParser.DATA_END_TOKEN;
        }
    }
    ...
    private ResultPoint[] getBullsEyeCorners(Point point) {
        ...
        if (i10 == 5 || i10 == 7) {
            ...
            return expandSquare(resultPointArr, (float) ((i11 * 2) - 3), (float) (i11 * 2));
        }
        throw NotFoundException.getNotFoundInstance();
    }
    ...
    private int getColor(Point point, Point point2) {
        ...
        float x10 = ((float) (point2.getX() - point.getX())) / distance;
        float y10 = ((float) (point2.getY() - point.getY())) / distance;
        float x11 = (float) point.getX();
        float y11 = (float) point.getY();
    ...
    private Point getFirstDifferent(Point point, boolean z10, int i10, int i11) {
        ...
        int i122 = x10 - i10;
        int i132 = y10 - i11;
        while (isValid(i122, i132) && this.image.get(i122, i132) == z10) {
            i122 += i10;
        }
        int i14 = i122 - i10;
        while (isValid(i14, i132) && this.image.get(i14, i132) == z10) {
            i132 += i11;
        }
        return new Point(i14, i132 - i11);
    }
    ...
    private Point getMatrixCenter() {
        ...
        try {
            ...
            resultPoint4 = getFirstDifferent(new Point(i13, i11), false, -1, -1).toResultPoint();
        ...
        try {
            ...
            int i14 = round + 7;
            int i15 = round2 - 7;
            resultPoint6 = getFirstDifferent(new Point(i14, i15), false, 1, -1).toResultPoint();
            int i16 = round2 + 7;
            resultPoint5 = getFirstDifferent(new Point(i14, i16), false, 1, 1).toResultPoint();
            int i17 = round - 7;
    ...
    private BitMatrix sampleGrid(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4) {
        ...
        int i10 = dimension;
        int i11 = dimension;
        float f10 = ((float) dimension) / 2.0f;
        int i12 = this.nbCenterLayers;
        float f11 = f10 - ((float) i12);
        float f12 = f10 + ((float) i12);
        return instance.sampleGrid(bitMatrix, i11, i10, f11, f11, f12, f11, f12, f12, f11, f12, resultPoint.getX(), resultPoint.getY(), resultPoint2.getX(), resultPoint2.getY(), resultPoint3.getX(), resultPoint3.getY(), resultPoint4.getX(), resultPoint4.getY());
    }

...
public abstract class OneDReader implements Reader {
    ...
    private com.google.zxing.Result doDecode(com.google.zxing.BinaryBitmap r22, java.util.Map<com.google.zxing.DecodeHintType, ?> r23) {
        ...
        L_0x0077:
            ...
            com.google.zxing.ResultPoint[] r6 = r14.getResultPoints()     // Catch:{ ReaderException -> 0x00c6 }
        ...
        try {
            ...
            if (resultPoints != null) {
                ...
                for (int i11 = 0; i11 < resultPoints.length; i11++) {
                    resultPoints[i11] = new ResultPoint((((float) height) - resultPoints[i11].getY()) - 1.0f, resultPoints[i11].getX());
                }
            }
            return doDecode;
        }

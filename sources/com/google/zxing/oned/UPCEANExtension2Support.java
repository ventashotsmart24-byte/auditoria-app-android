...
final class UPCEANExtension2Support {
    ...
    public Result decodeRow(int i10, BitArray bitArray, int[] iArr) {
        ...
        float f10 = (float) i10;
        Result result = new Result(sb2, (byte[]) null, new ResultPoint[]{new ResultPoint(((float) (iArr[0] + iArr[1])) / 2.0f, f10), new ResultPoint((float) decodeMiddle, f10)}, BarcodeFormat.UPC_EAN_EXTENSION);

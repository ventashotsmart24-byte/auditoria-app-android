...
public final class CodaBarReader extends OneDReader {
    ...
    private void validatePattern(int i10) {
        ...
        while (true) {
            ...
            while (i22 >= 0) {
                ...
                float f12 = (float) this.counters[i10 + i22];
    ...
    public com.google.zxing.Result decodeRow(int r11, com.google.zxing.common.BitArray r12, java.util.Map<com.google.zxing.DecodeHintType, ?> r13) {
        /*
            r10 = this;
            int[] r0 = r10.counters
            r1 = 0

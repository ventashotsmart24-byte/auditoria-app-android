...
public final class ITFReader extends OneDReader {
    ...
    private void validateQuietZone(BitArray bitArray, int i10) {
        ...
        int i12 = i10 - 1;
        while (i11 > 0 && i12 >= 0 && !bitArray.get(i12)) {
            i11--;
            i12--;
        }
        if (i11 != 0) {
    ...
    public Result decodeRow(int i10, BitArray bitArray, Map<DecodeHintType, ?> map) {
        ...
        if (z10) {
            float f10 = (float) i10;
            return new Result(sb2, (byte[]) null, new ResultPoint[]{new ResultPoint((float) decodeStart[1], f10), new ResultPoint((float) decodeEnd[0], f10)}, BarcodeFormat.ITF);
        }

...
final class GeneralAppIdDecoder {
    ...
    private boolean isAlphaTo646ToAlphaLatch(int i10) {
        ...
        int i12 = 0;
        while (i12 < 5 && (i11 = i12 + i10) < this.information.getSize()) {
            if (i12 == 2) {
    ...
    private boolean isNumericToAlphaNumericLatch(int i10) {
        ...
        int i12 = 0;
        while (i12 < 4 && (i11 = i12 + i10) < this.information.getSize()) {
    ...
    private boolean isStillNumeric(int i10) {
        ...
        } else if (i10 + 4 <= this.information.getSize()) {
            return true;
        } else {
            return false;
        }
    ...
    private DecodedInformation parseBlocks() {
        ...
        do {
            ...
            if (this.current.isAlpha()) {
                ...
                z10 = blockParsedResult.isFinished();

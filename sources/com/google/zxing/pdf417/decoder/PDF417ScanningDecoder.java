...
public final class PDF417ScanningDecoder {
    ...
    private static BoundingBox adjustBoundingBox(DetectionResultRowIndicatorColumn detectionResultRowIndicatorColumn) {
        ...
        int i13 = 0;
        while (i11 > 0 && codewords[i13] == null) {
            i11--;
            i13++;
        }
        ...
        while (i10 > 0 && codewords[length2] == null) {
            i10--;
            length2--;
        }
    ...
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i10, int i11) {
        ...
        while (true) {
            ...
            if (detectionResult == null) {
                throw NotFoundException.getNotFoundInstance();
            } else if (i16 != 0 || detectionResult.getBoundingBox() == null || (detectionResult.getBoundingBox().getMinY() >= boundingBox.getMinY() && detectionResult.getBoundingBox().getMaxY() <= boundingBox.getMaxY())) {
        ...
        for (int i19 = 1; i19 <= barcodeColumnCount; i19++) {
            ...
            if (detectionResult.getDetectionResultColumn(i12) == null) {
                if (i12 == 0 || i12 == barcodeColumnCount) {
                    ...
                    detectionResultColumn = new DetectionResultRowIndicatorColumn(boundingBox, z11);
                } else {
                ...
                while (minY <= boundingBox.getMaxY()) {
                    ...
                    if (detectCodeword != null) {
                        detectionResultColumn.setCodeword(i13, detectCodeword);
    ...
    private static int[] getModuleBitCount(BitMatrix bitMatrix, int i10, int i11, boolean z10, int i12, int i13) {
        ...
        while (true) {
            ...
            if (i15 >= 8) {
                break;
            } else if (bitMatrix.get(i12, i13) == z11) {
                iArr[i15] = iArr[i15] + 1;
                i12 += i14;
            } else {
                i15++;
    ...
    private static DetectionResultRowIndicatorColumn getRowIndicatorColumn(BitMatrix bitMatrix, BoundingBox boundingBox, ResultPoint resultPoint, boolean z10, int i10, int i11) {
        ...
        int i13;
        boolean z11 = z10;
        DetectionResultRowIndicatorColumn detectionResultRowIndicatorColumn = new DetectionResultRowIndicatorColumn(boundingBox, z11);
        for (int i14 = 0; i14 < 2; i14++) {
            ...
            while (y10 <= boundingBox.getMaxY() && y10 >= boundingBox.getMinY()) {
    ...
    private static int getStartColumn(DetectionResult detectionResult, int i10, int i11, boolean z10) {
        ...
        if (isValidBarcodeColumn(detectionResult, i14)) {
            codeword = detectionResult.getDetectionResultColumn(i14).getCodeword(i11);
        } else {
            codeword = null;
        }
        if (codeword == null) {
            ...
            if (codewordNearby == null) {
                if (isValidBarcodeColumn(detectionResult, i14)) {
                    codewordNearby = detectionResult.getDetectionResultColumn(i14).getCodewordNearby(i11);
                }
                if (codewordNearby == null) {
                    int i15 = 0;
                    while (true) {
                        ...
                        if (isValidBarcodeColumn(detectionResult, i10)) {
                            for (Codeword codeword2 : detectionResult.getDetectionResultColumn(i10).getCodewords()) {
                                if (codeword2 != null) {
                                    if (z10) {
                                        i13 = codeword2.getEndX();
                                    } else {
                                        i13 = codeword2.getStartX();
                                    }
                                    return i13 + (i12 * i15 * (codeword2.getEndX() - codeword2.getStartX()));
                                }
                            }
                            i15++;
                        } else {
    ...
    public static String toString(BarcodeValue[][] barcodeValueArr) {
        ...
        for (int i10 = 0; i10 < barcodeValueArr.length; i10++) {
            formatter.format("Row %2d: ", new Object[]{Integer.valueOf(i10)});
            int i11 = 0;
            while (true) {

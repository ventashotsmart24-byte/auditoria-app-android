...
public final class Detector {
    ...
    private static ResultPoint[] findRowsWithPattern(BitMatrix bitMatrix, int i10, int i11, int i12, int i13, int[] iArr) {
        ...
        while (true) {
            ...
            int[] findGuardPattern = findGuardPattern(bitMatrix, i13, i19, i11, false, iArr, iArr2);
            if (findGuardPattern != null) {
                ...
                while (true) {
                    ...
                    int i22 = i21 - 1;
                    int[] findGuardPattern2 = findGuardPattern(bitMatrix, i13, i22, i11, false, iArr, iArr2);
                ...
                float f10 = (float) i17;
                resultPointArr[0] = new ResultPoint((float) iArr3[0], f10);
                resultPointArr[1] = new ResultPoint((float) iArr3[1], f10);
                i19 = i17;
                z10 = true;
            } else {
                i19 += 5;
        ...
        if (z10) {
            ...
            while (true) {
                ...
                i15 = i25;
                i16 = i24;
                int[] findGuardPattern3 = findGuardPattern(bitMatrix, iArr4[0], i24, i11, false, iArr, iArr2);
            ...
            i23 = i16 - (i15 + 1);
            float f11 = (float) i23;
            resultPointArr[2] = new ResultPoint((float) iArr4[0], f11);
            resultPointArr[3] = new ResultPoint((float) iArr4[1], f11);
        }
        if (i23 - i19 < 10) {
            for (i14 = 0; i14 < 4; i14++) {

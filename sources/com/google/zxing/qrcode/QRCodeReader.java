...
public class QRCodeReader implements Reader {
    ...
    private static BitMatrix extractPureBits(BitMatrix bitMatrix) {
        ...
        if (i14 == i13 - i12 || (i13 = i12 + i14) < bitMatrix.getWidth()) {
            int round = Math.round(((float) ((i13 - i12) + 1)) / moduleSize);
            int round2 = Math.round(((float) (i14 + 1)) / moduleSize);
            if (round <= 0 || round2 <= 0) {
                throw NotFoundException.getNotFoundInstance();
                ...
                int i16 = i10 + i15;
                int i17 = i12 + i15;
                int i18 = (((int) (((float) (round - 1)) * moduleSize)) + i17) - i13;
                if (i18 > 0) {
                    if (i18 <= i15) {
                        i17 -= i18;
                    } else {
                ...
                int i19 = (((int) (((float) (round2 - 1)) * moduleSize)) + i16) - i11;
                if (i19 > 0) {
                    if (i19 <= i15) {
                        i16 -= i19;
                    } else {
                ...
                for (int i20 = 0; i20 < round2; i20++) {
                    int i21 = ((int) (((float) i20) * moduleSize)) + i16;
                    for (int i22 = 0; i22 < round; i22++) {
                        if (bitMatrix.get(((int) (((float) i22) * moduleSize)) + i17, i21)) {

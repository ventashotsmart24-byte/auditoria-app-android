...
public class UIMediaController implements RemoteMediaClient.Listener, SessionManagerListener<CastSession> {
    ...
    private final void zzh(int i10, boolean z10) {
        if (z10) {
            for (zzbp zzb2 : this.zzf) {
                zzb2.zzb(((long) i10) + this.zza.zze());
            }
        }
    }

    private final void zzi() {
        for (zzbp zza2 : this.zzf) {
            zza2.zza(false);
        }
    }
    ...
    public void bindImageViewToImageOfCurrentItem(@RecentlyNonNull ImageView imageView, int i10, int i11) {
        ...
        zzk(imageView, new zzay(imageView, this.zzc, new ImageHints(i10, 0, 0), i11, (View) null));
    }
    ...
    public void bindTextViewToStreamDuration(@RecentlyNonNull TextView textView) {
        Preconditions.checkMainThread("Must be called from the main thread.");
        zzk(textView, new zzbn(textView, this.zzc.getString(R.string.cast_invalid_stream_duration_text), (View) null));
    }

    public void bindTextViewToStreamPosition(@RecentlyNonNull TextView textView, boolean z10) {
        bindTextViewToStreamPosition(textView, z10, 1000);
    }
    ...
    public void onForwardClicked(@RecentlyNonNull View view, long j10) {
        ...
        if (remoteMediaClient != null && remoteMediaClient.hasMediaSession()) {
            if (remoteMediaClient.zzq()) {
                ...
                zza zza2 = this.zza;
                remoteMediaClient.seek(Math.min(approximateStreamPosition + j10, ((long) zza2.zzc()) + zza2.zze()));
                return;
            }
    ...
    public void onRewindClicked(@RecentlyNonNull View view, long j10) {
        ...
        if (remoteMediaClient != null && remoteMediaClient.hasMediaSession()) {
            if (remoteMediaClient.zzq()) {
                long approximateStreamPosition = remoteMediaClient.getApproximateStreamPosition();
                zza zza2 = this.zza;
                remoteMediaClient.seek(Math.max(approximateStreamPosition - j10, ((long) zza2.zzd()) + zza2.zze()));
                return;
            }
            remoteMediaClient.seek(remoteMediaClient.getApproximateStreamPosition() - j10);
        }
    ...
    public final void zze(zzbp zzbp) {
        this.zzf.add(zzbp);
    }
    ...
    public void bindTextViewToStreamPosition(@RecentlyNonNull TextView textView, boolean z10, long j10) {
        Preconditions.checkMainThread("Must be called from the main thread.");
        zzbo zzbo = new zzbo(textView, j10, this.zzc.getString(R.string.cast_invalid_stream_position_text));
        if (z10) {
            this.zzf.add(zzbo);
        }
        zzk(textView, zzbo);
    ...
    public void bindImageViewToImageOfCurrentItem(@RecentlyNonNull ImageView imageView, @RecentlyNonNull ImageHints imageHints, int i10) {
        Preconditions.checkMainThread("Must be called from the main thread.");
        zzk(imageView, new zzay(imageView, this.zzc, imageHints, i10, (View) null));
    }

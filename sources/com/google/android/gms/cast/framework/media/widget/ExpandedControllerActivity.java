...
public abstract class ExpandedControllerActivity extends d implements ControlButtonsContainer {
    ...
    private Timer zzN;
    private String zzO;
    private final SessionManagerListener<CastSession> zza = new zzo(this, (zzn) null);
    private final RemoteMediaClient.Listener zzb = new zzm(this, (zzl) null);
    private int zzc;
    private int zzd;
    private int zze;
    private int zzf;
    ...
    private final void zzn(View view, int i10, int i11, UIMediaController uIMediaController) {
        ...
        if (i11 == R.id.cast_button_type_empty) {
            ...
            Drawable zzb2 = zzp.zzb(this, this.zzq, this.zze);
            Drawable zzb3 = zzp.zzb(this, this.zzq, this.zzd);
            Drawable zzb4 = zzp.zzb(this, this.zzq, this.zzf);
    ...
    public final void zzo(RemoteMediaClient remoteMediaClient) {
        ...
        if (!this.zzL && (mediaStatus = remoteMediaClient.getMediaStatus()) != null && !remoteMediaClient.isBuffering()) {
            ...
            if (currentAdBreakClip != null && currentAdBreakClip.getWhenSkippableInMs() != -1) {
                ...
                this.zzH.setText(getResources().getString(R.string.cast_expanded_controller_skip_ad_text, new Object[]{Integer.valueOf((int) Math.ceil((double) (whenSkippableInMs / 1000.0f)))}));
    ...
    public final void zzp() {
        ...
        if (!(currentCastSession == null || (castDevice = currentCastSession.getCastDevice()) == null)) {
            ...
            if (!TextUtils.isEmpty(friendlyName)) {
                this.zzu.setText(getResources().getString(R.string.cast_casting_to_device, new Object[]{friendlyName}));
                return;
            }
        }
        this.zzu.setText("");
    ...
    public final void zzq() {
        ...
        a supportActionBar;
        RemoteMediaClient zzl2 = zzl();
        if (zzl2 != null && zzl2.hasMediaSession() && (mediaInfo = zzl2.getMediaInfo()) != null && (metadata = mediaInfo.getMetadata()) != null && (supportActionBar = getSupportActionBar()) != null) {
    ...
    public final void zzr() {
        ...
        Bitmap zza2;
        RemoteMediaClient zzl2 = zzl();
        if (zzl2 != null && (mediaStatus = zzl2.getMediaStatus()) != null) {
            String str2 = null;
            if (mediaStatus.isPlayingAd()) {
                if (PlatformVersion.isAtLeastJellyBeanMR1() && this.zzy.getVisibility() == 8 && (drawable = this.zzx.getDrawable()) != null && (drawable instanceof BitmapDrawable) && (bitmap = ((BitmapDrawable) drawable).getBitmap()) != null && (zza2 = zzp.zza(this, bitmap, 0.25f, 7.5f)) != null) {
                    this.zzy.setImageBitmap(zza2);
            ...
            if (PlatformVersion.isAtLeastJellyBeanMR1()) {
                ...
                this.zzy.setImageBitmap((Bitmap) null);
            }
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        zzbv zzbv = new zzbv(relativeLayout, this.zzw, this.zzJ.zza());
        this.zzJ.bindViewToUIController(relativeLayout, zzbv);
        this.zzJ.zze(zzbv);
        ...
        zzb zzb2 = new zzb(getApplicationContext(), new ImageHints(-1, this.zzD.getWidth(), this.zzD.getHeight()));
        this.zzI = zzb2;
    ...
    public void onResume() {
        ...
        RemoteMediaClient zzl2 = zzl();
        boolean z10 = true;
        if (zzl2 != null && zzl2.hasMediaSession()) {
            z10 = false;
        }
        this.zzL = z10;
        zzp();

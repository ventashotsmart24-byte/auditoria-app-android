...
public class CastOptions extends AbstractSafeParcelable {
    ...
    public static final class Builder {
        ...
        public CastOptions build() {
            ...
            zzdf<CastMediaOptions> zzdf = this.zzf;
            if (zzdf != null) {
                castMediaOptions = zzdf.zza();
            } else {
                castMediaOptions = new CastMediaOptions.Builder().build();
            }
            return new CastOptions(this.zza, this.zzb, this.zzc, this.zzd, this.zze, castMediaOptions, this.zzg, this.zzh, false, false, false);
        }

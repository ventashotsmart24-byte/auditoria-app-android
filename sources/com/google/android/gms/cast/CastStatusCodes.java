        ...
        if (i10 < -999 || i10 > 999) {
            if (i10 < 2000 || i10 > 2099) {
                if (i10 >= 2100 && i10 <= 2109) {
                    return String.format(Locale.ROOT, "%s %d", new Object[]{"Media control channel status code", Integer.valueOf(i10)});
                } else if (i10 >= 2105 && i10 <= 2169) {
                    return String.format(Locale.ROOT, "%s %d", new Object[]{"Cast session status code", Integer.valueOf(i10)});
                } else if (i10 >= 2200 && i10 <= 2219) {
                    return String.format(Locale.ROOT, "%s %d", new Object[]{"Cast remote display status code", Integer.valueOf(i10)});
                } else if (i10 >= 2250 && i10 <= 2289) {
                    return String.format(Locale.ROOT, "%s %d", new Object[]{"Cast socket status code", Integer.valueOf(i10)});
                } else if (i10 >= 2300 && i10 <= 2309) {
                    return String.format(Locale.ROOT, "%s %d", new Object[]{"Cast service status code", Integer.valueOf(i10)});
                } else if (i10 >= 2310 && i10 <= 2319) {
                    return String.format(Locale.ROOT, "%s %d", new Object[]{"Endpoint switch status code", Integer.valueOf(i10)});
                } else if (i10 >= 2350 && i10 <= 2359) {
                    return String.format(Locale.ROOT, "%s %d", new Object[]{"Cast multizone device status code", Integer.valueOf(i10)});
                } else if (i10 >= 2400 && i10 <= 2419) {
                    return String.format(Locale.ROOT, "%s %d", new Object[]{"Cast relay casting status code", Integer.valueOf(i10)});
                } else if (i10 >= 2450 && i10 <= 2469) {
                    return String.format(Locale.ROOT, "%s %d", new Object[]{"Cast nearby casting status code", Integer.valueOf(i10)});
                } else if (i10 >= 2470 && i10 <= 2479) {
                    return String.format(Locale.ROOT, "%s %d", new Object[]{"Cast application status code", Integer.valueOf(i10)});
                } else if (i10 < 2490 || i10 > 2499) {
                    return String.format(Locale.ROOT, "Unknown cast status code %d", new Object[]{Integer.valueOf(i10)});
                } else {
                    return String.format(Locale.ROOT, "%s %d", new Object[]{"Cast media loading status code", Integer.valueOf(i10)});
                }
            } else if (i10 == 2015) {
                ...
                switch (i10) {
                    ...
                    default:
                        return String.format(Locale.ROOT, "%s %d", new Object[]{"Common cast status code", Integer.valueOf(i10)});
                }
            }
        } else if (i10 == 0) {

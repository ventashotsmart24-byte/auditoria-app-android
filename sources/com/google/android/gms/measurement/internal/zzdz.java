...
final class zzdz extends SQLiteOpenHelper {
    ...
    public zzdz(zzea zzea, Context context, String str) {
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) {
        zzan.zza(this.zza.zzt.zzay(), sQLiteDatabase, "messages", "create table if not exists messages ( type INTEGER NOT NULL, entry BLOB NOT NULL)", "type,entry", (String[]) null);
    }

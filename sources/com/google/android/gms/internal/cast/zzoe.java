...
public abstract class zzoe implements Iterable<Byte>, Serializable {
    private static final Comparator<zzoe> zza = new zznx();
    public static final zzoe zzb = new zzoc(zzph.zzd);
    private static final zzod zzd = new zzod((zznv) null);
    private int zzc = 0;
    ...
    public abstract void zzh(zznu zznu);

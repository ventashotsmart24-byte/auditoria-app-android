...
public abstract class zzol extends zznu {
    ...
    public static final boolean zzc = zzrn.zzx();
    zzom zza;

    private zzol() {
    }

    public /* synthetic */ zzol(zzoi zzoi) {
    }
    ...
    public static int zzt(zzoe zzoe) {
        int zzd = zzoe.zzd();
        return zzA(zzd) + zzd;
    }

    @Deprecated
    public static int zzu(int i10, zzqe zzqe, zzqp zzqp) {
        int zzA = zzA(i10 << 3);
        int i11 = zzA + zzA;
        zznr zznr = (zznr) zzqe;
        int zzn = zznr.zzn();
    ...
    public static int zzw(zzpm zzpm) {
        int zza2 = zzpm.zza();
        return zzA(zza2) + zza2;
    }

    public static int zzx(zzqe zzqe, zzqp zzqp) {
        zznr zznr = (zznr) zzqe;
        int zzn = zznr.zzn();
        if (zzn == -1) {
            zzn = zzqp.zza(zznr);
    ...
    public static int zzy(String str) {
        ...
        try {
            ...
            i10 = str.getBytes(zzph.zzb).length;
        }
        return zzA(i10) + i10;
    }
    ...
    public final void zzE(String str, zzrq zzrq) {
        zzb.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", zzrq);
    ...
    public abstract void zze(int i10, zzoe zzoe);

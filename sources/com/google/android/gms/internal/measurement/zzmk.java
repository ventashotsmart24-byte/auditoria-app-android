...
class zzmk extends AbstractMap {
    ...
    public /* synthetic */ zzmk(int i10, zzmj zzmj) {
        this.zza = i10;
    }
    ...
    public final Set entrySet() {
        if (this.zze == null) {
            this.zze = new zzmi(this, (zzmh) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i10 = 0; i10 < zzb2; i10++) {
            if (!zzg(i10).equals(zzmk.zzg(i10))) {
                return false;
            }
        }
        if (zzb2 != size) {
            return this.zzc.equals(zzmk.zzc);
        }
        return true;
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i11 = this.zza;
        if (size == i11) {
            zzme zzme = (zzme) this.zzb.remove(i11 - 1);
            zzm().put(zzme.zza(), zzme.getValue());
        }

...
final class zzjj extends zzjm {
    ...
    public final void zzb(byte b10) {
        try {
            ...
            throw new zzjk(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1}), e10);
        }
    }
    ...
    public final void zzc(byte[] bArr, int i10, int i11) {
        try {
            ...
            throw new zzjk(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i11)}), e10);
        }
    }
    ...
    public final void zzn(String str) {
        ...
        try {
            ...
            if (zzA2 == zzA) {
                int i11 = i10 + zzA2;
                this.zzd = i11;
                int zzb2 = zznd.zzb(str, this.zzb, i11, this.zzc - i11);
                this.zzd = i10;
                zzq((zzb2 - i10) - zzA2);
                this.zzd = zzb2;
                return;
    ...
    public final void zzs(long j10) {
        if (!zzjm.zzc || this.zzc - this.zzd < 10) {
            ...
            while ((j10 & -128) != 0) {
                ...
                int i12 = this.zzd;
                this.zzd = i12 + 1;
                zzmy.zzn(bArr3, (long) i12, (byte) ((((int) j10) & 127) | 128));
                j10 >>>= 7;
            }
            byte[] bArr4 = this.zzb;
            int i13 = this.zzd;
            this.zzd = i13 + 1;
            zzmy.zzn(bArr4, (long) i13, (byte) ((int) j10));
        }
    }
}

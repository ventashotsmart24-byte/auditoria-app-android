...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        public static Field<byte[], byte[]> forBase64(String str, int i10) {
            return new Field(8, false, 8, false, str, i10, (Class) null, (FieldConverter) null);
        }

        @KeepForSdk
        public static Field<Boolean, Boolean> forBoolean(String str, int i10) {
            return new Field(6, false, 6, false, str, i10, (Class) null, (FieldConverter) null);
        }
        ...
        public static Field<Double, Double> forDouble(String str, int i10) {
            return new Field(4, false, 4, false, str, i10, (Class) null, (FieldConverter) null);
        }

        @KeepForSdk
        public static Field<Float, Float> forFloat(String str, int i10) {
            return new Field(3, false, 3, false, str, i10, (Class) null, (FieldConverter) null);
        }

        @KeepForSdk
        @VisibleForTesting
        public static Field<Integer, Integer> forInteger(String str, int i10) {
            return new Field(0, false, 0, false, str, i10, (Class) null, (FieldConverter) null);
        }

        @KeepForSdk
        public static Field<Long, Long> forLong(String str, int i10) {
            return new Field(2, false, 2, false, str, i10, (Class) null, (FieldConverter) null);
        }

        @KeepForSdk
        public static Field<String, String> forString(String str, int i10) {
            return new Field(7, false, 7, false, str, i10, (Class) null, (FieldConverter) null);
        }

        @KeepForSdk
        public static Field<HashMap<String, String>, HashMap<String, String>> forStringMap(String str, int i10) {
            return new Field(10, false, 10, false, str, i10, (Class) null, (FieldConverter) null);
        }

        @KeepForSdk
        public static Field<ArrayList<String>, ArrayList<String>> forStrings(String str, int i10) {
            return new Field(7, true, 7, true, str, i10, (Class) null, (FieldConverter) null);
        }
        ...
        public static Field withConverter(String str, int i10, FieldConverter<?, ?> fieldConverter, boolean z10) {
            fieldConverter.zaa();
            fieldConverter.zab();
            return new Field(7, z10, 0, false, str, i10, (Class) null, fieldConverter);
        }

...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    private final Drawable createDefaultItemBackground(r2 r2Var) {
        ...
        return new InsetDrawable(materialShapeDrawable, r2Var.f(R.styleable.NavigationView_itemShapeInsetStart, 0), r2Var.f(R.styleable.NavigationView_itemShapeInsetTop, 0), r2Var.f(R.styleable.NavigationView_itemShapeInsetEnd, 0), r2Var.f(R.styleable.NavigationView_itemShapeInsetBottom, 0));
    }
        ...
        this.onGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
            public void onGlobalLayout() {
                ...
                if ((context instanceof Activity) && Build.VERSION.SDK_INT >= 21) {
                    ...
                    navigationView2.setDrawBottomInsetForeground(z13);
                }
            }
        };
    ...
    public NavigationView(Context context, AttributeSet attributeSet, int i10) {
        ...
        if (obtainTintedStyledAttributes.r(i13)) {
            setElevation((float) obtainTintedStyledAttributes.f(i13, 0));
        }
        ...
        if (obtainTintedStyledAttributes.r(i14)) {
            colorStateList = obtainTintedStyledAttributes.c(i14);
        } else {
        ...
        navigationMenu.setCallback(new g.a() {

...
public class ShapeAppearancePathProvider {
    ...
    public static final class ShapeAppearancePathSpec {
        ...
        public ShapeAppearancePathSpec(ShapeAppearanceModel shapeAppearanceModel2, float f10, RectF rectF, PathListener pathListener2, Path path2) {
    ...
    private void getCoordinatesOfCorner(int i10, RectF rectF, PointF pointF2) {
        if (i10 == 1) {

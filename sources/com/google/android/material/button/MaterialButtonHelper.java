...
class MaterialButtonHelper {
    ...
    private Drawable createBackground() {
        ...
        float f10 = (float) this.strokeWidth;
    ...
    private MaterialShapeDrawable getMaterialShapeDrawable(boolean z10) {
        ...
        if (IS_LOLLIPOP) {
            return (MaterialShapeDrawable) ((LayerDrawable) ((InsetDrawable) this.rippleDrawable.getDrawable(0)).getDrawable()).getDrawable(z10 ^ true ? 1 : 0);
        }
        return (MaterialShapeDrawable) this.rippleDrawable.getDrawable(z10 ^ true ? 1 : 0);
    }
    ...
    public void setCornerRadius(int i10) {
        if (!this.cornerRadiusSet || this.cornerRadius != i10) {
            ...
            this.cornerRadiusSet = true;
            setShapeAppearanceModel(this.shapeAppearanceModel.withCornerSize((float) i10));
        }
    }

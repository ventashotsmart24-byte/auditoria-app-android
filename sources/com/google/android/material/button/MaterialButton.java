...
public class MaterialButton extends g implements Checkable, Shapeable {
    ...
    private void resetIconDrawable(boolean z10) {
        if (z10) {
            e0.j(this, this.icon, (Drawable) null, (Drawable) null, (Drawable) null);
        } else {
            e0.j(this, (Drawable) null, (Drawable) null, this.icon, (Drawable) null);
        }
    }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (Build.VERSION.SDK_INT == 21 && (materialButtonHelper2 = this.materialButtonHelper) != null) {
            materialButtonHelper2.updateMaskBounds(i13 - i11, i12 - i10);
        }
    }
    ...
    public void setIconTintResource(int i10) {
        setIconTint(b.c(getContext(), i10));
    }
    ...
    public void setRippleColorResource(int i10) {
        if (isUsingOriginalBackground()) {
            setRippleColor(b.c(getContext(), i10));
        }
    }

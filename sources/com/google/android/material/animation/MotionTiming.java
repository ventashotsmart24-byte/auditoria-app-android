...
public class MotionTiming {
    ...
    public String toString() {
        return 10 + getClass().getName() + ASCIIPropertyListParser.DICTIONARY_BEGIN_TOKEN + Integer.toHexString(System.identityHashCode(this)) + " delay: " + getDelay() + " duration: " + getDuration() + " interpolator: " + getInterpolator().getClass() + " repeatCount: " + getRepeatCount() + " repeatMode: " + getRepeatMode() + "}\n";
    }

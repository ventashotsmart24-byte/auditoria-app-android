...
final class IndicatorViewController {
    ...
    private void updateCaptionViewsVisibility(int i10, int i11, boolean z10) {
        if (z10) {
            ...
            int i12 = i10;
            int i13 = i11;
            createCaptionAnimators(arrayList2, this.helperTextEnabled, this.helperTextView, 2, i12, i13);
            createCaptionAnimators(arrayList2, this.errorEnabled, this.errorView, 1, i12, i13);
    ...
    public void hideHelperText() {
        ...
        updateCaptionViewsVisibility(i10, this.captionToShow, shouldAnimateCaptionView(this.helperTextView, (CharSequence) null));
    }

...
class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(MaterialCardView materialCardView2, AttributeSet attributeSet, int i10, int i11) {
        this.materialCardView = materialCardView2;
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(materialCardView2.getContext(), attributeSet, i10, i11);
        this.bgDrawable = materialShapeDrawable;
        materialShapeDrawable.initializeElevationOverlay(materialCardView2.getContext());
        materialShapeDrawable.setShadowColor(-12303292);
        ShapeAppearanceModel.Builder builder = materialShapeDrawable.getShapeAppearanceModel().toBuilder();
        TypedArray obtainStyledAttributes = materialCardView2.getContext().obtainStyledAttributes(attributeSet, R.styleable.CardView, i10, R.style.CardView);
    ...
    private Drawable insetDrawable(Drawable drawable) {
        ...
        if (z10 || this.materialCardView.getUseCompatPadding()) {
            ...
            i11 = (int) Math.ceil((double) calculateHorizontalBackgroundPadding());
            i10 = ceil;
        } else {
            i11 = 0;
            i10 = 0;
        }
        return new InsetDrawable(drawable, i11, i10, i11, i10) {
    ...
    private void updateRippleColor() {
        ...
        a.a(drawable).setColor(this.rippleColor);
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (this.clickableForegroundDrawable != null) {
            ...
            this.clickableForegroundDrawable.setLayerInset(2, i13, this.checkedIconMargin, i12, i17);
        }
    }

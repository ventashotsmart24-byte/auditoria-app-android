...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void createColorAnimation(View view, View view2, boolean z10, boolean z11, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z10) {
                ...
                objectAnimator = ObjectAnimator.ofInt(circularRevealWidget, CircularRevealWidget.CircularRevealScrimColorProperty.CIRCULAR_REVEAL_SCRIM_COLOR, new int[]{i10});
            } else {
    ...
    private void createExpansionAnimation(View view, View view2, boolean z10, boolean z11, FabTransformationSpec fabTransformationSpec, float f10, float f11, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view4 instanceof CircularRevealWidget) {
            ...
            if (z10) {
                ...
                View view5 = view2;
                createPreFillRadialExpansion(view5, timing.getDelay(), i10, i11, f12, list);
                ...
                createPostFillRadialExpansion(view5, delay, duration, totalDuration, i10, i11, width, list);
    ...
    private void createPostFillRadialExpansion(View view, long j10, long j11, long j12, int i10, int i11, float f10, List<Animator> list) {
        if (Build.VERSION.SDK_INT >= 21) {
            long j13 = j10 + j11;
            if (j13 < j12) {
                Animator a10 = ViewAnimationUtils.createCircularReveal(view, i10, i11, f10, f10);
                a10.setStartDelay(j13);
                a10.setDuration(j12 - j13);
                list.add(a10);
            }
        }
    }
    ...
    private void createTranslationAnimation(View view, View view2, boolean z10, boolean z11, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2, RectF rectF) {
        ...
        Pair<MotionTiming, MotionTiming> calculateMotionTiming = calculateMotionTiming(calculateTranslationX, calculateTranslationY, z12, fabTransformationSpec2);
        MotionTiming motionTiming = (MotionTiming) calculateMotionTiming.first;
        MotionTiming motionTiming2 = (MotionTiming) calculateMotionTiming.second;
        if (z12) {
            if (!z11) {
    ...
    public AnimatorSet onCreateExpandedStateChangeAnimation(View view, View view2, boolean z10, boolean z11) {
        ...
        FabTransformationSpec onCreateMotionSpec = onCreateMotionSpec(view2.getContext(), z12);
        if (z12) {
        ...
        createTranslationAnimation(view3, view4, z13, z11, onCreateMotionSpec, arrayList3, arrayList4, rectF);
        float width = rectF.width();
        float height = rectF.height();
        createDependencyTranslationAnimation(view3, view4, z13, onCreateMotionSpec, arrayList);
        boolean z14 = z11;
        FabTransformationSpec fabTransformationSpec = onCreateMotionSpec;
        createIconFadeAnimation(view3, view4, z13, z14, fabTransformationSpec, arrayList3, arrayList4);
        createExpansionAnimation(view3, view4, z13, z14, fabTransformationSpec, width, height, arrayList, arrayList2);
        ArrayList arrayList5 = arrayList;
        ArrayList arrayList6 = arrayList2;
        createColorAnimation(view3, view4, z13, z14, fabTransformationSpec, arrayList5, arrayList6);
        createChildrenFadeAnimation(view3, view4, z13, z14, fabTransformationSpec, arrayList5, arrayList6);

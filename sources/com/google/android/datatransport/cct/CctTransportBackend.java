...
final class CctTransportBackend implements TransportBackend {
    ...
    public HttpResponse doSend(HttpRequest httpRequest) {
        ...
        try {
            ...
            Logging.e(LOG_TAG, "Couldn't open connection, returning with 500", e10);
            return new HttpResponse(500, (URL) null, 0);
        } catch (EncodingException | IOException e11) {
            Logging.e(LOG_TAG, "Couldn't encode request, returning with 400", e11);
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            HttpResponse httpResponse = (HttpResponse) Retries.retry(5, new HttpRequest(url, requestBody, str), new a(this), new b());

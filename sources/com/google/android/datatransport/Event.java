...
public abstract class Event<T> {
    ...
    public static <T> Event<T> ofData(T t10) {
        return new AutoValue_Event((Integer) null, t10, Priority.DEFAULT);
    }

    public static <T> Event<T> ofTelemetry(T t10) {
        return new AutoValue_Event((Integer) null, t10, Priority.VERY_LOW);
    }

    public static <T> Event<T> ofUrgent(T t10) {
        return new AutoValue_Event((Integer) null, t10, Priority.HIGHEST);
    }
}

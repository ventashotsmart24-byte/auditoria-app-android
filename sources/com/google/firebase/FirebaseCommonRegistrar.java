...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        ...
        arrayList.add(LibraryVersionComponent.fromContext(TARGET_SDK, new d()));
        arrayList.add(LibraryVersionComponent.fromContext(MIN_SDK, new e()));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_PLATFORM, new f()));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_INSTALLER, new g()));

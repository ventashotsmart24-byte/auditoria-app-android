...
public class ModalLayoutPortrait extends BaseModalLayout {
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        for (int i16 = 0; i16 < size; i16++) {
            ...
            Logging.logdPair("\t(left, right)", (float) i14, (float) i15);
            view.layout(i14, paddingTop, i15, i17);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        for (ViewMeasure next : this.vgm.getViews()) {
            ...
            MeasureUtils.measureAtMost(next.getView(), i13, next.getMaxHeight());
            paddingBottom += getDesiredHeight(next.getView());
        }
        Logging.logdPair("Measured dims", f10, (float) paddingBottom);

...
public class InAppMessageLayoutConfig {
    ...
    public static class Builder {
        ...
        public Builder setMaxBodyHeightWeight(Float f10) {
            Float unused = this.config.maxBodyHeightWeight = f10;
            return this;
        }

        public Builder setMaxBodyWidthWeight(Float f10) {
            Float unused = this.config.maxBodyWidthWeight = f10;
            return this;
        }
        ...
        public Builder setMaxImageHeightWeight(Float f10) {
            Float unused = this.config.maxImageHeightWeight = f10;
            return this;
        }

        public Builder setMaxImageWidthWeight(Float f10) {
            Float unused = this.config.maxImageWidthWeight = f10;
            return this;
        }

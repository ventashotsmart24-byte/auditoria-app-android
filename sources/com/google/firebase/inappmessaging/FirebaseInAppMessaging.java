...
public class FirebaseInAppMessaging {
    ...
    public FirebaseInAppMessaging(InAppMessageStreamManager inAppMessageStreamManager2, @ProgrammaticTrigger ProgramaticContextualTriggers programaticContextualTriggers2, DataCollectionHelper dataCollectionHelper2, FirebaseInstallationsApi firebaseInstallationsApi, DisplayCallbacksFactory displayCallbacksFactory2, DeveloperListenerManager developerListenerManager2, @Lightweight Executor executor) {
        ...
        firebaseInstallationsApi.getId().addOnSuccessListener(executor, new a());
        inAppMessageStreamManager2.createFirebaseInAppMessageStream().subscribe(new b(this));
    }

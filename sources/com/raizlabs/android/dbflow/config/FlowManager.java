...
public class FlowManager {
    ...
    public static <TModel> com.raizlabs.android.dbflow.structure.InstanceAdapter<TModel> getInstanceAdapter(java.lang.Class<TModel> r2) {
        /*
            com.raizlabs.android.dbflow.structure.ModelAdapter r0 = getModelAdapterOrNull(r2)
            if (r0 != 0) goto L_0x0010
            com.raizlabs.android.dbflow.structure.ModelViewAdapter r0 = getModelViewAdapterOrNull(r2)
            if (r0 != 0) goto L_0x0010
            com.raizlabs.android.dbflow.structure.QueryModelAdapter r0 = getQueryModelAdapterOrNull(r2)
        L_0x0010:
            if (r0 != 0) goto L_0x0017
            java.lang.String r1 = "InstanceAdapter"
            throwCannotFindAdapter(r1, r2)
        L_0x0017:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.raizlabs.android.dbflow.config.FlowManager.getInstanceAdapter(java.lang.Class):com.raizlabs.android.dbflow.structure.InstanceAdapter");
    }
    ...
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static <TModel> com.raizlabs.android.dbflow.structure.RetrievalAdapter<TModel> getRetrievalAdapter(java.lang.Class<TModel> r2) {
        /*
            com.raizlabs.android.dbflow.structure.ModelAdapter r0 = getModelAdapterOrNull(r2)
            if (r0 != 0) goto L_0x0010
            com.raizlabs.android.dbflow.structure.ModelViewAdapter r0 = getModelViewAdapterOrNull(r2)
        ...
        L_0x0017:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.raizlabs.android.dbflow.config.FlowManager.getRetrievalAdapter(java.lang.Class):com.raizlabs.android.dbflow.structure.RetrievalAdapter");
    }
    ...
    public static void init(FlowConfig flowConfig) {
        ...
        if (!flowConfig.databaseHolders().isEmpty()) {
            for (Class<? extends DatabaseHolder> loadDatabaseHolder : flowConfig.databaseHolders()) {

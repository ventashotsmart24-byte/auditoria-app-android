...
public final class DatabaseConfig {
    ...
    public static final class Builder {
        ...
        public Builder modelNotifier(ModelNotifier modelNotifier2) {
            this.modelNotifier = modelNotifier2;
            return this;
        }

        public Builder openHelper(OpenHelperCreator openHelperCreator2) {
            this.openHelperCreator = openHelperCreator2;
            return this;
        }

        public Builder transactionManagerCreator(TransactionManagerCreator transactionManagerCreator2) {
            this.transactionManagerCreator = transactionManagerCreator2;
            return this;
        }
    }
    ...
    public DatabaseConfig(Builder builder) {
        ...
        if (str3 == null) {
            this.databaseExtensionName = a.f14486d;
            return;
        }

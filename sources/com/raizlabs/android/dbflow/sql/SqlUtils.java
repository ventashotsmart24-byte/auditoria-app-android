...
public class SqlUtils {
    ...
    public static Uri getNotificationUri(String str, Class<?> cls, BaseModel.Action action, Iterable<SQLOperator> iterable) {
        ...
        if (iterable != null) {
            for (SQLOperator next : iterable) {
                appendQueryParameter.appendQueryParameter(Uri.encode(next.columnName()), Uri.encode(String.valueOf(next.value())));
            }
        }
    ...
    public static Uri getNotificationUri(String str, Class<?> cls, BaseModel.Action action) {
        return getNotificationUri(str, cls, action, "", (Object) null);
    }
}

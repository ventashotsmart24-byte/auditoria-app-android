...
public class Join<TModel, TFromModel> implements Query {
    ...
    public Join(From<TFromModel> from2, Class<TModel> cls, JoinType joinType) {
        this.from = from2;
        this.table = cls;
        this.type = joinType;
    ...
    public Join(From<TFromModel> from2, JoinType joinType, ModelQueriable<TModel> modelQueriable) {

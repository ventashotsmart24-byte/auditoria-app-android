...
public class Insert<TModel> extends BaseQueriable<TModel> implements Query {
    ...
    public String getQuery() {
        ...
        if (this.selectFrom != null) {
            ...
            if (this.columns != null) {
                for (Collection<Object> size : this.valuesList) {
            ...
            for (int i10 = 0; i10 < this.valuesList.size(); i10++) {
                ...
                queryBuilder.append(BaseOperator.joinArguments((CharSequence) ", ", (Iterable) this.valuesList.get(i10))).append(")");
            }
        }
        return queryBuilder.getQuery();
    }

    public Insert<TModel> or(ConflictAction conflictAction2) {

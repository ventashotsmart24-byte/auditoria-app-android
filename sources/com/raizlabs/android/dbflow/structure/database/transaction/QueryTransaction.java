...
public class QueryTransaction<TResult> implements ITransaction {
    ...
    public static final class Builder<TResult> {
        ...
        public Builder(ModelQueriable<TResult> modelQueriable2) {
    ...
    public void execute(DatabaseWrapper databaseWrapper) {
        ...
        QueryResultCallback<TResult> queryResultCallback2 = this.queryResultCallback;
        if (queryResultCallback2 != null) {
            if (this.runResultCallbacksOnSameThread) {
                queryResultCallback2.onQueryResult(this, queryResults);
            } else {

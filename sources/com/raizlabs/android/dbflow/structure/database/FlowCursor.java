...
public class FlowCursor extends CursorWrapper {
    ...
    private FlowCursor(Cursor cursor2) {
        super(cursor2);
        this.cursor = cursor2;
    }

    public static FlowCursor from(Cursor cursor2) {
        if (cursor2 instanceof FlowCursor) {
            return (FlowCursor) cursor2;
        }
        return new FlowCursor(cursor2);
    }

...
public class LruCache<K, V> {
    ...
    public final V get(K r5) {
        ...
        L_0x0054:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.raizlabs.android.dbflow.structure.cache.LruCache.get(java.lang.Object):java.lang.Object");
    }
    ...
    public final synchronized String toString() {
        ...
        return String.format(Locale.getDefault(), "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(i10)});
    }

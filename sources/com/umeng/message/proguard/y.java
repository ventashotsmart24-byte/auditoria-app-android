...
public final class y {
    ...
    private static Application f16085a;

    public static void a(Context context) {
        if (f16085a == null && context != null) {
            f16085a = (Application) context.getApplicationContext();
            u.a();
        }
    }

    public static Application a() {
        Application application = f16085a;
        if (application != null) {
            return application;
        }
        try {

...
final class dl {
    ...
    public dl(Context context, dk dkVar) {
        ...
        if (dkVar.a()) {
            ...
            imageView.setImageDrawable(new ei(dkVar2.f15787b, ed.a(8.0f)));
            ...
            textView.setText(dkVar2.f15786a.d());
            ...
            textView2.setText(dkVar2.f15786a.e());

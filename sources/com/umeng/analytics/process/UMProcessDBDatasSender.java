...
public class UMProcessDBDatasSender implements UMLogDataProtocol {
    ...
    public class ReplaceCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str) {
            ...
            UMProcessDBHelper.getInstance(UMProcessDBDatasSender.this.mContext).deleteEventDatas(str.replace(a.f14486d, ""), (String) null, (List<UMProcessDBHelper.a>) null);
            return true;
        }
    }
    ...
    private int defconProcesserHandler() {
        ...
        if (a10 != 0) {
            ...
            UMProcessDBHelper.getInstance(this.mContext).deleteEventDatas(a.f14490h, (String) null, (List<UMProcessDBHelper.a>) null);
        }
        return a10;
    }
    ...
    private JSONObject generalHeader() {
        ...
        try {
            ...
            jSONObject.put(f.f14194i, AnalyticsConfig.getVerticalType(this.mContext));
            String str4 = "9.7.9";
            ...
            SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(this.mContext);
            jSONObject.put(f.f14197l, UMEnvelopeBuild.imprintProperty(this.mContext, "pr_ve", (String) null));
            jSONObject.put(f.f14198m, UMEnvelopeBuild.imprintProperty(this.mContext, "ud_da", (String) null));
            jSONObject.put(f.an, "1.0.0");
            if (TextUtils.isEmpty(imprintProperty)) {
                jSONObject.put(f.f14197l, sharedPreferences.getString("vers_pre_version", "0"));
                jSONObject.put(f.f14198m, sharedPreferences.getString("vers_date", new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date(System.currentTimeMillis()))));
            }
        } catch (Throwable th) {
            th.printStackTrace();
        }
    ...
    public void removeCacheData(Object obj) {
        ...
        if (obj != null && (list = this.mGeneralBodyIds) != null && list.size() != 0) {
            ...
            if (jSONObject.has(b.a("analytics")) && (optJSONObject = jSONObject.optJSONObject(b.a("analytics"))) != null && optJSONObject.length() > 0 && optJSONObject.has("ekv")) {
            ...
            if (jSONObject2.length() > 0) {
                if (jSONObject2.has("analytics")) {
                    ...
                    if (optJSONObject.length() == 1) {
                        if (optJSONObject.optJSONObject(f.L) != null || !TextUtils.isEmpty(optJSONObject.optString("userlevel"))) {
                            return null;
                        }
                    }

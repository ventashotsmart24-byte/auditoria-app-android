...
public class MobclickAgent {
    ...
    public static void onEventObject(Context context, String str, Map<String, Object> map) {
        ...
        try {
            ...
            bbVar.a(bb.a.OBJECT_MAP).a(str).b((Map<String, Object>) hashMap);
            az.a(context, 101, ba.a(), bbVar);
        } catch (Throwable unused) {
        }
        if (map == null) {
            UMLog.aq(l.f14307a, 0, "\\|");
        } else {
    ...
    public static void onEventValue(Context context, String str, Map<String, String> map, int i10) {
        ...
        try {
            ...
            bbVar.a(bb.a.STRING_MAP).a(str).a((Map<String, String>) hashMap2).a(true);
            az.a(context, 101, ba.a(), bbVar);
        } catch (Throwable unused) {
        }
        if (map == null) {
    ...
    public static void reportError(Context context, String str) {
        ...
        Class<UMCrash> cls2 = UMCrash.class;
        try {
    ...
    public static void onProfileSignIn(String str, String str2) {
        if (TextUtils.isEmpty(str2)) {
            UMLog.aq(l.f14328t, 0, "\\|");
        } else if (str2.length() > 64) {
            UMLog.aq(l.f14329u, 0, "\\|");
        } else if (TextUtils.isEmpty(str)) {
            b.a().a("_adhoc", str2);
        } else if (str.length() > 32) {
            UMLog.aq(l.f14330v, 0, "\\|");
        } else {
            b.a().a(str, str2);
        }
    }
    ...
    public static void reportError(Context context, Throwable th) {
        Class<UMCrash> cls = UMCrash.class;
        try {
            EfsReporter efsReporter = UMCrash.sReporter;
    ...
    public static void onEvent(Context context, String str, Map<String, String> map) {
        ...
        try {
            ...
            bbVar.a(bb.a.STRING_MAP).a(str).a((Map<String, String>) hashMap);
            az.a(context, 101, ba.a(), bbVar);
        } catch (Throwable unused) {
        }
        if (map == null) {

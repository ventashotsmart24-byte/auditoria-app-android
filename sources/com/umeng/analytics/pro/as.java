...
public class as {
    ...
    public static void a(Context context, String str) {
        ...
        try {
            Method declaredMethod = cls.getDeclaredMethod("processEvent", new Class[]{Context.class, String.class});
            if (declaredMethod != null) {
                declaredMethod.invoke(cls, new Object[]{context, str});
            }
        } catch (Throwable unused) {
        }
    }

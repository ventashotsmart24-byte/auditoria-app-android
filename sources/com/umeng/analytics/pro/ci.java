...
public final class ci {
    ...
    private static final Comparator f14048a = new a();
    ...
    public static int a(List list, List list2) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            int compare = f14048a.compare(list.get(i10), list2.get(i10));
            if (compare != 0) {
                return compare;
            }
        }
    ...
    public static int a(Set set, Set set2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            int compare = f14048a.compare(it.next(), it2.next());
            if (compare != 0) {
                return compare;
            }
        }
    ...
    public static int a(Map map, Map map2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            ...
            Comparator comparator2 = f14048a;
    ...
    public static String a(byte b10) {
        return Integer.toHexString((b10 | 256) & UnsignedBytes.MAX_VALUE).toUpperCase().substring(1);
    }

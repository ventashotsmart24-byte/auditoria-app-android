...
public class l {
    ...
    public static final String f14307a = ("事件属性集合参数为空|onEvent接口必须传入非空的属性集合。详见问题链接 " + UMLogUtils.makeUrl("66946"));

    /* renamed from: aa  reason: collision with root package name */
    public static final String f14308aa = ("unregisterPreProperty接口调用非法。|当前处于非DPLUS场景中，不能使用DPLUS相关接口，详见问题连接：" + UMLogUtils.makeUrl("67310"));

    /* renamed from: ab  reason: collision with root package name */
    public static final String f14309ab = ("clearPreProperties接口调用非法。|当前处于非DPLUS场景中，不能使用DPLUS相关接口，详见问题连接：" + UMLogUtils.makeUrl("67310"));
    ...
    public static final String f14310b = ("事件ID和保留字冲突|onEvent接口传入的事件ID不能和保留字冲突。详见问题链接 " + UMLogUtils.makeUrl("66946"));

    /* renamed from: c  reason: collision with root package name */
    public static final String f14311c = ("事件ID为null或者为空字符串|onEvent接口传入的事件ID不能为null，也不能为空字符串。详见问题链接 " + UMLogUtils.makeUrl("66946"));

    /* renamed from: d  reason: collision with root package name */
    public static final String f14312d = ("事件属性集合map没有加入K-V值|事件属性集合参数map必须添加K-V值。详见问题链接 " + UMLogUtils.makeUrl("66946"));

    /* renamed from: e  reason: collision with root package name */
    public static final String f14313e = ("事件属性集合map中key值和保留字冲突|事件属性集合map中key值不能和保留字冲突。详见问题链接 " + UMLogUtils.makeUrl("66946"));

    /* renamed from: f  reason: collision with root package name */
    public static final String f14314f = ("事件ID为null或者长度超过限制|事件ID不能为null、空串，且长度不能超过128个字符。详见问题链接 " + UMLogUtils.makeUrl("66946"));

    /* renamed from: g  reason: collision with root package name */
    public static final String f14315g = ("事件属性集合参数为空或者事件属性集合map没有加入K-V值|事件属性集合参数map必须添加K-V值。详见问题链接 " + UMLogUtils.makeUrl("66946"));

    /* renamed from: h  reason: collision with root package name */
    public static final String f14316h = ("事件属性集合map中key非法|事件属性集合参数map中key不能为非法的。详见问题链接 " + UMLogUtils.makeUrl("66946"));

    /* renamed from: i  reason: collision with root package name */
    public static final String f14317i = ("事件属性集合map中value为null|事件属性集合参数map中value不能为null。详见问题链接 " + UMLogUtils.makeUrl("66946"));

    /* renamed from: j  reason: collision with root package name */
    public static final String f14318j = ("事件属性集合map中value长度超过限制|事件属性集合参数map中value如果为字符串时，其长度不能超过256个字符。详见问题链接 " + UMLogUtils.makeUrl("66946"));

    /* renamed from: k  reason: collision with root package name */
    public static final String f14319k = ("事件标签为null或者为空字符串|onEvent接口传入的事件标签不能为null，也不能为空字符串。详见问题链接 " + UMLogUtils.makeUrl("66946"));

    /* renamed from: l  reason: collision with root package name */
    public static final String f14320l = ("事件ID为null或者长度超过限制，或事件标签长度超过限制|事件ID不能为null、空串，且长度不能超过128个字符。事件标签长度不能超过256个字符。详见问题链接 " + UMLogUtils.makeUrl("66946"));

    /* renamed from: m  reason: collision with root package name */
    public static final String f14321m = ("事件ID和保留字冲突|onEvent接口传入的事件ID不能和保留字冲突。详见问题链接 " + UMLogUtils.makeUrl("66946"));

    /* renamed from: n  reason: collision with root package name */
    public static final String f14322n = ("MobclickAgent.onResume接口参数不能为null|MobclickAgent.onResume接口参数应该传入当前Activity的上下文。详见问题链接 " + UMLogUtils.makeUrl("66948"));

    /* renamed from: o  reason: collision with root package name */
    public static final String f14323o = ("MobclickAgent.onResume接口参数不是Activity的上下文|MobclickAgent.onResume接口参数应该传入当前Activity的上下文。详见问题链接 " + UMLogUtils.makeUrl("66948"));

    /* renamed from: p  reason: collision with root package name */
    public static final String f14324p = ("MobclickAgent.onPause接口参数不能为null|MobclickAgent.onPause接口参数应该传入当前Activity的上下文。详见问题链接 " + UMLogUtils.makeUrl("66948"));

    /* renamed from: q  reason: collision with root package name */
    public static final String f14325q = ("MobclickAgent.onPause接口参数不是Activity的上下文|MobclickAgent.onPause接口参数应该传入当前Activity的上下文。详见问题链接 " + UMLogUtils.makeUrl("66948"));

    /* renamed from: r  reason: collision with root package name */
    public static final String f14326r = ("@ 遗漏了Mobclick.onResume函数调用|每个Activity的onResume中都必须调用MobclickAgent.onResume。详见问题链接 " + UMLogUtils.makeUrl("66948"));

    /* renamed from: s  reason: collision with root package name */
    public static final String f14327s = ("@ 遗漏了Mobclick.onPaused函数调用|每个Activity的onPaused中都必须调用MobclickAgent.onPaused。详见问题链接 " + UMLogUtils.makeUrl("66948"));

    /* renamed from: t  reason: collision with root package name */
    public static final String f14328t = ("MobclickAgent.onProfileSignIn接口参数 账号ID 不能为null|账号ID不能为空。详见问题链接 " + UMLogUtils.makeUrl("66951"));

    /* renamed from: u  reason: collision with root package name */
    public static final String f14329u = ("MobclickAgent.onProfileSignIn接口参数 账号ID 长度超过限制|账号ID 长度不能超过64个字符。详见问题链接 " + UMLogUtils.makeUrl("66951"));

    /* renamed from: v  reason: collision with root package name */
    public static final String f14330v = ("MobclickAgent.onProfileSignIn接口参数 账号来源 长度超过限制|账号来源 长度不能超过32个字符。详见问题链接 " + UMLogUtils.makeUrl("66951"));

    /* renamed from: w  reason: collision with root package name */
    public static final String f14331w = ("MobclickAgent.reportError方法参数context不能为null|参数Context需要指定ApplicationContext值。详见问题链接 " + UMLogUtils.makeUrl("66971"));

    /* renamed from: x  reason: collision with root package name */
    public static final String f14332x = ("MobclickAgent.reportError方法参数error不能为null，也不能为空字符串。|error参数必须是非空字符串。详见问题链接 " + UMLogUtils.makeUrl("66971"));

    /* renamed from: y  reason: collision with root package name */
    public static final String f14333y = ("MobclickAgent.reportError方法 Context和Throwable参数都不能为空。|参数Context需要指定ApplicationContext值，Throwable参数传入捕获到的异常对象。详见问题链接 " + UMLogUtils.makeUrl("66971"));

    /* renamed from: z  reason: collision with root package name */
    public static final String f14334z = "MobclickAgent.setSecret方法参数context不能为null|参数Context需要指定ApplicationContext值。";
}

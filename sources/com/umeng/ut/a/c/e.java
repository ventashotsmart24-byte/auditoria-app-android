...
public class e {
    ...
    private static boolean f16230b = false;
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static void m30a(String str, Object... objArr) {
        if (f16230b) {
            d();
            a(str, objArr);
        }
            ...
            for (StackTraceElement stackTraceElement : Thread.currentThread().getStackTrace()) {
                if (!stackTraceElement.isNativeMethod()) {
                    if (!stackTraceElement.getClassName().equals(Thread.class.getName())) {
                        if (!stackTraceElement.getClassName().equals(e.class.getName())) {

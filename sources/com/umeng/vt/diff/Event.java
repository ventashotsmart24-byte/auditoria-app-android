...
public class Event {
    ...
    private static void reflectTrack(Context context, String str, Map<String, Object> map) {
        ...
        try {
            ...
            if (findClass != null && (method = findClass.getMethod("onEvent", new Class[]{Context.class, String.class, Map.class})) != null) {
                method.invoke((Object) null, new Object[]{context, str, map});
            }

...
public class ABTest implements d {
    ...
    private ABTest(Context context2, String str, int i10) {
    ...
    private float prob(String str, int i10) {
        ...
        return ((float) Integer.valueOf(str.substring(i11, i11 + 5), 16).intValue()) / 1048576.0f;
    }

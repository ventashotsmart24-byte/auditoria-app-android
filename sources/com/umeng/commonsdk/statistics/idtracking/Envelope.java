...
public class Envelope {
    ...
    public static Envelope genEncryptEnvelope(Context context, String str, byte[] bArr) {
        try {
            ...
            String string = sharedPreferences.getString(a.f14531x, (String) null);
            ...
            envelope.seal();
            sharedPreferences.edit().putInt("serial", i10 + 1).putString(a.f14531x, envelope.getSignature()).commit();
    ...
    public static String getSignature(Context context) {
        ...
        return sharedPreferences.getString(a.f14531x, (String) null);
    }

    public void export(Context context) {
        String str = this.mAddress;
        String imprintProperty = UMEnvelopeBuild.imprintProperty(context, bt.f13913g, (String) null);
        ...
        try {
            ...
            if (imprintProperty != null) {
                jSONObject.put(bt.f13913g, imprintProperty);
            }
            jSONObject.put(a.f14531x, hexString);
        ...
        try {
            ...
            if (imprintProperty != null) {
                jSONObject2.put(bt.f13913g, HelperUtils.getUmengMD5(imprintProperty));
            }
            HelperUtils.writeFile(new File(context.getFilesDir(), bd.b().b(bd.f13848h)), jSONObject2.toString());
        } catch (Throwable th2) {
            th2.printStackTrace();
        }
    }

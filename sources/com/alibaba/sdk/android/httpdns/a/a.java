...
public class a {
    ...
    private static volatile a f4913a;

    /* renamed from: a  reason: collision with other field name */
    private final Beacon.OnServiceErrListener f0a = new Beacon.OnServiceErrListener() {
    ...
    /* renamed from: a  reason: collision with other field name */
    private final Beacon.OnUpdateListener f1a = new Beacon.OnUpdateListener() {
    ...
    public void b(List<Beacon.Config> list) {
        if (list != null && list.size() != 0) {
            for (Beacon.Config next : list) {
                if (next.key.equalsIgnoreCase("___httpdns_service___")) {
                    a(next);
                }
            }
        }
    ...
    private void i(String str) {
        if (str != null) {
            ...
            sb.append(str);
            this.f4914m = !str.equalsIgnoreCase("disabled");
        }
    }

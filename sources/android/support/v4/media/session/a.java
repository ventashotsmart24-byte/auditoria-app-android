...
public interface a extends IInterface {
    ...
    public static abstract class C0007a extends Binder implements a {
        ...
        public static class C0008a implements a {
            ...
            public static a f467b;

            /* renamed from: a  reason: collision with root package name */
            public IBinder f468a;
            ...
            public void G(ParcelableVolumeInfo parcelableVolumeInfo) {
                ...
                try {
                    ...
                    if (this.f468a.transact(8, obtain, (Parcel) null, 1) || C0007a.j0() == null) {
                        obtain.recycle();
                    } else {
                        C0007a.j0().G(parcelableVolumeInfo);
                    }
                } finally {
                    obtain.recycle();
                }
            ...
            public void h0(PlaybackStateCompat playbackStateCompat) {
                ...
                try {
                    ...
                    if (this.f468a.transact(3, obtain, (Parcel) null, 1) || C0007a.j0() == null) {
                        obtain.recycle();
                    } else {
                        C0007a.j0().h0(playbackStateCompat);
                    }
                } finally {
                    obtain.recycle();
                }
            ...
            public void t() {
                ...
                try {
                    obtain.writeInterfaceToken("android.support.v4.media.session.IMediaControllerCallback");
                    if (this.f468a.transact(2, obtain, (Parcel) null, 1) || C0007a.j0() == null) {
                        obtain.recycle();
                    } else {
                        C0007a.j0().t();
                    }
            ...
            public void v(MediaMetadataCompat mediaMetadataCompat) {
                ...
                try {
                    ...
                    if (this.f468a.transact(4, obtain, (Parcel) null, 1) || C0007a.j0() == null) {
                        obtain.recycle();
                    } else {
                        C0007a.j0().v(mediaMetadataCompat);
                    }
                } finally {
                    obtain.recycle();
                }

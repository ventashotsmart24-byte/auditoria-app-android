...
public class IjkMediaCodecInfo {
    ...
    public static String getProfileLevelName(int i10, int i11) {
        return String.format(Locale.US, " %s Profile Level %s (%d,%d)", new Object[]{getProfileName(i10), getLevelName(i11), Integer.valueOf(i10), Integer.valueOf(i11)});
    }
    ...
    public void dumpProfileLevels(String str) {
        ...
        try {
            ...
            String.format(Locale.US, "%s", new Object[]{getProfileLevelName(i11, i10)});
        } catch (Throwable unused) {
        }
    }
}

...
public class IjkMediaMeta {
    ...
    public static class IjkStreamMeta {
        ...
        public String getBitrateInline() {
            ...
            if (j10 < 1000) {
                return String.format(Locale.US, "%d bit/s", new Object[]{Long.valueOf(j10)});
            }
            return String.format(Locale.US, "%d kb/s", new Object[]{Long.valueOf(j10 / 1000)});
        }
        ...
        public String getChannelLayoutInline() {
            ...
            return String.format(Locale.US, "%x", new Object[]{Long.valueOf(j10)});
        }
        ...
        public String getFpsInline() {
            ...
            return String.valueOf(((float) i11) / ((float) i10));
        }
        ...
        public String getResolutionInline() {
            ...
            if (this.mSarNum <= 0 || this.mSarDen <= 0) {
                return String.format(Locale.US, "%d x %d", new Object[]{Integer.valueOf(i10), Integer.valueOf(this.mHeight)});
            }
            return String.format(Locale.US, "%d x %d [SAR %d:%d]", new Object[]{Integer.valueOf(i10), Integer.valueOf(this.mHeight), Integer.valueOf(this.mSarNum), Integer.valueOf(this.mSarDen)});
        }
        ...
        public String getSampleRateInline() {
            ...
            return String.format(Locale.US, "%d Hz", new Object[]{Integer.valueOf(i10)});
        }
    ...
    public String getDurationInline() {
        ...
        long j11 = j10 / 60;
        return String.format(Locale.US, "%02d:%02d:%02d", new Object[]{Long.valueOf(j11 / 60), Long.valueOf(j11 % 60), Long.valueOf(j10 % 60)});
    }

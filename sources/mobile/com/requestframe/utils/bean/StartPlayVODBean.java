...
public final class StartPlayVODBean {
    ...
    public static /* synthetic */ StartPlayVODBean copy$default(StartPlayVODBean startPlayVODBean, String str, String str2, String str3, String str4, int[] iArr, String str5, Integer num, String str6, String str7, int i10, int i11, Object obj) {
        StartPlayVODBean startPlayVODBean2 = startPlayVODBean;
        int i12 = i11;
        return startPlayVODBean.copy((i12 & 1) != 0 ? startPlayVODBean2.userToken : str, (i12 & 2) != 0 ? startPlayVODBean2.userId : str2, (i12 & 4) != 0 ? startPlayVODBean2.portalCode : str3, (i12 & 8) != 0 ? startPlayVODBean2.authType : str4, (i12 & 16) != 0 ? startPlayVODBean2.episodeNumberList : iArr, (i12 & 32) != 0 ? startPlayVODBean2.type : str5, (i12 & 64) != 0 ? startPlayVODBean2.columnId : num, (i12 & 128) != 0 ? startPlayVODBean2.contentId : str6, (i12 & 256) != 0 ? startPlayVODBean2.seriesContentId : str7, (i12 & 512) != 0 ? startPlayVODBean2.startTime : i10);
    }
    ...
    public final StartPlayVODBean copy(String str, String str2, String str3, String str4, int[] iArr, String str5, Integer num, String str6, String str7, int i10) {
        ...
        String str9 = str6;
        i.g(str9, "contentId");
        return new StartPlayVODBean(str, str2, str3, str4, iArr, str8, num, str9, str7, i10);
    }
    ...
    public int hashCode() {
        ...
        return ((hashCode4 + i10) * 31) + this.startTime;
    }

...
public final class FilterByContentBean {
    ...
    public static /* synthetic */ FilterByContentBean copy$default(FilterByContentBean filterByContentBean, String str, String str2, String str3, String str4, String str5, String str6, String str7, Integer num, String str8, int i10, int i11, int i12, Object obj) {
        FilterByContentBean filterByContentBean2 = filterByContentBean;
        int i13 = i12;
        return filterByContentBean.copy((i13 & 1) != 0 ? filterByContentBean2.userToken : str, (i13 & 2) != 0 ? filterByContentBean2.userId : str2, (i13 & 4) != 0 ? filterByContentBean2.portalCode : str3, (i13 & 8) != 0 ? filterByContentBean2.originalCountry : str4, (i13 & 16) != 0 ? filterByContentBean2.tags : str5, (i13 & 32) != 0 ? filterByContentBean2.year : str6, (i13 & 64) != 0 ? filterByContentBean2.audio : str7, (i13 & 128) != 0 ? filterByContentBean2.columnId : num, (i13 & 256) != 0 ? filterByContentBean2.language : str8, (i13 & 512) != 0 ? filterByContentBean2.pageSize : i10, (i13 & 1024) != 0 ? filterByContentBean2.pageNum : i11);
    }
    ...
    public final FilterByContentBean copy(String str, String str2, String str3, String str4, String str5, String str6, String str7, Integer num, String str8, int i10, int i11) {
        ...
        String str9 = str3;
        i.g(str9, "portalCode");
        return new FilterByContentBean(str, str2, str9, str4, str5, str6, str7, num, str8, i10, i11);
    }
    ...
    public int hashCode() {
        ...
        return ((((hashCode6 + i10) * 31) + this.pageSize) * 31) + this.pageNum;
    }

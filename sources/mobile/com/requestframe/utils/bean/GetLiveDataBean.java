...
public final class GetLiveDataBean {
    ...
    public static /* synthetic */ GetLiveDataBean copy$default(GetLiveDataBean getLiveDataBean, String str, String str2, String str3, int i10, String str4, String str5, int i11, int i12, int i13, Object obj) {
        GetLiveDataBean getLiveDataBean2 = getLiveDataBean;
        int i14 = i13;
        return getLiveDataBean.copy((i14 & 1) != 0 ? getLiveDataBean2.userToken : str, (i14 & 2) != 0 ? getLiveDataBean2.userId : str2, (i14 & 4) != 0 ? getLiveDataBean2.portalCode : str3, (i14 & 8) != 0 ? getLiveDataBean2.columnId : i10, (i14 & 16) != 0 ? getLiveDataBean2.dataVersion : str4, (i14 & 32) != 0 ? getLiveDataBean2.expireTimeStr : str5, (i14 & 64) != 0 ? getLiveDataBean2.pageNum : i11, (i14 & 128) != 0 ? getLiveDataBean2.pageSize : i12);
    }
    ...
    public int hashCode() {
        ...
        return ((((hashCode2 + i10) * 31) + this.pageNum) * 31) + this.pageSize;
    }

...
public final class SearchByNameBean {
    ...
    public static /* synthetic */ SearchByNameBean copy$default(SearchByNameBean searchByNameBean, String str, String str2, String str3, Integer num, String str4, String str5, Integer num2, Integer num3, String str6, int i10, Object obj) {
        SearchByNameBean searchByNameBean2 = searchByNameBean;
        int i11 = i10;
        return searchByNameBean.copy((i11 & 1) != 0 ? searchByNameBean2.userToken : str, (i11 & 2) != 0 ? searchByNameBean2.userId : str2, (i11 & 4) != 0 ? searchByNameBean2.portalCode : str3, (i11 & 8) != 0 ? searchByNameBean2.columnId : num, (i11 & 16) != 0 ? searchByNameBean2.value : str4, (i11 & 32) != 0 ? searchByNameBean2.type : str5, (i11 & 64) != 0 ? searchByNameBean2.pageSize : num2, (i11 & 128) != 0 ? searchByNameBean2.pageNum : num3, (i11 & 256) != 0 ? searchByNameBean2.filter : str6);
    }
    ...
    public final SearchByNameBean copy(String str, String str2, String str3, Integer num, String str4, String str5, Integer num2, Integer num3, String str6) {
        ...
        String str8 = str5;
        i.g(str8, "type");
        return new SearchByNameBean(str, str2, str3, num, str7, str8, num2, num3, str6);
    }

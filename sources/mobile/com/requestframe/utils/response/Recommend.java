...
public final class Recommend implements Serializable {
    ...
    public static /* synthetic */ Recommend copy$default(Recommend recommend, String str, String str2, List<RecommendContentList> list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public int hashCode() {
        ...
        return ((hashCode + i10) * 31) + this.contentList.hashCode();
    }

...
public final class FilterGenreResultData {
    ...
    public static /* synthetic */ FilterGenreResultData copy$default(FilterGenreResultData filterGenreResultData, List list, List list2, List list3, List list4, List list5, List list6, List list7, List list8, List list9, int i10, Object obj) {
        FilterGenreResultData filterGenreResultData2 = filterGenreResultData;
        int i11 = i10;
        return filterGenreResultData.copy((i11 & 1) != 0 ? filterGenreResultData2.originalCountry : list, (i11 & 2) != 0 ? filterGenreResultData2.tags : list2, (i11 & 4) != 0 ? filterGenreResultData2.year : list3, (i11 & 8) != 0 ? filterGenreResultData2.audio : list4, (i11 & 16) != 0 ? filterGenreResultData2.types : list5, (i11 & 32) != 0 ? filterGenreResultData2.fixGenre : list6, (i11 & 64) != 0 ? filterGenreResultData2.fixYear : list7, (i11 & 128) != 0 ? filterGenreResultData2.fixCountry : list8, (i11 & 256) != 0 ? filterGenreResultData2.fixAudio : list9);
    }
    ...
    public final FilterGenreResultData copy(List<String> list, List<String> list2, List<String> list3, List<FilterInfo> list4, List<ChildColumnList> list5, List<FilterInfo> list6, List<FilterInfo> list7, List<FilterInfo> list8, List<FilterInfo> list9) {
        ...
        i.g(list3, "year");
        i.g(list4, "audio");
        List<ChildColumnList> list10 = list5;
        i.g(list10, "types");
        List<FilterInfo> list11 = list6;
        i.g(list11, "fixGenre");
        List<FilterInfo> list12 = list7;
        i.g(list12, "fixYear");
        List<FilterInfo> list13 = list8;
        i.g(list13, "fixCountry");
        List<FilterInfo> list14 = list9;
        i.g(list14, "fixAudio");
        return new FilterGenreResultData(list, list2, list3, list4, list10, list11, list12, list13, list14);
    }

...
public final class CdnListBeanResult implements Serializable {
    ...
    public static /* synthetic */ CdnListBeanResult copy$default(CdnListBeanResult cdnListBeanResult, String str, String str2, String str3, String str4, String str5, String str6, int i10, String str7, List list, Integer num, String str8, String str9, String str10, String str11, int i11, Object obj) {
        CdnListBeanResult cdnListBeanResult2 = cdnListBeanResult;
        int i12 = i11;
        return cdnListBeanResult.copy((i12 & 1) != 0 ? cdnListBeanResult2.main_addr : str, (i12 & 2) != 0 ? cdnListBeanResult2.main_addr_mark : str2, (i12 & 4) != 0 ? cdnListBeanResult2.spared_addr : str3, (i12 & 8) != 0 ? cdnListBeanResult2.spared_addr_mark : str4, (i12 & 16) != 0 ? cdnListBeanResult2.cdn_type : str5, (i12 & 32) != 0 ? cdnListBeanResult2.tag : str6, (i12 & 64) != 0 ? cdnListBeanResult2.serial_number : i10, (i12 & 128) != 0 ? cdnListBeanResult2.cdn_id : str7, (i12 & 256) != 0 ? cdnListBeanResult2.url_list : list, (i12 & 512) != 0 ? cdnListBeanResult2.weight : num, (i12 & 1024) != 0 ? cdnListBeanResult2.cdn_id_mark : str8, (i12 & 2048) != 0 ? cdnListBeanResult2.rule_id_mark : str9, (i12 & 4096) != 0 ? cdnListBeanResult2.group_id_mark : str10, (i12 & 8192) != 0 ? cdnListBeanResult2.gslb_params : str11);
    }
    ...
    public final CdnListBeanResult copy(String str, String str2, String str3, String str4, String str5, String str6, int i10, String str7, List<CdnUrl> list, Integer num, String str8, String str9, String str10, String str11) {
        ...
        String str14 = str7;
        i.g(str14, "cdn_id");
        return new CdnListBeanResult(str, str2, str3, str4, str12, str13, i10, str14, list, num, str8, str9, str10, str11);
    }

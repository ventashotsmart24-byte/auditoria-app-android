...
public final class GetLiveData implements Serializable {
    ...
    public static /* synthetic */ GetLiveData copy$default(GetLiveData getLiveData, String str, String str2, int i10, List<Channel> list, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public int hashCode() {
        ...
        return ((((hashCode + i10) * 31) + this.channelListTotalSize) * 31) + this.channelList.hashCode();
    }

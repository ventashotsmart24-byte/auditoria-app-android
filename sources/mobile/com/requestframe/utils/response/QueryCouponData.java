...
public final class QueryCouponData {
    ...
    public static /* synthetic */ QueryCouponData copy$default(QueryCouponData queryCouponData, List<CouponCodeList> list, String str, int i10, List<AvailableCouponCodeList> list2, int i11, Object obj) {
        if ((i11 & 1) != 0) {

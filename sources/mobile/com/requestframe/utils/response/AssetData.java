...
public final class AssetData implements Serializable {
    ...
    public AssetData(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, int i10, int i11, String str9, String str10, String str11, String str12, String str13, float f10, String str14, String str15, String str16, String str17, String str18, int i12, int i13, int i14, int i15, String str19, String str20, String str21, String str22, String str23, List<SimpleProgramList> list, List<? extends PosterList> list2, List<ProgramSeason> list3) {
        ...
        i.g(str25, "name");
        i.g(str26, "duration");
        i.g(str27, "hasPositive");
        i.g(str28, "hasTidbits");
        i.g(str29, "hasTrailer");
        i.g(str30, "restricted");
        i.g(str31, "programType");
        i.g(str32, "alias");
        i.g(str33, "director");
        i.g(str34, "actorDisplay");
        i.g(str35, "language");
        i.g(str36, "originalCountry");
        i.g(str37, "releaseTime");
        i.g(str15, "viewPoint");
        i.g(str16, "keyWords");
        i.g(str17, "tags");
        ...
        this.name = str25;
        this.duration = str26;
        this.hasPositive = str27;
        this.hasTidbits = str28;
        this.hasTrailer = str29;
        this.restricted = str30;
        this.programType = str31;
        this.volumnCount = i10;
        this.updateCount = i11;
        this.alias = str32;
        this.director = str33;
        this.actorDisplay = str34;
        this.language = str35;
        this.originalCountry = str36;
        this.score = f10;
        this.releaseTime = str37;
    ...
    public static /* synthetic */ AssetData copy$default(AssetData assetData, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, int i10, int i11, String str9, String str10, String str11, String str12, String str13, float f10, String str14, String str15, String str16, String str17, String str18, int i12, int i13, int i14, int i15, String str19, String str20, String str21, String str22, String str23, List list, List list2, List list3, int i16, int i17, Object obj) {
        AssetData assetData2 = assetData;
        int i18 = i16;
        return assetData.copy((i18 & 1) != 0 ? assetData2.contentId : str, (i18 & 2) != 0 ? assetData2.name : str2, (i18 & 4) != 0 ? assetData2.duration : str3, (i18 & 8) != 0 ? assetData2.hasPositive : str4, (i18 & 16) != 0 ? assetData2.hasTidbits : str5, (i18 & 32) != 0 ? assetData2.hasTrailer : str6, (i18 & 64) != 0 ? assetData2.restricted : str7, (i18 & 128) != 0 ? assetData2.programType : str8, (i18 & 256) != 0 ? assetData2.volumnCount : i10, (i18 & 512) != 0 ? assetData2.updateCount : i11, (i18 & 1024) != 0 ? assetData2.alias : str9, (i18 & 2048) != 0 ? assetData2.director : str10, (i18 & 4096) != 0 ? assetData2.actorDisplay : str11, (i18 & 8192) != 0 ? assetData2.language : str12, (i18 & 16384) != 0 ? assetData2.originalCountry : str13, (i18 & 32768) != 0 ? assetData2.score : f10, (i18 & 65536) != 0 ? assetData2.releaseTime : str14, (i18 & 131072) != 0 ? assetData2.viewPoint : str15, (i18 & 262144) != 0 ? assetData2.keyWords : str16, (i18 & 524288) != 0 ? assetData2.tags : str17, (i18 & LogType.ANR) != 0 ? assetData2.description : str18, (i18 & AutoStrategy.BITRATE_LOW4) != 0 ? assetData2.moreAudio : i12, (i18 & AutoStrategy.BITRATE_LOW) != 0 ? assetData2.moreSubtitle : i13, (i18 & AutoStrategy.BITRATE_HIGH) != 0 ? assetData2.subscribeId : i14, (i18 & 16777216) != 0 ? assetData2.favoriteId : i15, (i18 & 33554432) != 0 ? assetData2.hasSubscribe : str19, (i18 & 67108864) != 0 ? assetData2.hasFavorite : str20, (i18 & 134217728) != 0 ? assetData2.contentTag : str21, (i18 & 268435456) != 0 ? assetData2.contentTagUrl : str22, (i18 & 536870912) != 0 ? assetData2.awardsUrl : str23, (i18 & Ints.MAX_POWER_OF_TWO) != 0 ? assetData2.simpleProgramList : list, (i18 & Integer.MIN_VALUE) != 0 ? assetData2.posterList : list2, (i17 & 1) != 0 ? assetData2.sameSeasonSeriesList : list3);
    }
    ...
    public final AssetData copy(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, int i10, int i11, String str9, String str10, String str11, String str12, String str13, float f10, String str14, String str15, String str16, String str17, String str18, int i12, int i13, int i14, int i15, String str19, String str20, String str21, String str22, String str23, List<SimpleProgramList> list, List<? extends PosterList> list2, List<ProgramSeason> list3) {
        ...
        i.g(list, "simpleProgramList");
        i.g(list2, "posterList");
        return new AssetData(str24, str2, str3, str4, str5, str6, str7, str8, i10, i11, str9, str10, str11, str12, str13, f10, str14, str15, str16, str17, str18, i12, i13, i14, i15, str19, str20, str21, str22, str23, list, list2, list3);
    }

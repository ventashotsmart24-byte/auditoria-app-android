...
public final class GetOrderInfoData {
    ...
    public GetOrderInfoData(int i10, String str, int i11, String str2, int i12, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, int i13, int i14) {
        ...
        String str22 = str11;
        i.g(str, "orderId");
        i.g(str14, "packagePlanName");
        i.g(str15, "paymentAmount");
        i.g(str16, "paymentCurrency");
        i.g(str17, "paymentTime");
        i.g(str18, IPushHandler.STATE);
        i.g(str19, "paymentPlatform");
        i.g(str20, "paymentType");
        i.g(str21, BrowserInfo.KEY_CREATE_TIME);
        i.g(str22, "invalidDate");
        this.id = i10;
        this.orderId = str;
        this.packageType = i11;
        this.packagePlanName = str14;
        this.authorizedDays = i12;
        this.paymentAmount = str15;
        this.paymentCurrency = str16;
        this.paymentTime = str17;
        this.state = str18;
        this.paymentPlatform = str19;
        this.paymentType = str20;
        this.createTime = str21;
        this.redirectUrl = str10;
        this.invalidDate = str22;
    ...
    public static /* synthetic */ GetOrderInfoData copy$default(GetOrderInfoData getOrderInfoData, int i10, String str, int i11, String str2, int i12, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, int i13, int i14, int i15, Object obj) {
        GetOrderInfoData getOrderInfoData2 = getOrderInfoData;
        int i16 = i15;
        return getOrderInfoData.copy((i16 & 1) != 0 ? getOrderInfoData2.id : i10, (i16 & 2) != 0 ? getOrderInfoData2.orderId : str, (i16 & 4) != 0 ? getOrderInfoData2.packageType : i11, (i16 & 8) != 0 ? getOrderInfoData2.packagePlanName : str2, (i16 & 16) != 0 ? getOrderInfoData2.authorizedDays : i12, (i16 & 32) != 0 ? getOrderInfoData2.paymentAmount : str3, (i16 & 64) != 0 ? getOrderInfoData2.paymentCurrency : str4, (i16 & 128) != 0 ? getOrderInfoData2.paymentTime : str5, (i16 & 256) != 0 ? getOrderInfoData2.state : str6, (i16 & 512) != 0 ? getOrderInfoData2.paymentPlatform : str7, (i16 & 1024) != 0 ? getOrderInfoData2.paymentType : str8, (i16 & 2048) != 0 ? getOrderInfoData2.createTime : str9, (i16 & 4096) != 0 ? getOrderInfoData2.redirectUrl : str10, (i16 & 8192) != 0 ? getOrderInfoData2.invalidDate : str11, (i16 & 16384) != 0 ? getOrderInfoData2.uploadUrl : str12, (i16 & 32768) != 0 ? getOrderInfoData2.paymentInfo : str13, (i16 & 65536) != 0 ? getOrderInfoData2.isProcessing : i13, (i16 & 131072) != 0 ? getOrderInfoData2.specialType : i14);
    }
    ...
    public int hashCode() {
        ...
        return ((((hashCode3 + i10) * 31) + this.isProcessing) * 31) + this.specialType;
    }

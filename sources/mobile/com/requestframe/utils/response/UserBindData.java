...
public final class UserBindData {
    ...
    public static /* synthetic */ UserBindData copy$default(UserBindData userBindData, String str, String str2, String str3, String str4, String str5, int i10, Object obj) {
        ...
        String str6 = str2;
        if ((i10 & 4) != 0) {
            str3 = userBindData.f19010mobile;
        }
        String str7 = str3;
        if ((i10 & 8) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return i.b(this.email, userBindData.email) && i.b(this.bindMail, userBindData.bindMail) && i.b(this.f19010mobile, userBindData.f19010mobile) && i.b(this.bindMobile, userBindData.bindMobile) && i.b(this.areaCode, userBindData.areaCode);
    }
    ...
    public int hashCode() {
        ...
        String str3 = this.f19010mobile;
        if (str3 != null) {
            i10 = str3.hashCode();
        }
        return ((((hashCode2 + i10) * 31) + this.bindMobile.hashCode()) * 31) + this.areaCode.hashCode();
    }
    ...
    public final void setMobile(String str) {
        this.f19010mobile = str;
    }

    public String toString() {
        return "UserBindData(email=" + this.email + ", bindMail=" + this.bindMail + ", mobile=" + this.f19010mobile + ", bindMobile=" + this.bindMobile + ", areaCode=" + this.areaCode + ASCIIPropertyListParser.ARRAY_END_TOKEN;
    }
}

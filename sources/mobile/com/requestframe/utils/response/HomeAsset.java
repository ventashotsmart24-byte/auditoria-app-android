...
public final class HomeAsset implements Serializable {
    ...
    public static /* synthetic */ HomeAsset copy$default(HomeAsset homeAsset, String str, String str2, String str3, String str4, String str5, Integer num, Integer num2, String str6, String str7, List list, int i10, Object obj) {
        HomeAsset homeAsset2 = homeAsset;
        int i11 = i10;
        return homeAsset.copy((i11 & 1) != 0 ? homeAsset2.contentId : str, (i11 & 2) != 0 ? homeAsset2.name : str2, (i11 & 4) != 0 ? homeAsset2.type : str3, (i11 & 8) != 0 ? homeAsset2.duration : str4, (i11 & 16) != 0 ? homeAsset2.programType : str5, (i11 & 32) != 0 ? homeAsset2.volumnCount : num, (i11 & 64) != 0 ? homeAsset2.updateCount : num2, (i11 & 128) != 0 ? homeAsset2.alias : str6, (i11 & 256) != 0 ? homeAsset2.contentType : str7, (i11 & 512) != 0 ? homeAsset2.posterList : list);
    }
    ...
    public final HomeAsset copy(String str, String str2, String str3, String str4, String str5, Integer num, Integer num2, String str6, String str7, List<ShelvePoster> list) {
        ...
        i.g(str8, "duration");
        String str9 = str5;
        i.g(str9, "programType");
        return new HomeAsset(str, str2, str3, str8, str9, num, num2, str6, str7, list);
    }

...
public final class ShelveChannel implements Serializable {
    ...
    public static /* synthetic */ ShelveChannel copy$default(ShelveChannel shelveChannel, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, List list, List list2, int i10, Object obj) {
        ShelveChannel shelveChannel2 = shelveChannel;
        int i11 = i10;
        return shelveChannel.copy((i11 & 1) != 0 ? shelveChannel2.channelCode : str, (i11 & 2) != 0 ? shelveChannel2.name : str2, (i11 & 4) != 0 ? shelveChannel2.alias : str3, (i11 & 8) != 0 ? shelveChannel2.supportBusiness : str4, (i11 & 16) != 0 ? shelveChannel2.channelNumber : str5, (i11 & 32) != 0 ? shelveChannel2.tags : str6, (i11 & 64) != 0 ? shelveChannel2.contentEn : str7, (i11 & 128) != 0 ? shelveChannel2.contentZh : str8, (i11 & 256) != 0 ? shelveChannel2.keyWords : str9, (i11 & 512) != 0 ? shelveChannel2.restricted : str10, (i11 & 1024) != 0 ? shelveChannel2.posterList : list, (i11 & 2048) != 0 ? shelveChannel2.liveAddressList : list2);
    }

...
public final class GetProgramData {
    ...
    public static /* synthetic */ GetProgramData copy$default(GetProgramData getProgramData, String str, String str2, String str3, int i10, String str4, String str5, List list, String str6, int i11, Object obj) {
        GetProgramData getProgramData2 = getProgramData;
        int i12 = i11;
        return getProgramData.copy((i12 & 1) != 0 ? getProgramData2.channelCode : str, (i12 & 2) != 0 ? getProgramData2.name : str2, (i12 & 4) != 0 ? getProgramData2.supportBusiness : str3, (i12 & 8) != 0 ? getProgramData2.channelNumber : i10, (i12 & 16) != 0 ? getProgramData2.tags : str4, (i12 & 32) != 0 ? getProgramData2.restricted : str5, (i12 & 64) != 0 ? getProgramData2.programList : list, (i12 & 128) != 0 ? getProgramData2.alias : str6);
    }

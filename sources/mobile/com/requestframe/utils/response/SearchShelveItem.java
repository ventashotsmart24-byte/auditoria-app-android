...
public final class SearchShelveItem implements Serializable {
    ...
    public static /* synthetic */ SearchShelveItem copy$default(SearchShelveItem searchShelveItem, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, List list, String str11, int i10, float f10, int i11, int i12, int i13, Object obj) {
        SearchShelveItem searchShelveItem2 = searchShelveItem;
        int i14 = i13;
        return searchShelveItem.copy((i14 & 1) != 0 ? searchShelveItem2.type : str, (i14 & 2) != 0 ? searchShelveItem2.contentId : str2, (i14 & 4) != 0 ? searchShelveItem2.name : str3, (i14 & 8) != 0 ? searchShelveItem2.alias : str4, (i14 & 16) != 0 ? searchShelveItem2.director : str5, (i14 & 32) != 0 ? searchShelveItem2.actorDisplay : str6, (i14 & 64) != 0 ? searchShelveItem2.originalCountry : str7, (i14 & 128) != 0 ? searchShelveItem2.releaseTime : str8, (i14 & 256) != 0 ? searchShelveItem2.tags : str9, (i14 & 512) != 0 ? searchShelveItem2.programType : str10, (i14 & 1024) != 0 ? searchShelveItem2.posterList : list, (i14 & 2048) != 0 ? searchShelveItem2.contentType : str11, (i14 & 4096) != 0 ? searchShelveItem2.moreSubtitle : i10, (i14 & 8192) != 0 ? searchShelveItem2.score : f10, (i14 & 16384) != 0 ? searchShelveItem2.updateCount : i11, (i14 & 32768) != 0 ? searchShelveItem2.volumnCount : i12);
    }
    ...
    public int hashCode() {
        ...
        return ((((((((hashCode11 + i10) * 31) + this.moreSubtitle) * 31) + Float.floatToIntBits(this.score)) * 31) + this.updateCount) * 31) + this.volumnCount;
    }

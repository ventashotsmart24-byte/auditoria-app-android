...
public final class ShelveAsset implements Serializable {
    ...
    public ShelveAsset(String str, String str2, String str3, String str4, String str5, String str6, int i10, int i11, String str7, String str8, float f10, String str9, String str10, String str11, String str12, String str13, int i12, int i13, String str14, List<ShelvePoster> list) {
        ...
        String str25 = str12;
        String str26 = str13;
        List<ShelvePoster> list2 = list;
        i.g(str15, "contentId");
        i.g(str16, "name");
        i.g(str17, "actorDisplay");
        i.g(str18, "type");
        i.g(str19, "duration");
        i.g(str20, "programType");
        i.g(str21, "alias");
        i.g(str22, "director");
        i.g(str23, "viewPoint");
        i.g(str24, "updateTime");
        i.g(str25, "tags");
        i.g(str26, MediaTrack.ROLE_DESCRIPTION);
        i.g(list2, "posterList");
        this.contentId = str15;
        this.name = str16;
        this.actorDisplay = str17;
        this.type = str18;
        this.duration = str19;
        this.programType = str20;
        this.volumnCount = i10;
        this.updateCount = i11;
        this.alias = str21;
        this.director = str22;
        this.score = f10;
        this.viewPoint = str23;
    ...
    public static /* synthetic */ ShelveAsset copy$default(ShelveAsset shelveAsset, String str, String str2, String str3, String str4, String str5, String str6, int i10, int i11, String str7, String str8, float f10, String str9, String str10, String str11, String str12, String str13, int i12, int i13, String str14, List list, int i14, Object obj) {
        ShelveAsset shelveAsset2 = shelveAsset;
        int i15 = i14;
        return shelveAsset.copy((i15 & 1) != 0 ? shelveAsset2.contentId : str, (i15 & 2) != 0 ? shelveAsset2.name : str2, (i15 & 4) != 0 ? shelveAsset2.actorDisplay : str3, (i15 & 8) != 0 ? shelveAsset2.type : str4, (i15 & 16) != 0 ? shelveAsset2.duration : str5, (i15 & 32) != 0 ? shelveAsset2.programType : str6, (i15 & 64) != 0 ? shelveAsset2.volumnCount : i10, (i15 & 128) != 0 ? shelveAsset2.updateCount : i11, (i15 & 256) != 0 ? shelveAsset2.alias : str7, (i15 & 512) != 0 ? shelveAsset2.director : str8, (i15 & 1024) != 0 ? shelveAsset2.score : f10, (i15 & 2048) != 0 ? shelveAsset2.viewPoint : str9, (i15 & 4096) != 0 ? shelveAsset2.updateTime : str10, (i15 & 8192) != 0 ? shelveAsset2.shelveTime : str11, (i15 & 16384) != 0 ? shelveAsset2.tags : str12, (i15 & 32768) != 0 ? shelveAsset2.description : str13, (i15 & 65536) != 0 ? shelveAsset2.moreAudio : i12, (i15 & 131072) != 0 ? shelveAsset2.moreSubtitle : i13, (i15 & 262144) != 0 ? shelveAsset2.contentType : str14, (i15 & 524288) != 0 ? shelveAsset2.posterList : list);
    }
    ...
    public final ShelveAsset copy(String str, String str2, String str3, String str4, String str5, String str6, int i10, int i11, String str7, String str8, float f10, String str9, String str10, String str11, String str12, String str13, int i12, int i13, String str14, List<ShelvePoster> list) {
        ...
        i.g(list, "posterList");
        return new ShelveAsset(str15, str2, str3, str4, str5, str6, i10, i11, str7, str8, f10, str9, str10, str11, str12, str13, i12, i13, str14, list);
    }
    ...
    public int hashCode() {
        ...
        return ((hashCode2 + i10) * 31) + this.posterList.hashCode();
    }

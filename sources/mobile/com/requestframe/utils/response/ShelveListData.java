...
public final class ShelveListData {
    ...
    public ShelveListData(String str, int i10, int i11, List<ShelveChannel> list, List<ShelveAsset> list2, int i12, SlbInfo slbInfo2, String str2, int i13) {
        i.g(slbInfo2, "slbInfo");
        ...
        this.freshTime = i12;
        this.slbInfo = slbInfo2;
        this.hasFavorite = str2;
        this.favoriteId = i13;
    }

    public static /* synthetic */ ShelveListData copy$default(ShelveListData shelveListData, String str, int i10, int i11, List list, List list2, int i12, SlbInfo slbInfo2, String str2, int i13, int i14, Object obj) {
        ShelveListData shelveListData2 = shelveListData;
        int i15 = i14;
        return shelveListData.copy((i15 & 1) != 0 ? shelveListData2.version : str, (i15 & 2) != 0 ? shelveListData2.channelListTotalSize : i10, (i15 & 4) != 0 ? shelveListData2.assetListTotalSize : i11, (i15 & 8) != 0 ? shelveListData2.channelList : list, (i15 & 16) != 0 ? shelveListData2.assetList : list2, (i15 & 32) != 0 ? shelveListData2.freshTime : i12, (i15 & 64) != 0 ? shelveListData2.slbInfo : slbInfo2, (i15 & 128) != 0 ? shelveListData2.hasFavorite : str2, (i15 & 256) != 0 ? shelveListData2.favoriteId : i13);
    }
    ...
    public final ShelveListData copy(String str, int i10, int i11, List<ShelveChannel> list, List<ShelveAsset> list2, int i12, SlbInfo slbInfo2, String str2, int i13) {
        SlbInfo slbInfo3 = slbInfo2;
        i.g(slbInfo3, "slbInfo");
        String str3 = str2;
        i.g(str3, "hasFavorite");
        return new ShelveListData(str, i10, i11, list, list2, i12, slbInfo3, str3, i13);
    }
    ...
    public int hashCode() {
        ...
        return ((((((((hashCode2 + i10) * 31) + this.freshTime) * 31) + this.slbInfo.hashCode()) * 31) + this.hasFavorite.hashCode()) * 31) + this.favoriteId;
    }
    ...
    public final void setSlbInfo(SlbInfo slbInfo2) {
        i.g(slbInfo2, "<set-?>");
        this.slbInfo = slbInfo2;
    }

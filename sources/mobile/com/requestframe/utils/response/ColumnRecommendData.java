...
public final class ColumnRecommendData implements Serializable {
    ...
    public static /* synthetic */ ColumnRecommendData copy$default(ColumnRecommendData columnRecommendData, List<ShelveAsset> list, List<ShelveChannel> list2, int i10, Object obj) {
        if ((i10 & 1) != 0) {

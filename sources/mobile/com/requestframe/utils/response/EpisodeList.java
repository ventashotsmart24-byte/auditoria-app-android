...
public final class EpisodeList implements Serializable {
    ...
    public static /* synthetic */ EpisodeList copy$default(EpisodeList episodeList, List<TotalMovieList> list, Integer num, String str, List<SubData> list2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public int hashCode() {
        ...
        return ((hashCode2 + i10) * 31) + this.subtitleList.hashCode();
    }

...
public class j {
    ...
    public final Logger f10850a;

    /* renamed from: b  reason: collision with root package name */
    public final Level f10851b;
    ...
    public final boolean a() {
        return this.f10850a.isLoggable(this.f10851b);
    }

    public void b(a aVar, int i10, Buffer buffer, int i11, boolean z10) {
        if (a()) {
            Logger logger = this.f10850a;
            Level level = this.f10851b;
    ...
    public j(Level level, Logger logger) {
        this.f10851b = (Level) Preconditions.checkNotNull(level, FirebaseAnalytics.Param.LEVEL);
        this.f10850a = (Logger) Preconditions.checkNotNull(logger, "logger");
    }
}

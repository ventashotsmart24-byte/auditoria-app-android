...
public class p {
    ...
    public static final Set f9703b;

    /* renamed from: c  reason: collision with root package name */
    public static final p f9704c = new p();

    /* renamed from: a  reason: collision with root package name */
    public Set f9705a = f9703b;
    ...
    static {
        ...
        f9703b = Collections.unmodifiableSet(hashSet);
    }
    ...
    public void b(g gVar, j jVar, c cVar) {
        Class<? super Object> q10 = jVar.q();
        String name = q10.getName();
        if (!this.f9705a.contains(name)) {
            if (!q10.isInterface()) {

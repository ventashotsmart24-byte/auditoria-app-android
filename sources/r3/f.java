...
public final class f extends u {
    ...
    public f(b bVar, f0 f0Var, boolean z10) {
        super(bVar);
        this.f9103d = f0Var;
        this.f9104e = z10;
    }
    ...
    public static c.a p(b bVar, o oVar, f0 f0Var, j jVar, Class cls, boolean z10) {
        boolean z11;
        if (cls != null) {
            z11 = true;
        } else {
    ...
    public final List i(j jVar, Class cls) {
        ArrayList arrayList;
        h.a aVar;
        List list;
        int i10;
        ...
        if (cls != null) {
            y[] yVarArr = null;
            for (h.a aVar3 : h.A(cls)) {
                if (aVar3.d() == 0) {
                    if (aVar != null) {
                        this.f9105f = q(aVar, aVar3);
                        aVar = null;
                    }
        ...
        if (aVar != null) {
            this.f9105f = q(aVar, (h.a) null);
        }
        for (int i14 = 0; i14 < i10; i14++) {
            if (((e) list.get(i14)) == null) {
                list.set(i14, s((h.a) arrayList.get(i14), (h.a) null));
            }
        }
        return list;
    }

    public final List j(o oVar, j jVar, Class cls) {
        ArrayList arrayList = null;
        for (Method method : h.z(jVar.q())) {
            if (k(method)) {
                if (arrayList == null) {
                    arrayList = new ArrayList();
                }
        ...
        for (int i13 = 0; i13 < size; i13++) {
            if (((j) arrayList2.get(i13)) == null) {
                ...
                arrayList2.set(i13, r(method3, z.e(method3, jVar, oVar, f0Var), (Method) null));
            } else {
                o oVar2 = oVar;
                j jVar2 = jVar;
            }
    ...
    public c.a l(o oVar, j jVar, Class cls) {
        ...
        if (this.f9104e) {
            e eVar = this.f9105f;
            if (eVar != null && this.f9171a.o0(eVar)) {
                this.f9105f = null;
            }
            int size = i10.size();
            while (true) {
                ...
                if (size < 0) {
                    break;
                } else if (this.f9171a.o0((i) i10.get(size))) {
                    i10.remove(size);
                }
            }
            int size2 = j10.size();
            while (true) {
                ...
                if (size2 < 0) {
                    break;
                } else if (this.f9171a.o0((i) j10.get(size2))) {
                    j10.remove(size2);
                }
            }
        }
        return new c.a(this.f9105f, i10, j10);
    }
    ...
    public e q(h.a aVar, h.a aVar2) {
        return new e(this.f9103d, aVar.a(), m(aVar, aVar2), u.f9169b);
    }
    ...
    public j r(Method method, f0 f0Var, Method method2) {
        ...
        if (length == 0) {
            return new j(f0Var, method, n(method, method2), u.f9169b);
        }
        ...
        return new j(f0Var, method, n10, o(parameterAnnotations, annotationArr));
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v1, resolved type: r3.p[]} */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v5, resolved type: r3.p[]} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v9, resolved type: r3.p[]} */
    ...
    public r3.e s(d4.h.a r9, d4.h.a r10) {
        ...
        L_0x0057:
            ...
            java.lang.annotation.Annotation[] r1 = r3.u.f9170c
            r2[r5] = r1
            r3.p[] r3 = r8.o(r2, r3)
            goto L_0x0055
        L_0x0072:

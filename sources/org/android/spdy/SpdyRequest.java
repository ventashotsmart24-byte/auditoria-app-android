...
public final class SpdyRequest {
    ...
    public SpdyRequest(URL url2, String str, int i10, String str2, int i11, String str3, RequestPriority requestPriority, int i12, int i13, int i14) {
        this.url = url2;
        this.domain = "";
        this.host = str;
        this.port = i10;
    ...
    public SpdyRequest(URL url2, String str, int i10, String str2, RequestPriority requestPriority) {
        this.url = url2;
        this.domain = "";
        this.host = str;
        this.port = i10;
    ...
    public SpdyRequest(URL url2, String str, RequestPriority requestPriority, int i10, int i11) {
        this.url = url2;
        this.domain = "";
        this.host = url2.getHost();
        int port2 = url2.getPort();
    ...
    public SpdyRequest(URL url2, String str, String str2, int i10, String str3, int i11, String str4, RequestPriority requestPriority, int i12, int i13, int i14) {
        this.url = url2;
        this.domain = str;
        this.host = str2;
        this.port = i10;
    ...
    public SpdyRequest(URL url2, String str, String str2, int i10, String str3, RequestPriority requestPriority) {
        this.url = url2;
        this.domain = str;
        this.host = str2;
        this.port = i10;
    ...
    public SpdyRequest(URL url2, String str, String str2, RequestPriority requestPriority, int i10, int i11) {
        this.url = url2;
        this.domain = str;
        this.host = url2.getHost();
        int port2 = url2.getPort();

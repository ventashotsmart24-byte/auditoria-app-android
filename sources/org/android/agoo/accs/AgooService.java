...
public class AgooService extends TaoBaseService {
    ...
    public static CallBack f8574a;

    /* renamed from: b  reason: collision with root package name */
    public static CallBack f8575b;

    /* renamed from: c  reason: collision with root package name */
    private AgooFactory f8576c;
    ...
    public void onBind(String str, int i10, TaoBaseService.ExtraInfo extraInfo) {
        ...
        if (f8574a != null && GlobalClientInfo.AGOO_SERVICE_ID.equals(str)) {
            if (i10 == 200) {
                f8574a.onSuccess();
            } else {
                f8574a.onFailure(String.valueOf(i10), "bind Agoo service fail");
            }
        }
        f8574a = null;
    }
    ...
    public void onCreate() {
        ...
        this.f8576c = agooFactory;
        agooFactory.init(getApplicationContext(), (NotifManager) null, (MessageService) null);
    }
    ...
    public void onData(String str, String str2, String str3, byte[] bArr, TaoBaseService.ExtraInfo extraInfo) {
        ...
        try {
            this.f8576c.saveMsg(bArr);
            this.f8576c.msgRecevie(bArr, "accs", extraInfo);
        } catch (Throwable th) {
    ...
    public void onResponse(String str, String str2, int i10, byte[] bArr, TaoBaseService.ExtraInfo extraInfo) {
        ...
        if (i10 == 200 && TextUtils.equals(str, AgooConstants.AGOO_SERVICE_AGOOACK)) {
            ...
            this.f8576c.updateMsg(bArr, true);
    ...
    public void onSendData(String str, String str2, int i10, TaoBaseService.ExtraInfo extraInfo) {
        try {
            ...
            if (i10 == 200) {
                ...
                instance.commitEvent(AgooConstants.AGOO_EVENT_ID, "accs.agooService", b10, "errorCode", str2 + ",serviceId=" + str + ",errorCode=" + i10);
            }
        } catch (Throwable th) {
            if (ALog.isPrintLog(ALog.Level.E)) {
    ...
    public void onUnbind(String str, int i10, TaoBaseService.ExtraInfo extraInfo) {
        ...
        if (f8575b != null && GlobalClientInfo.AGOO_SERVICE_ID.equals(str)) {
            if (i10 == 200) {
                f8575b.onSuccess();
            } else {
                f8575b.onFailure(String.valueOf(i10), "unbind Agoo service fail");
            }
        }
        f8575b = null;
    }

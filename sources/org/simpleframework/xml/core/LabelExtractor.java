...
class LabelExtractor {
    ...
    private LabelBuilder getBuilder(Annotation annotation) {
        ...
        if (annotation instanceof Element) {
            return new LabelBuilder(ElementLabel.class, cls);
        }
        Class<ElementList> cls2 = ElementList.class;
        if (annotation instanceof ElementList) {
            return new LabelBuilder(ElementListLabel.class, cls2);
        }
        ...
        if (annotation instanceof ElementMap) {
            return new LabelBuilder(ElementMapLabel.class, cls3);
        }
        if (annotation instanceof ElementUnion) {
            return new LabelBuilder(ElementUnionLabel.class, ElementUnion.class, cls);
        }
        if (annotation instanceof ElementListUnion) {
            return new LabelBuilder(ElementListUnionLabel.class, ElementListUnion.class, cls2);
        }
        if (annotation instanceof ElementMapUnion) {
            return new LabelBuilder(ElementMapUnionLabel.class, ElementMapUnion.class, cls3);
        }

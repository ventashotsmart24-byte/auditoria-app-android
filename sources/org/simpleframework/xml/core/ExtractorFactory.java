...
class ExtractorFactory {
    ...
    public static class ElementExtractor implements Extractor<Element> {
        ...
        public ElementExtractor(Contact contact2, ElementUnion elementUnion, Format format2) {
    ...
    public static class ElementListExtractor implements Extractor<ElementList> {
        ...
        public ElementListExtractor(Contact contact2, ElementListUnion elementListUnion, Format format2) {
            this.contact = contact2;
            this.format = format2;
    ...
    public static class ElementMapExtractor implements Extractor<ElementMap> {
        ...
        public ElementMapExtractor(Contact contact2, ElementMapUnion elementMapUnion, Format format2) {
            this.contact = contact2;
            this.format = format2;

...
class ParameterFactory {
    ...
    private ParameterBuilder getBuilder(Annotation annotation) {
        ...
        if (annotation instanceof Element) {
            return new ParameterBuilder(ElementParameter.class, cls);
        }
        Class<ElementList> cls2 = ElementList.class;
        if (annotation instanceof ElementList) {
            return new ParameterBuilder(ElementListParameter.class, cls2);
        }
        if (annotation instanceof ElementArray) {
            return new ParameterBuilder(ElementArrayParameter.class, ElementArray.class);
        }
        Class<ElementMap> cls3 = ElementMap.class;
        if (annotation instanceof ElementMapUnion) {
            return new ParameterBuilder(ElementMapUnionParameter.class, ElementMapUnion.class, cls3);
        }
        if (annotation instanceof ElementListUnion) {
            return new ParameterBuilder(ElementListUnionParameter.class, ElementListUnion.class, cls2);
        }
        if (annotation instanceof ElementUnion) {
            return new ParameterBuilder(ElementUnionParameter.class, ElementUnion.class, cls);
        }
        if (annotation instanceof ElementMap) {
            return new ParameterBuilder(ElementMapParameter.class, cls3);
        }
    ...
    public Parameter getInstance(Constructor constructor, Annotation annotation, int i10) {
        return getInstance(constructor, annotation, (Annotation) null, i10);
    }
    ...
    public Parameter getInstance(Constructor constructor, Annotation annotation, Annotation annotation2, int i10) {
        ...
        if (annotation2 != null) {
            return (Parameter) constructor2.newInstance(new Object[]{constructor, annotation, annotation2, this.format, Integer.valueOf(i10)});
        }
        return (Parameter) constructor2.newInstance(new Object[]{constructor, annotation, this.format, Integer.valueOf(i10)});
    }
}

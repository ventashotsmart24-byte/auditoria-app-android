...
public abstract class j {
    ...
    public static class a implements TypeEvaluator {
        ...
        public d.b[] evaluate(float f10, d.b[] bVarArr, d.b[] bVarArr2) {
            if (d.b(bVarArr, bVarArr2)) {
                if (!d.b(this.f9581a, bVarArr)) {
                    this.f9581a = d.f(bVarArr);
                }
                for (int i10 = 0; i10 < bVarArr.length; i10++) {
                    this.f9581a[i10].d(bVarArr[i10], bVarArr2[i10], f10);
                }
                return this.f9581a;
            }
    ...
    public static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) {
        ...
        L_0x005d:
            ...
            int[] r0 = x0.a.f9563h
            r7 = r22
            android.content.res.TypedArray r6 = q.i.k(r8, r9, r7, r0)
            java.lang.String r0 = "ordering"
            int r16 = q.i.g(r6, r10, r0, r14, r14)
            r0 = r18
            r1 = r19
            r2 = r20
            r3 = r21
    ...
    public static android.animation.PropertyValuesHolder e(android.content.res.TypedArray r11, int r12, int r13, int r14, java.lang.String r15) {
        ...
        L_0x0165:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: x0.j.e(android.content.res.TypedArray, int, int, int, java.lang.String):android.animation.PropertyValuesHolder");
    }
    ...
    public static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        boolean z10;
        TypedArray k10 = i.k(resources, theme, attributeSet, a.f9565j);
        int i10 = 0;
        TypedValue l10 = i.l(k10, xmlPullParser, "value", 0);
        if (l10 != null) {
            z10 = true;
        } else {
            z10 = false;
    ...
    public static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f10, XmlPullParser xmlPullParser) {
        TypedArray k10 = i.k(resources, theme, attributeSet, a.f9562g);
        TypedArray k11 = i.k(resources, theme, attributeSet, a.f9566k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        q(valueAnimator, k10, k11, f10, xmlPullParser);
        int h10 = i.h(k10, xmlPullParser, "interpolator", 0, 0);
        if (h10 > 0) {
    ...
    public static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i10, XmlPullParser xmlPullParser) {
        ...
        Keyframe keyframe;
        TypedArray k10 = i.k(resources, theme, attributeSet, a.f9565j);
        float f10 = i.f(k10, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue l10 = i.l(k10, xmlPullParser, "value", 0);
        if (l10 != null) {
            z10 = true;
        } else {
        ...
        if (z10) {
            if (i10 == 0) {
                keyframe = Keyframe.ofFloat(f10, i.f(k10, xmlPullParser, "value", 0, 0.0f));
            } else if (i10 == 1 || i10 == 3) {
                keyframe = Keyframe.ofInt(f10, i.g(k10, xmlPullParser, "value", 0, 0));
            } else {
                keyframe = null;
            }
        } else if (i10 == 0) {
        ...
        int h10 = i.h(k10, xmlPullParser, "interpolator", 1, 0);
        if (h10 > 0) {
            keyframe.setInterpolator(i.b(context, h10));
        }
        k10.recycle();
        return keyframe;
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.animation.PropertyValuesHolder o(android.content.Context r9, android.content.res.Resources r10, android.content.res.Resources.Theme r11, org.xmlpull.v1.XmlPullParser r12, java.lang.String r13, int r14) {
        /*
            r0 = 0
            r1 = r0
        L_0x0002:
        ...
        L_0x00e9:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: x0.j.o(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, java.lang.String, int):android.animation.PropertyValuesHolder");
    }

    /* JADX WARNING: Removed duplicated region for block: B:21:0x006f  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.animation.PropertyValuesHolder[] p(android.content.Context r17, android.content.res.Resources r18, android.content.res.Resources.Theme r19, org.xmlpull.v1.XmlPullParser r20, android.util.AttributeSet r21) {
        /*
            r6 = r20
            r7 = 0
            r8 = r7
        ...
        L_0x0016:
            ...
            r12 = r19
            r13 = r21
            android.content.res.TypedArray r14 = q.i.k(r11, r12, r13, r0)
            java.lang.String r0 = "propertyName"
            java.lang.String r15 = q.i.i(r14, r6, r0, r1)
            java.lang.String r0 = "valueType"
            r1 = 4
            int r5 = q.i.g(r14, r6, r0, r2, r1)
            r0 = r17
            r1 = r18
            r2 = r19
            r3 = r20
        ...
        L_0x0082:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: x0.j.p(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet):android.animation.PropertyValuesHolder[]");
    }
    ...
    public static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f10, XmlPullParser xmlPullParser) {
        long g10 = (long) i.g(typedArray, xmlPullParser, "duration", 1, 300);
        long g11 = (long) i.g(typedArray, xmlPullParser, "startOffset", 2, 0);
        int g12 = i.g(typedArray, xmlPullParser, "valueType", 7, 4);
    ...
    public static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i10, float f10, XmlPullParser xmlPullParser) {
        ...
        String i11 = i.i(typedArray, xmlPullParser, "pathData", 1);
        if (i11 != null) {
            String i12 = i.i(typedArray, xmlPullParser, "propertyXName", 2);
            String i13 = i.i(typedArray, xmlPullParser, "propertyYName", 3);
            if (i10 != 2) {
            }
            if (i12 == null && i13 == null) {
                throw new InflateException(typedArray.getPositionDescription() + " propertyXName or propertyYName is needed for PathData");
            }
            s(d.e(i11), objectAnimator, f10 * 0.5f, i12, i13);
            return;
        }

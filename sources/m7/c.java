...
public abstract class c {
    ...
    public static String c(int i10) {
        String string = f.f7908b.getResources().getString(i10);
        if ("false".equals(f.f7908b.getResources().getString(R$string.domain_is_security))) {
            return string;
        }
        return b.a(string, "*&@!6d5d-c483-4720-bb29-785b8f321c^%");
    }
    ...
    public static Pair d(d dVar, d dVar2, int i10, int i11) {
        ...
        String d10 = a.d(f.f7908b, dVar.b());
        if (TextUtils.isEmpty(d10)) {
            d10 = c(i10);
        }
        String d11 = a.d(f.f7908b, dVar2.b());

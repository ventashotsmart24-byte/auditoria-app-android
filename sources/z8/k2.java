...
public abstract class k2 {
    ...
    public static final Logger f20735a = Logger.getLogger(k2.class.getName());

    /* renamed from: b  reason: collision with root package name */
    public static final byte[] f20736b = "-bin".getBytes(Charsets.US_ASCII);
    ...
    public static byte[][] d(v0 v0Var) {
        ...
        for (int i11 = 0; i11 < d10.length; i11 += 2) {
            ...
            if (a(bArr, f20736b)) {
                d10[i10] = bArr;
                d10[i10 + 1] = j0.f20031b.encode(bArr2).getBytes(Charsets.US_ASCII);
            } else if (b(bArr2)) {
                d10[i10] = bArr;
                d10[i10 + 1] = bArr2;
            } else {
                String str = new String(bArr, Charsets.US_ASCII);
                Logger logger = f20735a;

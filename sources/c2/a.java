...
public final class a {
    ...
    public static final String f4591b = a.class.getSimpleName();

    public final void a(CastAction castAction, long j10, long j11) {
        i.g(castAction, "castAction");
        ...
        e.f4622a.a("app_cast_action", hashMap, j10, j11, false, true);
    }

    public final void b(CastDeviceDiscovery castDeviceDiscovery, long j10, long j11) {
        i.g(castDeviceDiscovery, "castDeviceDiscovery");
        HashMap hashMap = new HashMap();
        ...
        e.f4622a.a("app_cast_discovery", hashMap, j10, j11, false, true);
    }

    public final void c(CastPlay castPlay, long j10, long j11) {
        i.g(castPlay, "castPlay");
        HashMap hashMap = new HashMap();
        ...
        e.f4622a.a("app_cast_play", hashMap, j10, j11, false, true);
    }
}

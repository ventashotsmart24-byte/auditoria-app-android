...
public class a implements IAppMonitor {
    ...
    private static Map<Class<?>, List<Field>> f3615b = new ConcurrentHashMap();

    /* renamed from: c  reason: collision with root package name */
    private static Map<Class<?>, List<Field>> f3616c = new ConcurrentHashMap();

    /* renamed from: d  reason: collision with root package name */
    private static Map<Field, String> f3617d = new ConcurrentHashMap();

    /* renamed from: e  reason: collision with root package name */
    private static Random f3618e = new Random();

    /* renamed from: f  reason: collision with root package name */
    private static Set<Class<?>> f3619f = Collections.newSetFromMap(new ConcurrentHashMap());
    ...
    public synchronized void a(java.lang.Class<?> r17) {
        /*
            ...
            boolean r1 = f3614a     // Catch:{ all -> 0x00f4 }
            if (r1 != 0) goto L_0x000b
            goto L_0x00f7
        L_0x000b:
            r1 = 0
            java.util.Set<java.lang.Class<?>> r2 = f3619f     // Catch:{ Exception -> 0x00e7 }
        ...
        L_0x0016:
            ...
            return
        L_0x0022:
            java.lang.reflect.Field[] r3 = r17.getFields()     // Catch:{ Exception -> 0x00e7 }
        ...
        L_0x0064:
            java.util.Map<java.lang.reflect.Field, java.lang.String> r11 = f3617d     // Catch:{ Exception -> 0x00e7 }
        ...
        L_0x008e:
            java.lang.String r11 = r10.name()     // Catch:{ Exception -> 0x00e7 }
        L_0x0092:
            java.util.Map<java.lang.reflect.Field, java.lang.String> r12 = f3617d     // Catch:{ Exception -> 0x00e7 }
        ...
        L_0x00c8:
            ...
            goto L_0x0039
        L_0x00cc:
            java.util.Map<java.lang.Class<?>, java.util.List<java.lang.reflect.Field>> r3 = f3615b     // Catch:{ Exception -> 0x00e7 }
            r3.put(r0, r4)     // Catch:{ Exception -> 0x00e7 }
            java.util.Map<java.lang.Class<?>, java.util.List<java.lang.reflect.Field>> r3 = f3616c     // Catch:{ Exception -> 0x00e7 }
    ...
    public void commitAlarm(AlarmObject alarmObject) {
        if (f3614a && alarmObject != null && !TextUtils.isEmpty(alarmObject.module) && !TextUtils.isEmpty(alarmObject.modulePoint)) {
    ...
    public void commitCount(CountObject countObject) {
        if (f3614a && countObject != null && !TextUtils.isEmpty(countObject.module) && !TextUtils.isEmpty(countObject.modulePoint)) {
            ...
            if (monitor != null) {
                ...
                if (statObject.beforeCommit()) {
                    if (monitor.monitorPoint().equals("network")) {
                        ...
                        if (a10 != 10000 && f3618e.nextInt(10000) >= a10) {
                            return;
                        }
                    }
                    try {
                        ...
                        List<Field> list = f3615b.get(cls);
                        if (ALog.isPrintLog(1)) {
                            hashMap = new HashMap();
                        } else {
                            hashMap = null;
                        ...
                        if (list != null) {
                            ...
                            for (Field field2 : f3616c.get(cls)) {
                                Double valueOf = Double.valueOf(field2.getDouble(statObject));
                                create2.setValue(f3617d.get(field2), valueOf.doubleValue());
                                if (hashMap != null) {
                                    hashMap.put(f3617d.get(field2), valueOf);
                                }
                            }
                        }

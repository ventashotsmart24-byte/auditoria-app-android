...
public abstract class f extends RecyclerView.n implements RecyclerView.q {
    ...
    public static abstract class a {
        ...
        private static final Interpolator sDragScrollInterpolator = new C0044a();
        private static final Interpolator sDragViewScrollCapInterpolator = new b();
        private int mCachedMaxScrollSpeed = -1;

        /* renamed from: androidx.recyclerview.widget.f$a$a  reason: collision with other inner class name */
        public static class C0044a implements Interpolator {
        ...
        public RecyclerView.d0 chooseDropTarget(RecyclerView.d0 d0Var, List<RecyclerView.d0> list, int i10, int i11) {
            ...
            int width = i10 + d0Var2.itemView.getWidth();
            int height = i11 + d0Var2.itemView.getHeight();
            int left2 = i10 - d0Var2.itemView.getLeft();
            int top2 = i11 - d0Var2.itemView.getTop();
            int size = list.size();
            RecyclerView.d0 d0Var3 = null;
            int i12 = -1;
            for (int i13 = 0; i13 < size; i13++) {
                RecyclerView.d0 d0Var4 = list.get(i13);
                if (left2 > 0 && (right = d0Var4.itemView.getRight() - width) < 0 && d0Var4.itemView.getRight() > d0Var2.itemView.getRight() && (abs4 = Math.abs(right)) > i12) {
                    d0Var3 = d0Var4;
                    i12 = abs4;
                }
                if (left2 < 0 && (left = d0Var4.itemView.getLeft() - i10) > 0 && d0Var4.itemView.getLeft() < d0Var2.itemView.getLeft() && (abs3 = Math.abs(left)) > i12) {
                    d0Var3 = d0Var4;
                    i12 = abs3;
                }
                if (top2 < 0 && (top = d0Var4.itemView.getTop() - i11) > 0 && d0Var4.itemView.getTop() < d0Var2.itemView.getTop() && (abs2 = Math.abs(top)) > i12) {
                    d0Var3 = d0Var4;
                    i12 = abs2;
                }
                if (top2 > 0 && (bottom = d0Var4.itemView.getBottom() - height) < 0 && d0Var4.itemView.getBottom() > d0Var2.itemView.getBottom() && (abs = Math.abs(bottom)) > i12) {
                    d0Var3 = d0Var4;
                    i12 = abs;
                }
            }
        ...
        public int interpolateOutOfBoundsScroll(RecyclerView recyclerView, int i10, int i11, int i12, long j10) {
            float f10 = 1.0f;
            int signum = (int) (((float) (((int) Math.signum((float) i11)) * a(recyclerView))) * sDragViewScrollCapInterpolator.getInterpolation(Math.min(1.0f, (((float) Math.abs(i11)) * 1.0f) / ((float) i10))));
        ...
        public void onChildDraw(Canvas canvas, RecyclerView recyclerView, RecyclerView.d0 d0Var, float f10, float f11, int i10, boolean z10) {
            h.f2986a.c(canvas, recyclerView, d0Var.itemView, f10, f11, i10, z10);
        }
        ...
        public void onChildDrawOver(Canvas canvas, RecyclerView recyclerView, RecyclerView.d0 d0Var, float f10, float f11, int i10, boolean z10) {
            h.f2986a.d(canvas, recyclerView, d0Var.itemView, f10, f11, i10, z10);
        }

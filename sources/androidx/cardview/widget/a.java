...
public abstract class a extends FrameLayout {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (!(fVar instanceof c)) {
            ...
            if (mode == Integer.MIN_VALUE || mode == 1073741824) {
                i10 = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil((double) fVar.m(this.mCardViewDelegate)), View.MeasureSpec.getSize(i10)), mode);
            }
            int mode2 = View.MeasureSpec.getMode(i11);
            if (mode2 == Integer.MIN_VALUE || mode2 == 1073741824) {
                i11 = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil((double) fVar.f(this.mCardViewDelegate)), View.MeasureSpec.getSize(i11)), mode2);
            }
    ...
    public a(Context context, AttributeSet attributeSet, int i10) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.f1495a, i10, R$style.CardView);

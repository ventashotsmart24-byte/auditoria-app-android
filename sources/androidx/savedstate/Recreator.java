...
final class Recreator implements e {
    ...
    public static final class a implements SavedStateRegistry.b {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final Set f3078a = new HashSet();
        ...
        public Bundle a() {
            ...
            bundle.putStringArrayList("classes_to_restore", new ArrayList(this.f3078a));
            return bundle;
        }
    ...
    public void a(g gVar, d.b bVar) {
        if (bVar == d.b.ON_CREATE) {
            ...
            Bundle a10 = this.f3077a.getSavedStateRegistry().a("androidx.savedstate.Restarter");
            if (a10 != null) {
    ...
    public final void b(String str) {
        try {
            ...
            try {
                ...
                try {
                    ((SavedStateRegistry.a) declaredConstructor.newInstance(new Object[0])).a(this.f3077a);
                } catch (Exception e10) {

...
public final class WorkDatabase_Impl extends WorkDatabase {
    ...
    public volatile q f3387m;

    /* renamed from: n  reason: collision with root package name */
    public volatile b f3388n;

    /* renamed from: o  reason: collision with root package name */
    public volatile t f3389o;

    /* renamed from: p  reason: collision with root package name */
    public volatile h f3390p;

    /* renamed from: q  reason: collision with root package name */
    public volatile k f3391q;

    /* renamed from: r  reason: collision with root package name */
    public volatile n f3392r;

    /* renamed from: s  reason: collision with root package name */
    public volatile e f3393s;
    ...
    public class a extends g.a {
        ...
        public void b(t0.b bVar) {
            ...
            if (WorkDatabase_Impl.this.f8870h != null) {
                int size = WorkDatabase_Impl.this.f8870h.size();
                for (int i10 = 0; i10 < size; i10++) {
                    ((e.b) WorkDatabase_Impl.this.f8870h.get(i10)).b(bVar);
                }
            }
        }
        ...
        public void c(t0.b bVar) {
            if (WorkDatabase_Impl.this.f8870h != null) {
                int size = WorkDatabase_Impl.this.f8870h.size();
                for (int i10 = 0; i10 < size; i10++) {
                    ((e.b) WorkDatabase_Impl.this.f8870h.get(i10)).a(bVar);
                }
            }
        }

        public void d(t0.b bVar) {
            t0.b unused = WorkDatabase_Impl.this.f8863a = bVar;
            bVar.execSQL("PRAGMA foreign_keys = ON");
            WorkDatabase_Impl.this.m(bVar);
            if (WorkDatabase_Impl.this.f8870h != null) {
                int size = WorkDatabase_Impl.this.f8870h.size();
                for (int i10 = 0; i10 < size; i10++) {
                    ((e.b) WorkDatabase_Impl.this.f8870h.get(i10)).c(bVar);
                }
            }
        }
        ...
        public g.b g(t0.b bVar) {
            ...
            hashMap2.put(IPushHandler.STATE, new f.a(IPushHandler.STATE, "INTEGER", true, 0, (String) null, 1));
    ...
    public t0.c f(q0.a aVar) {
        return aVar.f8846a.a(c.b.a(aVar.f8847b).c(aVar.f8848c).b(new g(aVar, new a(12), "c103703e120ae8cc73c9248622f3cd1e", "49f946663a8deb7054212b8adda248c6")).a());
    }

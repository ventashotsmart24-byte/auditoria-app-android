...
public final class h extends LuminanceSource {
    ...
    public h(Bitmap bitmap) {
        ...
        for (int i11 = 0; i11 < height; i11++) {
            ...
            for (int i13 = 0; i13 < width; i13++) {
                ...
                int i18 = i15 & 255;
                if (i16 == i17 && i17 == i18) {
                    this.f16525a[i14] = (byte) i16;
                } else {
                    this.f16525a[i14] = (byte) ((((i16 + i17) + i17) + i18) >> 2);
                }
            }
        }
    }
    ...
    public byte[] getRow(int i10, byte[] bArr) {
        ...
        System.arraycopy(this.f16525a, i10 * width, bArr, 0, width);
        return bArr;
    }
}

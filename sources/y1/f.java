...
public final class f {
    ...
    public final AdInfo a(Context context, String str, AdInfo adInfo, String str2, long j10, boolean z10, String str3) {
        ...
        long longValue = ((Number) e.f9866a.b(context, str, adInfo.getAd_id(), 0L)).longValue();
        if (identityFrequency == null || (j10 - longValue <= ((long) (identityFrequency.intValue() * 60 * 60 * 1000)) && !d(z10, longValue, j10))) {
            return null;
        }
        return adInfo;
    }
    ...
    public final int b(Context context) {
        i.g(context, com.umeng.analytics.pro.f.X);
        if (f9868b == null) {
            f9868b = Integer.valueOf(context.getPackageManager().getPackageInfo(context.getPackageName(), 64).versionCode);
        }
        Integer num = f9868b;
        i.d(num);
        return num.intValue();
    ...
    public final ArrayList c(Context context, String str, List list, String str2, long j10, boolean z10, String str3) {
        ...
        while (it.hasNext()) {
            AdInfo a10 = f9867a.a(context, str, (AdInfo) it.next(), str2, j10, z10, str3);
            if (a10 != null) {
                arrayList.add(a10);
            }
        }

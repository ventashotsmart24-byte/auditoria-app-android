...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        /* JADX WARNING: Code restructure failed: missing block: B:20:?, code lost:
            ...
            r1.journalWriter = okio.Okio.buffer(okio.Okio.blackhole());
         */
        ...
        public Sink newSink(int i10) {
            synchronized (DiskLruCache.this) {
                if (!this.done) {
                    ...
                    try {
                        AnonymousClass1 r12 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(entry2.dirtyFiles[i10])) {
    ...
    public DiskLruCache(FileSystem fileSystem2, File file, int i10, int i11, long j10, Executor executor2) {

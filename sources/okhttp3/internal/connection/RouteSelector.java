...
public final class RouteSelector {
    ...
    private void resetNextInetSocketAddress(Proxy proxy) {
        ...
        if (i10 < 1 || i10 > 65535) {
            throw new SocketException("No route to " + str + SOAP.DELIM + i10 + "; port is out of range");
            ...
            if (!lookup.isEmpty()) {
                ...
                for (int i11 = 0; i11 < size; i11++) {
                    this.inetSocketAddresses.add(new InetSocketAddress(lookup.get(i11), i10));
                }
                return;
            }

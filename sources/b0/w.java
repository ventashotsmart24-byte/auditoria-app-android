...
public class w {
    ...
    public ViewParent f4115a;

    /* renamed from: b  reason: collision with root package name */
    public ViewParent f4116b;
    ...
    public boolean a(float f10, float f11, boolean z10) {
        ...
        return z1.a(i10, this.f4117c, f10, f11, z10);
    }
    ...
    public boolean b(float f10, float f11) {
        ...
        return z1.b(i10, this.f4117c, f10, f11);
    }
    ...
    public boolean d(int i10, int i11, int[] iArr, int[] iArr2, int i12) {
        ...
        if (i10 != 0 || i11 != 0) {
            if (iArr2 != null) {
                this.f4117c.getLocationInWindow(iArr2);
                i15 = iArr2[0];
                i14 = iArr2[1];
            } else {
                i15 = 0;
            ...
            iArr[0] = 0;
            iArr[1] = 0;
            z1.c(i13, this.f4117c, i10, i11, iArr, i12);
            if (iArr2 != null) {
                this.f4117c.getLocationInWindow(iArr2);
                iArr2[0] = iArr2[0] - i15;
                iArr2[1] = iArr2[1] - i14;
    ...
    public final boolean h(int i10, int i11, int i12, int i13, int[] iArr, int i14, int[] iArr2) {
        ...
        if (iArr4 != null) {
            this.f4117c.getLocationInWindow(iArr4);
            i17 = iArr4[0];
            i16 = iArr4[1];
        } else {
            i17 = 0;
        ...
        z1.d(i15, this.f4117c, i10, i11, i12, i13, i14, iArr3);
        if (iArr4 != null) {
            this.f4117c.getLocationInWindow(iArr4);
            iArr4[0] = iArr4[0] - i17;
            iArr4[1] = iArr4[1] - i16;
    ...
    public final void o(int i10, ViewParent viewParent) {
        if (i10 == 0) {
            this.f4115a = viewParent;
        } else if (i10 == 1) {
            this.f4116b = viewParent;
        }
    }
    ...
    public boolean q(int i10, int i11) {
        ...
        for (ViewParent parent = this.f4117c.getParent(); parent != null; parent = parent.getParent()) {
            if (z1.f(parent, view, this.f4117c, i10, i11)) {
                o(i11, parent);
                z1.e(parent, view, this.f4117c, i10, i11);
                return true;
            }

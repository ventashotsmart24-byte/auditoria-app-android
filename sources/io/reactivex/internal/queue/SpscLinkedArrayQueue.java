...
public final class SpscLinkedArrayQueue<T> implements SimplePlainQueue<T> {
    ...
    public SpscLinkedArrayQueue(int i10) {
        ...
        this.producerLookAhead = (long) (i11 - 1);
        soProducerIndex(0);
    }
    ...
    public boolean offer(T t10) {
        if (t10 != null) {
            ...
            long j10 = ((long) this.producerLookAheadStep) + lpProducerIndex;
            if (lvElement(atomicReferenceArray, calcWrappedOffset(j10, i10)) == null) {
                ...
                resize(atomicReferenceArray, lpProducerIndex, calcWrappedOffset, t10, (long) i10);
                return true;
            }
        } else {
    ...
    public T peek() {
        ...
        T lvElement = lvElement(atomicReferenceArray, calcWrappedOffset(lpConsumerIndex, i10));

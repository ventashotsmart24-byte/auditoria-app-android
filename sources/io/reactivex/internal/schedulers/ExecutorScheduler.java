...
public final class ExecutorScheduler extends Scheduler {
    ...
    public ExecutorScheduler(@NonNull Executor executor2, boolean z10) {
    ...
    public static final class ExecutorWorker extends Scheduler.Worker implements Runnable {
        ...
        public ExecutorWorker(Executor executor2, boolean z10) {
            this.executor = executor2;
        ...
        public Disposable schedule(@NonNull Runnable runnable, long j10, @NonNull TimeUnit timeUnit) {
            ...
            if (executor2 instanceof ScheduledExecutorService) {
                try {
                    scheduledRunnable.setFuture(((ScheduledExecutorService) executor2).schedule(scheduledRunnable, j10, timeUnit));
                } catch (RejectedExecutionException e10) {
                    this.disposed = true;
                    RxJavaPlugins.onError(e10);
                    return EmptyDisposable.INSTANCE;

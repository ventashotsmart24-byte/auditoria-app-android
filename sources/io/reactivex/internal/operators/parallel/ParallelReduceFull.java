...
public final class ParallelReduceFull<T> extends Flowable<T> {
    ...
    public static final class ParallelReduceFullMainSubscriber<T> extends DeferredScalarSubscription<T> {
        ...
        public SlotPair<T> addValue(T t10) {
            ...
            while (true) {
                ...
                if (slotPair == null) {
                    ...
                    if (!b.a(this.current, (Object) null, slotPair)) {
                        continue;
                    }
                }
                ...
                b.a(this.current, slotPair, (Object) null);
            }
            if (tryAcquireSlot == 0) {
                slotPair.first = t10;
            } else {
        ...
        public void innerComplete(T t10) {
            if (t10 != null) {
                while (true) {
                    SlotPair addValue = addValue(t10);
                    if (addValue == null) {
                        break;
                    }
                    try {
                        t10 = ObjectHelper.requireNonNull(this.reducer.apply(addValue.first, addValue.second), "The reducer returned a null value");
                    } catch (Throwable th) {
                        Exceptions.throwIfFatal(th);
                        innerError(th);
                        return;

...
public final class FlowableCollect<T, U> extends AbstractFlowableWithUpstream<T, U> {
    ...
    public static final class CollectSubscriber<T, U> extends DeferredScalarSubscription<U> implements FlowableSubscriber<T> {
        ...
        public void onNext(T t10) {
            if (!this.done) {
                try {
                    this.collector.accept(this.f17485u, t10);
                } catch (Throwable th) {
    ...
    public void subscribeActual(c cVar) {
        try {
            this.source.subscribe(new CollectSubscriber(cVar, ObjectHelper.requireNonNull(this.initialSupplier.call(), "The initial value supplied is null"), this.collector));
        } catch (Throwable th) {

...
public final class FlowableTimeoutTimed<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    public static final class TimeoutFallbackSubscriber<T> extends SubscriptionArbiter implements FlowableSubscriber<T>, TimeoutSupport {
        ...
        public TimeoutFallbackSubscriber(c cVar, long j10, TimeUnit timeUnit, Scheduler.Worker worker2, b bVar) {
            super(true);
            this.downstream = cVar;
            this.timeout = j10;
            this.unit = timeUnit;
    ...
    public static final class TimeoutSubscriber<T> extends AtomicLong implements FlowableSubscriber<T>, d, TimeoutSupport {
        ...
        public TimeoutSubscriber(c cVar, long j10, TimeUnit timeUnit, Scheduler.Worker worker2) {
            this.downstream = cVar;
            this.timeout = j10;
            this.unit = timeUnit;
            this.worker = worker2;
    ...
    public FlowableTimeoutTimed(Flowable<T> flowable, long j10, TimeUnit timeUnit, Scheduler scheduler2, b bVar) {
        super(flowable);
        this.timeout = j10;
        this.unit = timeUnit;

...
public final class FlowableInternalHelper {
    ...
    public static final class BufferedTimedReplay<T> implements Callable<ConnectableFlowable<T>> {
        ...
        public BufferedTimedReplay(Flowable<T> flowable, int i10, long j10, TimeUnit timeUnit, Scheduler scheduler2) {
            this.parent = flowable;
            this.bufferSize = i10;
            this.time = j10;
            this.unit = timeUnit;
    ...
    public static final class FlatMapWithCombinerInner<U, R, T> implements Function<U, R> {
        ...
        public R apply(U u10) {
            return this.combiner.apply(this.f17490t, u10);
        }
    }
    ...
    public static final class ItemDelayFunction<T, U> implements Function<T, b> {
        ...
        public b apply(T t10) {
            return new FlowableTakePublisher((b) ObjectHelper.requireNonNull(this.itemDelay.apply(t10), "The itemDelay returned a null Publisher"), 1).map(Functions.justFunction(t10)).defaultIfEmpty(t10);
        }
    }
    ...
    public static final class ReplayFunction<T, R> implements Function<Flowable<T>, b> {
        ...
        public ReplayFunction(Function<? super Flowable<T>, ? extends b> function, Scheduler scheduler2) {
    ...
    public static final class TimedReplay<T> implements Callable<ConnectableFlowable<T>> {
        ...
        public TimedReplay(Flowable<T> flowable, long j10, TimeUnit timeUnit, Scheduler scheduler2) {
            this.parent = flowable;
            this.time = j10;
            this.unit = timeUnit;
            this.scheduler = scheduler2;

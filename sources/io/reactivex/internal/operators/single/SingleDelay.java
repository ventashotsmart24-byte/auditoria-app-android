...
public final class SingleDelay<T> extends Single<T> {
    ...
    public final class Delay implements SingleObserver<T> {
        ...
        public final class OnError implements Runnable {
            ...
            private final Throwable f17526e;
            ...
            public void run() {
                Delay.this.downstream.onError(this.f17526e);
            }
        }
    ...
    public SingleDelay(SingleSource<? extends T> singleSource, long j10, TimeUnit timeUnit, Scheduler scheduler2, boolean z10) {

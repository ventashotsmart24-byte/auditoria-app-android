...
public final class ObservableRefCount<T> extends Observable<T> {
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        synchronized (this) {
            ...
            if (refConnection.connected || j11 != ((long) this.f17514n)) {
                z10 = false;
            } else {
                z10 = true;
    ...
    public ObservableRefCount(ConnectableObservable<T> connectableObservable, int i10, long j10, TimeUnit timeUnit, Scheduler scheduler2) {

...
public final class ObservableInternalHelper {
    ...
    public static final class BufferedTimedReplayCallable<T> implements Callable<ConnectableObservable<T>> {
        ...
        public BufferedTimedReplayCallable(Observable<T> observable, int i10, long j10, TimeUnit timeUnit, Scheduler scheduler2) {
            this.parent = observable;
            this.bufferSize = i10;
            this.time = j10;
            this.unit = timeUnit;
    ...
    public static final class FlatMapWithCombinerInner<U, R, T> implements Function<U, R> {
        ...
        public R apply(U u10) {
            return this.combiner.apply(this.f17513t, u10);
        }
    }
    ...
    public static final class ItemDelayFunction<T, U> implements Function<T, ObservableSource<T>> {
        ...
        public ObservableSource<T> apply(T t10) {
            return new ObservableTake((ObservableSource) ObjectHelper.requireNonNull(this.itemDelay.apply(t10), "The itemDelay returned a null ObservableSource"), 1).map(Functions.justFunction(t10)).defaultIfEmpty(t10);
        }
    }
    ...
    public static final class ObserverOnComplete<T> implements Action {
        ...
        public ObserverOnComplete(Observer<T> observer2) {
    ...
    public static final class ObserverOnError<T> implements Consumer<Throwable> {
        ...
        public ObserverOnError(Observer<T> observer2) {
            this.observer = observer2;
        }
    ...
    public static final class ObserverOnNext<T> implements Consumer<T> {
        ...
        public ObserverOnNext(Observer<T> observer2) {
            this.observer = observer2;
        }
    ...
    public static final class TimedReplayCallable<T> implements Callable<ConnectableObservable<T>> {
        ...
        public TimedReplayCallable(Observable<T> observable, long j10, TimeUnit timeUnit, Scheduler scheduler2) {
            this.parent = observable;
            this.time = j10;
            this.unit = timeUnit;
            this.scheduler = scheduler2;

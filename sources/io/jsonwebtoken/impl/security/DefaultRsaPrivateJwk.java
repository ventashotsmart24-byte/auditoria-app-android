...
class DefaultRsaPrivateJwk extends AbstractPrivateJwk<RSAPrivateKey, RSAPublicKey, RsaPublicJwk> implements RsaPrivateJwk {
    ...
    private static boolean equalsOtherPrimes(ParameterReadable parameterReadable, ParameterReadable parameterReadable2) {
        Parameter parameter = OTHER_PRIMES_INFO;
        List list = (List) parameterReadable.get(parameter);
        List list2 = (List) parameterReadable2.get(parameter);
        int size = Collections.size((Collection<?>) list);
        if (size != Collections.size((Collection<?>) list2)) {
            return false;
        }
        if (size == 0) {
            return true;
    ...
    public boolean equals(PrivateJwk<?, ?, ?> privateJwk) {
        return (privateJwk instanceof RsaPrivateJwk) && DefaultRsaPublicJwk.equalsPublic(this, privateJwk) && Parameters.equals((ParameterReadable) this, (Object) privateJwk, PRIVATE_EXPONENT) && Parameters.equals((ParameterReadable) this, (Object) privateJwk, FIRST_PRIME) && Parameters.equals((ParameterReadable) this, (Object) privateJwk, SECOND_PRIME) && Parameters.equals((ParameterReadable) this, (Object) privateJwk, FIRST_CRT_EXPONENT) && Parameters.equals((ParameterReadable) this, (Object) privateJwk, SECOND_CRT_EXPONENT) && Parameters.equals((ParameterReadable) this, (Object) privateJwk, FIRST_CRT_COEFFICIENT) && equalsOtherPrimes(this, (ParameterReadable) privateJwk);
    }
}

...
class DefaultEcPublicJwk extends AbstractPublicJwk<ECPublicKey> implements EcPublicJwk {
    ...
    static {
        ...
        Converter converter = FieldElementConverter.B64URL_CONVERTER;
    ...
    public static boolean equalsPublic(ParameterReadable parameterReadable, Object obj) {
        if (!Parameters.equals(parameterReadable, obj, CRV) || !Parameters.equals(parameterReadable, obj, X) || !Parameters.equals(parameterReadable, obj, Y)) {
            return false;
        }
        return true;
    }

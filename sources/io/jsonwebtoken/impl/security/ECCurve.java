...
public class ECCurve extends AbstractCurve {
    ...
    private final ECParameterSpec spec = ((ECParameterSpec) new JcaTemplate(KEY_PAIR_GENERATOR_JCA_NAME).withAlgorithmParameters(new CheckedFunction<AlgorithmParameters, ECParameterSpec>() {
    ...
    static {
        ...
        for (ECCurve next : VALUES) {
            BY_JCA_CURVE.put(next.spec.getCurve(), next);
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:2:0x0005, code lost:
        r4 = (java.security.interfaces.ECPublicKey) r4;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean contains(java.security.Key r4) {
        /*
            r3 = this;
            boolean r0 = r4 instanceof java.security.interfaces.ECPublicKey
            r1 = 0
            ...
            if (r0 == 0) goto L_0x0028
            java.security.spec.ECParameterSpec r2 = r3.spec
            java.security.spec.EllipticCurve r2 = r2.getCurve()
            java.security.spec.EllipticCurve r0 = r0.getCurve()
            boolean r0 = r2.equals(r0)
            if (r0 == 0) goto L_0x0028
            java.security.spec.ECPoint r4 = r4.getW()
            boolean r4 = r3.contains((java.security.spec.ECPoint) r4)
            if (r4 == 0) goto L_0x0028
            r1 = 1
        L_0x0028:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: io.jsonwebtoken.impl.security.ECCurve.contains(java.security.Key):boolean");
    }
    ...
    public KeyPairBuilder keyPair() {
        return new DefaultKeyPairBuilder(KEY_PAIR_GENERATOR_JCA_NAME, (AlgorithmParameterSpec) toParameterSpec());
    }

...
abstract class BaseNCodec {
    ...
    public long getEncodedLength(byte[] bArr) {
        ...
        if (i11 > 0) {
            return j10 + ((((((long) i11) + j10) - 1) / ((long) i11)) * ((long) this.chunkSeparatorLength));
        }
        return j10;
    }
    ...
    public boolean isInAlphabet(String str) {
        return isInAlphabet(Strings.utf8((CharSequence) str), true);
    }

    public byte[] decode(String str) {
        return decode(Strings.utf8((CharSequence) str));
    }
}

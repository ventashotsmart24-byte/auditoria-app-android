...
public class JsonObjectDeserializer implements Function<Reader, Map<String, ?>> {
    ...
    public JsonObjectDeserializer(Deserializer<?> deserializer2, String str) {
    ...
    public RuntimeException malformed(Throwable th) {
        throw new MalformedJwtException(String.format(MALFORMED_ERROR, new Object[]{this.name, th.getMessage()}), th);
    }
    ...
    public Map<String, ?> apply(Reader reader) {
        ...
        try {
            ...
            throw new DeserializationException(String.format(MALFORMED_COMPLEX_ERROR, new Object[]{str, str, e10.getMessage()}), e10);
        } catch (Throwable th) {
            throw malformed(th);
        }
    }

...
public class DefaultJweHeader extends DefaultProtectedHeader implements JweHeader {
    ...
    public static boolean isCandidate(ParameterMap parameterMap) {
        ...
        if (!Strings.hasText(str) || str.equalsIgnoreCase(Jwts.SIG.NONE.getId()) || !Strings.hasText((String) parameterMap.get(ENCRYPTION_ALGORITHM))) {
            return false;
        }
        return true;
    }
    ...
    public String getEncryptionAlgorithm() {
        return (String) get(ENCRYPTION_ALGORITHM);
    }

    public PublicJwk<?> getEphemeralPublicKey() {
        return (PublicJwk) get(EPK);
    }

...
public final class Jwts {
    ...
    public static final class SIG {
        ...
        static {
            ...
            RS256 = (SignatureAlgorithm) Jwts.get(registry, "RS256");
            RS384 = (SignatureAlgorithm) Jwts.get(registry, "RS384");
            RS512 = (SignatureAlgorithm) Jwts.get(registry, "RS512");
            PS256 = (SignatureAlgorithm) Jwts.get(registry, "PS256");
            PS384 = (SignatureAlgorithm) Jwts.get(registry, "PS384");
            PS512 = (SignatureAlgorithm) Jwts.get(registry, "PS512");
            ES256 = (SignatureAlgorithm) Jwts.get(registry, "ES256");
            ES384 = (SignatureAlgorithm) Jwts.get(registry, "ES384");
            ES512 = (SignatureAlgorithm) Jwts.get(registry, "ES512");
            EdDSA = (SignatureAlgorithm) Jwts.get(registry, "EdDSA");
        }
    ...
    public static Claims claims(Map<String, Object> map) {
        return (Claims) ((ClaimsBuilder) claims().add(map)).build();
    }
}
